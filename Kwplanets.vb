...
Private Shared lv_pl_helio_arr(3) As Double
Private Shared lv_pl_geo_arr(3) As Double
Private Shared lv_pl_ind As Long
Private Shared lv_pl_mtrx(LC_P1_COUNT, LC_P2_COUNT) As Double
...
Private Shared lv_isa_mtrx(7, 5) As Double
...
End Function
Public Shared Function pl_surface(ByVal plnt As Long) As Double
   Dim retvalu As Double
   If (plnt < LC_P1_PREV_PL Or LC_P1_COUNT <= plnt) Then
      retvalu = LC_P1_ERR
   Else
   ...
   Else
      ...
      Else
         ...
         If (state_x = LC_ISA_DENSITY) Then
            expon = expon + 1
         End If
         retvalu = Math.Pow(lv_isa_mtrx(h_ind, _
...
End Function
Private Shared Function lf_prem(ByVal height_m As Double, _
      ByVal state_x As Long) As Double
   Dim coec As Double
   Dim coeb As Double
   Dim coea As Double
   ...
   lf_prem = (retvalu)
End Function
Public Shared Function prem_density(ByVal height_m As Double) _
      As Double
   prem_density = ((lf_prem(height_m, LC_PREM_DENSITY)))
End Function
Public Shared Function prem_mass(ByVal height_m As Double) As _
      Double
