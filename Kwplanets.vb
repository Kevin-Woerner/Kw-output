...
Private Dim lv_pl_helio_arr(3) As Double
Private Dim lv_pl_geo_arr(3) As Double
Private Shared lv_pl_ind As Long
Private Dim lv_pl_arr(LC_P1_COUNT, LC_P2_COUNT) As Double
...
Private Dim lv_isa_arr(7, 5) As Double
