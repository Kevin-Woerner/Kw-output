...
Public Const TM_NGRTM_UVPV_IF_A2DMAX As Double = 1.0 / (Kw.UVPV * _
         TM_NGRTM_GAIN)
'IMPORT "Kw"
Public Shared Function tmc_cdtm_uVpV_to_rotor_freq(ByVal uvpv_data As _
         Double) As Double
   tmc_cdtm_uVpV_to_rotor_freq = uvpv_data / TM_CDTM_UVPV_PER_Hz + _
            TM_CDTM_NOMINAL_Hz_AT_ZERO
End Function
Public Shared Function tmc_cdtm_rotor_freq_to_uVpV(ByVal rf_data As _
         Double) As Double
   tmc_cdtm_rotor_freq_to_uVpV = TM_CDTM_UVPV_PER_Hz * (rf_data - _
            TM_CDTM_NOMINAL_Hz_AT_ZERO)
End Function
Public Shared Function tmc_dao_V_to_DAC(ByVal volt_data As Double) As Double
   tmc_dao_V_to_DAC = TM_DAOV_DAC_PER_V * (volt_data - TM_DAOV_V_IF_DACMIN)
End Function
Public Shared Function tmc_dao_DAC_to_V(ByVal dac_data As Double) As Double
   tmc_dao_DAC_to_V = dac_data / TM_DAOV_DAC_PER_V + TM_DAOV_V_IF_DACMIN
End Function
Public Shared Function tmc_dao_deltaV_to_DAC(ByVal volt_data As Double) _
         As Double
   tmc_dao_deltaV_to_DAC = TM_DAOV_DAC_PER_V * volt_data
End Function
Public Shared Function tmc_shunt_value(ByVal bridge_ohms As Double, ByVal _
