...
Friend  Shared lv_ymdhms_arr(20) As Double
...
Friend  Shared lv_ranz_arr(LC_KNUTH_QUALITY_COUNT) As Long
Friend  Shared lv_ran_a_arr(LC_KNUTH_ARRAY_COUNT) As Long
Friend  Shared lv_ran_x_arr(LC_KNUTH_KK_COUNT) As Long
...
Friend  Shared lv_sttx_arr(LC_STTS_MAX_KEY, LC_STTS_COUNT) As _
      Double
...
Friend  Shared lv_corx_arr(LC_STTS_MAX_KEY, LC_STTSC_COUNT) _
      As Double
...
Public Shared Function fabs(ByVal xx As Double) As Double
   fabs = Math.Abs(xx)
End Function
'   MMMMMMMMMMASTER-Function ------------------ lf_mod_vbdotnet #
...
Public Shared Function sincinv(ByVal yy As Double) As Double
   ...
   ElseIf (yy < 1.0) Then
      aa = yy - min_yy
      bb = 1.0 - yy
      start_xx = (aa * Math.Sqrt(5.0 * bb) + bb * _
...
Public Shared Function sincc(ByVal xx_rad As Double) As Double
   ...
   sincc = (retvalu)
End Function
Public Shared Function versin(ByVal xx_rad As Double) As Double
   Dim trigsign As Double
   Dim xr_rad As Double
   ...
   versin = (sum_curr)
End Function
Public Shared Function haversin(ByVal xx_rad As Double) As Double
   haversin = ((versin(xx_rad) / 2.0))
End Function
Public Shared Function tur2deg(ByVal xx_tur As Double) As Double
   tur2deg = (xx_tur * Kw.TURN / Kw.ARCDEG)
End Function
Public Shared Function deg2tur(ByVal xx_deg As Double) As Double
   deg2tur = (xx_deg * Kw.ARCDEG / Kw.TURN)
End Function
Public Shared Function tur2rad(ByVal xx_tur As Double) As Double
   tur2rad = (xx_tur * Kw.TURN / Kw.RADIAN)
End Function
Public Shared Function rad2tur(ByVal xx_rad As Double) As Double
   rad2tur = (xx_rad * Kw.RADIAN / Kw.TURN)
End Function
Public Shared Function tur2sec(ByVal xx_tur As Double) As Double
   tur2sec = (xx_tur * Kw.TURN / Kw.ARCSEC)
End Function
Public Shared Function sec2tur(ByVal xx_sec As Double) As Double
   sec2tur = (xx_sec * Kw.ARCSEC / Kw.TURN)
End Function
Public Shared Function rad2deg(ByVal xx_rad As Double) As Double
   rad2deg = (xx_rad * Kw.RADIAN / Kw.ARCDEG)
End Function
Public Shared Function deg2rad(ByVal xx_deg As Double) As Double
   deg2rad = (xx_deg * Kw.ARCDEG / Kw.RADIAN)
End Function
Public Shared Function rad2sec(ByVal xx_rad As Double) As Double
   rad2sec = (xx_rad * Kw.RADIAN / Kw.ARCSEC)
End Function
Public Shared Function sec2rad(ByVal xx_sec As Double) As Double
   sec2rad = (xx_sec * Kw.ARCSEC / Kw.RADIAN)
End Function
Public Shared Function deg2sec(ByVal xx_deg As Double) As Double
   deg2sec = (xx_deg * Kw.ARCDEG / Kw.ARCSEC)
End Function
Public Shared Function sec2deg(ByVal xx_sec As Double) As Double
...
End Function
Public Shared Function rad2dms2(ByVal xx_rads As Double) As _
      Double
   Dim dg As Double
   ...
   rad2dms2 _
         = ((dd_deg_arr(0) + (mm_min_arr(0) + dg / 100.0) / _
               100.0))
End Function
Public Shared Function dms2rad(ByVal xx_dms As Double) As Double
   Dim dd_deg As Double
   Dim mm_min As Double
   Dim dg As Double
   dd_deg = Math.Floor(xx_dms)
   ...
   dms2rad _
         = (((dg * Kw.ARCSEC + mm_min * Kw.ARCMIN + dd_deg * _
               Kw.ARCDEG) / Kw.RADIAN))
End Function
Public Shared Function deg2dms(ByVal xx_deg As Double) As Double
   deg2dms = ((rad2dms(deg2rad(xx_deg))))
End Function
Public Shared Function dms2deg(ByVal xx_dms As Double) As Double
   dms2deg = ((rad2deg(dms2rad(xx_dms))))
End Function
Public Shared Function cot(ByVal xx_rad As Double) As Double
   cot = ((Math.Cos(xx_rad) / Math.Sin(xx_rad)))
End Function
Public Shared Function sec(ByVal xx_rad As Double) As Double
   sec = ((1.0 / Math.Cos(xx_rad)))
End Function
Public Shared Function csc(ByVal xx_rad As Double) As Double
...
End Function
Public Shared Function sinh(ByVal xx As Double) As Double
   sinh = (((Math.Exp(xx) - Math.Exp(-xx)) / 2.0))
End Function
Public Shared Function cosh(ByVal xx As Double) As Double
   cosh = (((Math.Exp(xx) + Math.Exp(-xx)) / 2.0))
End Function
Public Shared Function tanh(ByVal xx As Double) As Double
   tanh = ((sinh(xx) / cosh(xx)))
End Function
Public Shared Function coth(ByVal xx As Double) As Double
   coth = ((cosh(xx) / sinh(xx)))
End Function
Public Shared Function sech(ByVal xx As Double) As Double
   sech = ((1.0 / cosh(xx)))
End Function
Public Shared Function csch(ByVal xx As Double) As Double
   csch = ((1.0 / sinh(xx)))
End Function
...
End Function
Public Shared Function print_contfra(ByVal orig As Double) As _
      Long
   print_contfra = ((lf_continued_fraction(orig, -1)))
End Function
Public Shared Function print_contfrac(ByVal orig As Double) _
      As Long
   print_contfrac = ((lf_continued_fraction(orig, 0)))
End Function
Public Shared Function print_contfracd(ByVal orig As Double) _
      As Long
   print_contfracd = ((lf_continued_fraction(orig, 1)))
End Function
Public Shared Function print_num2char(ByVal num As Long) As Long
   If (num < 32) Then
      If (num < 16) Then
         If (num < 8) Then
            If (num < 4) Then
   ...
   print_num2char = (num)
End Function
Public Shared Function print_base_out(ByVal num As Long, _
...
End Function
Public Shared Function print_base_outf(ByVal num As Double, _
      ByVal baset As Long) As Long
   Dim dig_count As Long
   Dim ii As Long
   Dim frc As Double
...
Public Shared Function prime0_f(ByVal nf As Long, _
   ...
   prime0_f = (retvalu)
End Function
Public Shared Function print_factor(ByVal nn As Long) As Long
   Dim ind As Long
...
Public Shared Function repetendlen(ByVal denm As Long, ByVal _
   ...
   repetendlen = (retvalu)
End Function
Public Shared Function print_kevy(ByVal den As Long, ByVal _
...
Public Shared Function bkbn(ByVal bb As Long, ByVal kk As _
      Long, ByVal bbb As Long) As Long
   Dim mdls As Long
   mdls = kk * bb - 1
...
Public Shared Function jd2ymdhmsinv() As Double
   ...
   jd2ymdhmsinv _
         = ((ymd2jd(lv_ymdhms_arr(LC_GD_YEAR), _
               ...
               Kw.JDAY))
End Function
Public Shared Function print_jd264(ByVal jjulid As Double) As _
      Double
...
Public Shared Function jewish2jdx(ByVal hebyear As Long) As _
   ...
   hour_el = (5 + (12 * months_el) + 793 * _
         Math.Floor(months_el / HQPHR) + _
         Math.Floor(halaqims_el / HQPHR))
...
End Function
Public Shared Function bb_pdf(ByVal wavelen As Double) As Double
   Dim retvalu As Double
   If (wavelen <= 0.0) Then
      retvalu = 0.0
   Else
      retvalu = 1.0 / (Math.Pow(wavelen, 5.0) * (Math.Exp(1.0 _
            / wavelen) - 1.0))
   End If
   bb_pdf = ((retvalu * 15.0 / Math.Pow(Kw.PI, 4.0)))
End Function
Public Shared Function blackbody_pdf(ByVal wavelen As Double) _
      As Double
...
Private Shared Function lf_stts_is_inited(ByVal ix_hndl As _
      Long) As Boolean
   ' local-use Vbdotnet lv_sttx_arr
   Dim vll As Long
   Dim ii As Long
   Dim jj As Long
   Dim retvalu_bol As Boolean
...
Private Shared Function lf_corr_is_init(ByVal ix_chnd As _
      Long) As Boolean
   ' local-use Vbdotnet lv_corx_arr
   Dim retvalu_bol As Boolean
   Dim vll As Double
...
Public Shared Function corrcorr(ByVal ix_chnd As Long) As Double
   ...
   If (Kw.iszero(den)) Then
      retvalu = 0.0
   Else
      retvalu = (lv_corx_arr(ix_chnd, LC_STTSC_COVAR) / _
            Math.Sqrt(den))
   End If
   corrcorr = (retvalu)
End Function
...
End Function
Public Shared Function circle_solve(ByVal aa_x As Double, _
...
End Function
Private Shared Function lf_signcrossproduct(ByVal aa_x As _
      Double, ByVal aa_y As Double, ByVal bb_x As Double, _
      ByVal bb_y As Double, ByVal cc_x As Double, ByVal cc_y _
      As Double) As Double
   Dim cr As Double
...
Public Shared Function b2m(ByVal bb As Double) As Double
   b2m = ((1.0 - 1.0 / (bb * bb)))
End Function
Public Shared Function elliptic1(ByVal mm As Double) As Double
   elliptic1 = ((Kw.PI / (2.0 * Kw.agmean(1.0, Math.Sqrt(1.0 _
         - mm)))))
End Function
Public Shared Function ellipticK(ByVal kk As Double) As Double
   ellipticK = ((elliptic1(k2m(kk))))
End Function
Public Shared Function elliptic1__1(ByVal mm As Double) As Double
   elliptic1__1 = ((Kw.carlsonRF(0.0, 1.0 - mm, 1.0)))
End Function
Public Shared Function elliptic1i(ByVal mm As Double, ByVal _
      ...
      If (10.0 < Math.Abs(tt)) Then
         ...
         If (Math.Abs(ee) < 10.0) Then
            If (npihlfs = 0) Then
               kresult = Kw.elliptic1(mm)
            End If
            temp = kresult - Kw.elliptic1i(mm, Math.Atan2(ee, 1))
            skip_flag = True
         End If
      End If
...
End Function
Public Shared Function elliptic1i__1(ByVal mm As Double, _
...
End Function
Public Shared Function elliptic2(ByVal mm As Double) As Double
   Dim aan As Double
   Dim ggn As Double
   Dim tn As Double
   Dim twon As Double
...
End Function
Public Shared Function elliptic2__1(ByVal mm As Double) As Double
   elliptic2__1 _
         = ((Kw.carlsonRF(0, 1 - mm, 1) - mm * Kw.carlsonRD(0 _
               , 1 - mm, 1) / 3.0))
End Function
Public Shared Function elliptic2i(ByVal mm As Double, ByVal _
      circ_rad As Double) As Double
   Dim aan As Double
   Dim ggn As Double
   Dim cc As Double
      ...
      Else
         ...
         Else
            ...
            temp = eliptwomm * (Math.Atan2(tt, 1) + modd * _
                  Kw.PI) / (ii * aan * elliptic1(mm)) + errsum
         End If
         If (signof < 0) Then
            temp = -temp
         End If
...
End Function
Public Shared Function elliptic2i__1(ByVal mm As Double, _
      ByVal circ_rad As Double) As Double
   Dim sinphi As Double
   ...
   elliptic2i__1 _
         = ((sinphi * carlsonRF(cosphisq, argb, 1) - mm * _
               ...
               + kresult))
End Function
Public Shared Function elliptic3(ByVal nn As Double, ByVal mm _
      As Double) As Double
   Dim aan As Double
   Dim ggn As Double
   Dim ppn As Double
...
End Function
Public Shared Function elliptic3i(ByVal nn As Double, ByVal _
...
End Function
Public Shared Function elliptic3__1(ByVal nn As Double, ByVal _
      mm As Double) As Double
   elliptic3__1 _
         = ((Kw.carlsonRF(0, 1 - mm, 1) + nn * Kw.carlsonRJ(0 _
               , 1 - mm, 1, 1 - nn) / 3.0))
End Function
Public Shared Function elliptic3i__1(ByVal nn As Double, _
...
Public Shared Function jacobicir(ByVal mm As Double) As Double
   jacobicir = ((4.0 * elliptic2(mm) / Math.Sqrt(1.0 - mm)))
End Function
...
Public Shared Function nevillethetac(ByVal mm As Double, _
   ...
   Do While (True)
      ...
      nn += 1
   Loop
   nevillethetac = ((sum_curr * Math.Sqrt(TAU * Math.Sqrt(qq _
         / mm) / km)))
End Function
Public Shared Function nevillethetad(ByVal mm As Double, _
   ...
   Do While (True)
      ...
      nn += 1
   Loop
   nevillethetad = (((1 + 2 * sum_curr) * Math.Sqrt(TAU / km) _
         / 2.0))
End Function
Public Shared Function nevillethetan(ByVal mm As Double, _
   ...
   Loop
   nevillethetan _
         = (((1 + 2 * sum_curr) * Math.Sqrt(TAU / (km * _
...
Public Shared Function nevillethetas(ByVal mm As Double, _
   ...
   Loop
   nevillethetas _
         = ((sum_curr * Math.Sqrt(TAU * Math.Sqrt(qq / (mm * _
               (1 - mm))) / km)))
End Function
...
Public Shared Function ellipseecc(ByVal aa As Double, ByVal _
   ...
   Dim rati As Double
   rati = Kw.ratio(aa, bb)
   ellipseecc = ((Math.Sqrt(1.0 - rati * rati)))
End Function
...
End Function
Public Shared Function ellipsecir(ByVal aa As Double, ByVal _
      bb As Double) As Double
   Dim xx As Double
   Dim yy As Double
   Dim mm As Double
   ...
   Else
      ...
      yy = bb
   End If
   If (yy <= Math.Sqrt(DBLEPS) * xx) Then
      retvalu = 4.0 * xx
   Else
      suma = 0.0
      mm = 1.0
...
Public Shared Function search_search(ByVal gg As Long) As Long
   ...
   search_search = (curr)
End Function
Public Shared Function blackbody(ByVal wavelength As Double, _
   ...
   Else
      ...
      retvalu = 2.0 * hc * Kw.LIGHT / (Math.Pow(wavelength, _
            5) * (Math.Exp(hc_kt / wavelength) - 1))
   End If
   blackbody = (retvalu)
End Function
