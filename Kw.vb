...
' 2020-08-31 kdw  For Changelog, See File Kw.varylog
Option Explicit On
...
Private Dim lv_sttx_mtrx(LC_STTS_MAX_KEY, LC_STTS_COUNT) As _
      Double
...
Private Dim lv_crx_mtrx(LC_STTS_MAX_KEY, LC_STTSC_COUNT) As _
      Double
