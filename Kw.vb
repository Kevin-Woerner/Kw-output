...
' 2020-08-25 kdw  For Changelog, See File Kw.varylog
Option Explicit On
...
Private Dim lv_ymdhms_arr(20) As Double
...
Private Dim lv_ranz_arr(LC_KNUTH_QUALITY_COUNT) As Long
Private Dim lv_ran_a_arr(LC_KNUTH_ARRAY_COUNT) As Long
Private Dim lv_ran_x_arr(LC_KNUTH_KK_COUNT) As Long
...
Private Dim lv_sttx_arr(LC_STTS_MAX_KEY, LC_STTS_COUNT) As Double
...
Private Dim lv_corx_arr(LC_STTS_MAX_KEY, LC_STTSC_COUNT) As _
      Double
...
Public Function kw_description() As String
   ...
   desc_string = desc_string _
         ...
         & "EAR GYEAR h h_ERR h_REC HALAQIM HALAQIM_PER_HOUR H" _
         & "ART HARTLEY HBAR HBAR_ERR HECTARE HECTO HELION_MAS"
   desc_string = desc_string _
         & "S HELIONMASS HELIONMASS_ERR HENRY HERTZ HFENERGY H" _
         & "FHz HFWAVELENGTH HFWAVENUMBER HI HI_ERR HIENERGY H" _
         & "IHz HIWAVELENGTH HIWAVENUMBER HORSEPOWER HOUR HP H" _
         & "PMETRIC HUBBLE HUBBLE_ERR HXENERGY HXHz HXWAVELENG"
   desc_string = desc_string _
         & "TH HXWAVENUMBER HYDROGENLINE HYDROGENLINE_ERR HYDR" _
         & "OGENRADIUS HYDROGENRADIUS_ERR INCH INDUCTANCE INHG" _
         & " INTMAX J2K J2KDAY JC JCENTURY JD JDAY JDSEC_AT_0G" _
         & "REGORIAN JDSEC_AT_0J2K JDSEC_AT_0KWT JDSEC_AT_0UET"
   desc_string = desc_string _
         & " JEWISH_FIRST_MONTH JM JMILLENNIUM JOSEPHSON JOSEP" _
         & "HSON_ERR JOULE JULIANCENTURY JULIANDAY JULIANMILLE" _
         & "NNIUM JULIANYEAR JY JYEAR K_AT_0TEMPC K_AT_0TEMPF " _
         & "K_AT_0TEMPR kB kB_ERR kB_REC KCD KCD_ERR KELVIN KG"
   desc_string = desc_string _
         & " KGENERGY KGF KGHz KGWAVELENGTH KGWAVENUMBER KIBI " _
         & "KILO KILOGRAM KPGBOUNDARY KWT LB LBF LC_CIRCLE_RAD" _
         & "IUS LC_CIRCLE_X LC_CIRCLE_Y LC_EPS LC_GD_COUNT LC_" _
         & "GD_DAY LC_GD_DOW LC_GD_HOUR LC_GD_JD LC_GD_MIN LC_"
   desc_string = desc_string _
         & "GD_MONTH LC_GD_NUM LC_GD_SEC LC_GD_YEAR LC_KNUTH_A" _
         & "RRAY_COUNT LC_KNUTH_KK_COUNT LC_KNUTH_LL LC_KNUTH_" _
         & "MAX LC_KNUTH_QUALITY_COUNT LC_KNUTH_TT LC_MAGIC_IN" _
         & "T LC_MAGIC_INT_NOT LC_MAX_FACTORS LC_PARABOLA_COEF"
   desc_string = desc_string _
         & "F_A LC_PARABOLA_COEFF_B LC_PARABOLA_COEFF_C LC_PAR" _
         & "ABOLA_REAL_ROOTS LC_PARABOLA_ROOT_A LC_PARABOLA_RO" _
         & "OT_B LC_PARABOLA_X_AXIS LC_PARABOLA_Y_EXTREMA LC_S" _
         & "TTS_COUNT LC_STTS_MAGIC LC_STTS_MAX LC_STTS_MAX_KE"
   desc_string = desc_string _
         & "Y LC_STTS_MEAN LC_STTS_MIN LC_STTS_MSQ LC_STTS_NUM" _
         & " LC_STTSC_COUNT LC_STTSC_COVAR LC_STTSC_MAGIC LC_S" _
         & "TTSC_XX LC_STTSC_YY LENGTH LFENERGY LFHz LFWAVELEN" _
         & "GTH LFWAVENUMBER LIFEAGE LIGHT LIGHT_ERR LIGHT_REC"
   desc_string = desc_string _
         & " LIGHTYEAR LITER LITRE LNTEN LNTWO LUMEN LUX MACH " _
         & "MAGNETIC MAGNETIC_ERR MAGNETICFLUX MAGNETICINDUCTI" _
         & "ON MARATHON MASS MEBI MEGA METER METRE MFENERGY MF" _
         & "Hz MFWAVELENGTH MFWAVENUMBER MICRO MICROWAVEENERGY"
   desc_string = desc_string _
         & " MICROWAVEHz MICROWAVEWAVELENGTH MICROWAVEWAVENUMB" _
         & "ER MILE MILKYWAYAGE MILKYWAYDAY MILKYWAYMASS MILKY" _
         & "WAYRADIUS MILLI MINUTE MIRENERGY MIRHz MIRWAVELENG" _
         & "TH MIRWAVENUMBER MM MMHG MOLARMASS MOLARMASS_ERR M"
   desc_string = desc_string _
         & "OLARMASSX MOLARMASSX_ERR MOLE MONTHS_IN_YEAR MOONM" _
         & "ONTH MPH MPS MPSS MU0 MU0_ERR MUON_MASS MUONENERGY" _
         & " MUONHz MUONMASS MUONMASS_ERR MUONWAVELENGTH NANO " _
         & "NAT NEUTRON_MASS NEUTRONENERGY NEUTRONHz NEUTRONMA"
   desc_string = desc_string _
         & "SS NEUTRONMASS_ERR NEUTRONWAVELENGTH NEWTON NICKEL" _
         & "MASS NICKELRADIUS NICKELTHICKNESS NINEVOLT NINEVOL" _
         & "TBATTERY NINEVOLTBATTERYCHARGE NINEVOLTBATTERYENER" _
         & "GY NINEVOLTBATTERYVOLTAGE NINEVOLTCHARGE NINEVOLTE"
   desc_string = desc_string _
         & "NERGY NINEVOLTVOLTAGE NIRENERGY NIRHz NIRWAVELENGT" _
         & "H NIRWAVENUMBER NPBOUNDARY NUVENERGY NUVHz NUVWAVE" _
         & "LENGTH NUVWAVENUMBER OHM ORANGEENERGY ORANGEHz ORA" _
         & "NGEWAVELENGTH ORANGEWAVENUMBER OUNCE PA PARSEC PEB"
   desc_string = desc_string _
         & "I PENNYMASS PENNYRADIUS PENNYTHICKNESS PETA PHI PH" _
         & "ONEBATTERY PHONEBATTERYCHARGE PHONEBATTERYENERGY P" _
         & "HONEBATTERYVOLTAGE PI PICO PINGPONGBALLMASS PINGPO" _
         & "NGBALLRADIUS PINT PLANCK PLANCK_ERR PLANCK_REC PLA"
   desc_string = desc_string _
         & "NCKBAR PLANCKBAR_ERR PLANCKCHARGE PLANCKENERGY PLA" _
         & "NCKLENGTH PLANCKMASS PLANCKTEMP PLANCKTIME POINT P" _
         & "OUND POWER PPB PPM PPQ PPT PRESSURE PROTON_MASS PR" _
         & "OTONENERGY PROTONHz PROTONMASS PROTONMASS_ERR PROT"
   desc_string = desc_string _
         & "ONRADIUS PROTONRADIUS_ERR PROTONWAVELENGTH PROXIMA" _
         & "CENTAURI PSI PTRBOUNDARY QUART QUARTERMASS QUARTER" _
         & "RADIUS QUARTERTHICKNESS RAD RADIAN REDENERGY REDHz" _
         & " REDWAVELENGTH REDWAVENUMBER RESISTANCE RPM RPS RY"
   desc_string = desc_string _
         & "DBERG RYDBERG_ERR RYDBERGENERGY RYDBERGHz RYDBERGW" _
         & "AVELENGTH RYDBERGWAVENUMBER SECOND SHANNON SHFENER" _
         & "GY SHFHz SHFWAVELENGTH SHFWAVENUMBER SI16MAX SI16M" _
         & "IN SI32MAX SI32MIN SIEMENS SOCCERBALLMASS SOCCERBA"
   desc_string = desc_string _
         & "LLRADIUS SOFTBALLMASS SOFTBALLRADIUS SOLARCONSTANT" _
         & " SOLID_ANGLE SPECIFICHEAT SPEED SPHERESURFACE SQDE" _
         & "G SQRTTWO SQUAREDEGREE STANDARDATMOSPHERE STANDARD" _
         & "GRAVITY STEFAN STEFAN_ERR STERADIAN SXENERGY SXHz "
   desc_string = desc_string _
         & "SXWAVELENGTH SXWAVENUMBER SXXENERGY SXXHz SXXWAVEL" _
         & "ENGTH SXXWAVENUMBER TAU TAU_MASS TAUENERGY TAUHz T" _
         & "AUMASS TAUMASS_ERR TAUWAVELENGTH TBLSP TEBI TEMPER" _
         & "ATURE TENNISBALLMASS TENNISBALLRADIUS TERA TESLA T"
   desc_string = desc_string _
         & "HFENERGY THFHz THFWAVELENGTH THFWAVENUMBER TIME TO" _
         & "N TONNE TORR TRITON_MASS TRITONMASS TRITONMASS_ERR" _
         & " TRJBOUNDARY TSP TT_AT_0TAI TT_AT_0UT1 TURN UAMU U" _
         & "AMU_ERR UET UHFENERGY UHFHz UHFWAVELENGTH UHFWAVEN"
   desc_string = desc_string _
         & "UMBER UI16MAX UI32MAX UNITGM UNIVERSEAGE UNIVERSEM" _
         & "ASS UNIVERSERADIUS UPQUARK_MASS UPQUARKENERGY UPQU" _
         & "ARKHz UPQUARKMASS UPQUARKMASS_ERR UPQUARKWAVELENGT" _
         & "H UVAENERGY UVAHz UVAWAVELENGTH UVAWAVENUMBER UVBE"
   desc_string = desc_string _
         & "NERGY UVBHz UVBWAVELENGTH UVBWAVENUMBER UVCENERGY " _
         & "UVCHz UVCWAVELENGTH UVCWAVENUMBER VHFENERGY VHFHz " _
         & "VHFWAVELENGTH VHFWAVENUMBER VIOLETENERGY VIOLETHz " _
         & "VIOLETWAVELENGTH VIOLETWAVENUMBER VISCOSITY VOLT V"
   desc_string = desc_string _
         & "OLTAGE VOLUME VONKLITZING VONKLITZING_ERR WATT WEB" _
         & "ER WEEK YARD YELLOWENERGY YELLOWGREENENERGY YELLOW" _
         & "GREENHz YELLOWGREENWAVELENGTH YELLOWGREENWAVENUMBE" _
         & "R YELLOWHz YELLOWWAVELENGTH YELLOWWAVENUMBER YOBI " _
         & "YOCTO YOTTA ZEBI ZEPTO ZETTA" _
         & vbNewLine
   desc_string = desc_string _
   ...
   desc_string = desc_string _
         ...
         & "inv ahmean1 almean1 amean1 aqmean1 b2m bankers bb_" _
         & "pdf bell bellx benford_rand bernoulli bernoullid b"
   desc_string = desc_string _
         & "ernoullin bessI0 bessI1 bessJ0 bessJ1 bessK0 bessK" _
         & "1 bessY0 bessY1 bessY1__1 bits_count bits_ls1b bit" _
         & "s_ls1bpos bits_ms1b bits_ms1bpos bitwisenot blackb" _
         & "ody_pdf blackbodymode blackbodypower cantor carmic"
   desc_string = desc_string _
         & "hael catalan cauchy_rand cbrt ceil chisqr_rand cir" _
         & "cle_get clip clockhour clockmin clocksec clockstde" _
         & "v clocksum cnv_dbl2si16 corr_delete corr_handlex c" _
         & "orr_handley corrcorr corrslope corrstderr corry0 c"
   desc_string = desc_string _
         & "os cos__1 cosd cosdinv cosh coshinv cosintegral co" _
         & "sinv cosm1 cosm1__1 cost costinv cot cotd cotdinv " _
         & "coth cothinv cotinv cott cottinv csc cscd cscdinv " _
         & "csch cschinv cscinv csct csctinv ctz cu cube cuber"
   desc_string = desc_string _
         & "oot date_easter date_pesach date_rosh_hashanah day" _
         & "2dhms day2dhmsinv day2hour deg2dms deg2rad deg2sec" _
         & " deg2tur digamma digamma__1 digammainv dms2deg dms" _
         & "2rad doomsday ecc2flat Ein elliptic1a elliptic1k e"
   desc_string = desc_string _
         & "lliptic1m elliptic1m__1 elliptic1m__2 elliptic2a e" _
         & "lliptic2k elliptic2m elliptic2m__1 ellipticE ellip" _
         & "ticK erf erf__1 erf__2 erf__3 erf__4 erfc erfcinv " _
         & "erfcx erfcxinv erfinv eta eulerphi eulerx exp exp_"
   desc_string = desc_string _
         & "_1 exp__2 exp_rand expintegral1 expintegrali expm1" _
         & " fac facinv factorial factorialdouble factorialinv" _
         & " fibo fibox fiboxinv flat2ecc floor frac fubini fu" _
         & "sc g2jewish gamma_rand gau_cdf gau_pdf gau_quantil"
   desc_string = desc_string _
         & "e gd gdinv geo_rand ghmean1 ghmean1inv glmean1 gme" _
         & "an1 gqmean1 has_primitiveroot haversin heaviside h" _
         & "eronianmean1 hlmean1 hmean1 hn hn__1 hour2day hqme" _
         & "an1 hypot1 hypot1inv id int_rand iround iseven isi"
   desc_string = desc_string _
         & "nt isjewish8short isjewish9short isjewishleap isle" _
         & "apyear ismagic isneg isnegint isodd ispos isposint" _
         & " ispractical isprime issquarefree iszero j2k2dow j" _
         & "2k2jd j2k2kwt j2k2uet j2k2ymdhms jacobicir jd2dow "
   desc_string = desc_string _
         & "jd2j2k jd2kwt jd2uet jd2ymdhms jewish2g jewish2jd " _
         & "jewish2jdx jewish_months_in_year jewish_yearlength" _
         & " k2a k2m k2tempc k2tempf k2tempr ks_a_cdf kwt2j2k " _
         & "kwt2jd kwt2uet l10 lg lgamma lgamma__1 lgamma__2 l"
   desc_string = desc_string _
         & "gammainv lix lixinv lmean1 ln ln1p ln__1 ln__2 lns" _
         & " log log10 log2 logintegral logistic_rand lqmean1 " _
         & "lucas lucasx m2a m2b m2k mertens minkowski mobius " _
         & "neg nom normal_cdf normal_cdf__1 normal_pdf normal"
   desc_string = desc_string _
         & "_quantile normal_quantile__1 parabola_get parabola" _
         & "_roots partition partitionq pcf pfg pfl poi_rand p" _
         & "ow10 pow2 prime0 prime1 primecount primecountx pri" _
         & "menext primenth primenth__1 primeprev primitiveroo"
   desc_string = desc_string _
         & "t print_contfra print_contfrac print_contfracd pri" _
         & "nt_factor print_jd264 print_num2char qmean1 rad2de" _
         & "g rad2dms rad2dms2 rad2sec rad2tur rand_init randl" _
         & " reci reimann round rto125 rtoi rtoz sba search_ch"
   desc_string = desc_string _
         & "eck search_search sec sec2deg sec2dhms sec2rad sec" _
         & "2tur secd secdinv sech sechinv secinv sect sectinv" _
         & " shc_shft2steps shc_steps2shft shc_steps2shftinv s" _
         & "igma0 sigma1 sigmoid sigmoidinv sign sin sin__1 si"
   desc_string = desc_string _
         & "nc sinc__1 sincc sincinv sind sindinv sinh sinhinv" _
         & " sinintegral sininv sint sintinv smooth sq sqinv s" _
         & "qrt sqrt__1 sqrt__2 sqrt__3 sqrtx square squareroo" _
         & "t stair stts_delete stts_reset sttscount sttsmagic"
   desc_string = desc_string _
         & " sttsmax sttsmean sttsmin sttsmsq sttsspread sttss" _
         & "tdev sttsstdevmean sttssum sttsvar supercatalan ta" _
         & "n tand tandinv tanh tanhinv taninv tant tantinv te" _
         & "mpc tempc2k tempc2tempf tempf tempf2k tempf2tempc "
   desc_string = desc_string _
         & "tempr tempr2k tgamma tgamma__1 tgamma__2 tgamma__3" _
         & " tgamma__stirling tgammadouble tgammainv topyh1 to" _
         & "tient tri tri_rand triinv trip trunc tur2deg tur2r" _
         & "ad tur2sec uet2j2k uet2jd uet2kwt uni_rand versin " _
         & "wm wminv wp wpinv ymdhms2j2k ymdhms2jd ymdhms_get " _
         & "zag zeta zig zigzag" _
         & vbNewLine
   desc_string = desc_string _
   ...
   desc_string = desc_string _
         & "liptic1ia elliptic1ik elliptic1im elliptic1im__1 e" _
         & "lliptic2ia elliptic2ik elliptic2im elliptic2im__1 " _
         & "elliptic3a elliptic3k elliptic3m elliptic3m__1 ell" _
         & "ipticEi ellipticF ellipticP entringer eulerian exp"
   desc_string = desc_string _
         & "_cdf exp_pdf exp_quantile expintegraln factor fact" _
         & "orialt floor2 fmod fmod fmods fmodu fmody fmul gam" _
         & "ma_cdf gamma_pdf gcd gcda geo_cdf geo_pdf geo_quan" _
         & "tile ghmean glmean gmean gompertz_rand gqmean has_"
   desc_string = desc_string _
         & "primitiveroot_f heronianmean hlmean hmean hnm hqme" _
         & "an hypot int_cdf int_pdf int_quantile ints_rand is" _
         & "eq isge isgt isle islt ismult ismultl isneq isprac" _
         & "tical_f isprimitiveroot issignsame issquarefree_f "
   desc_string = desc_string _
         & "isss jacobiphi jewish_monthbegin jewish_monthlengt" _
         & "h ks_b_cdf ks_cdf ks_quantile lbeta lcam lcams lca" _
         & "ntim lcm lcombx ligamma ligammainv lmean logistic_" _
         & "cdf logistic_pdf logistic_quantile lpermx lqmean m"
   desc_string = desc_string _
         & "ax2 maxabs maxabs2 maxi mb_cdf mb_pdf mean min2 mi" _
         & "nabs minabs2 mini mobius_f modf mods modulo nbd_ra" _
         & "nd nc nd nevillethetac nevillethetad nevillethetan" _
         & " nevillethetas ns nthroot__1 pareto_rand perm perm"
   desc_string = desc_string _
         & "utation permx pochhammer poi_cdf poi_pdf poi_quant" _
         & "ile polya_rand polycnum polynum pow powi prime0_f " _
         & "print_base_out print_base_outf qmean rand_init_arr" _
         & "ay ratio repetendlen rligamma rms round2 rtomsd ru"
   desc_string = desc_string _
         & "igamma sc sd shc_shftpoles2steps sigma sigma0_f si" _
         & "gma1_f sn sn__1 spread2stdev stdev2spread stirling" _
         & "1 stirling2 stts_copy stts_downdate stts_newx stts" _
         & "_scale stts_shift stts_update stts_update2 t_cdf t"
   desc_string = desc_string _
         & "_cdf__1 t_pdf t_quantile t_quantile__1 tetracnum t" _
         & "etranum theta1 theta2 theta3 theta4 Tn topyh totie" _
         & "nt_f trap_rand tri_cdf tri_pdf tri_quantile uigamm" _
         & "a uigamma__1 uigammainv Un uni_cdf uni_pdf uni_qua" _
         & "ntile variance zeta_cdf zeta_pdf zipf_rand znorder" _
         & " znorder__1" _
         & vbNewLine
   desc_string = desc_string _
         & "   Kw 3-ary Functions: agcmean aghmean atothenmodp" _
         & " atothenmodx beta_cdf beta_pdf beta_quantile betai" _
         & "nc betainc__1 binomial_cdf binomial_pdf bits_assig"
   desc_string = desc_string _
         & "n bkbn cantorll cantorul cantorxx carlsonRD carlso" _
         & "nRF chebeval clip2 clip2x corr_update cossin_ev di" _
         & "vi dlog dlogx elliptic3ia elliptic3ik elliptic3im " _
         & "elliptic3im__1 ellipticPi epdf2cdf f11 f_cdf f_qua"
   desc_string = desc_string _
         & "ntile f_quantile__1 fibo3 fit_ls fit_ls0 fit_minma" _
         & "x fit_minmax0 fit_poly fitx_minmax fmod2 gompertz_" _
         & "cdf gompertz_pdf gompertz_quantile hms2day horner " _
         & "hypot3 ifzero isalmostequal isbetween isbetweenx i"
   desc_string = desc_string _
         & "sfloorsame iswithin jewishymd2jd lv_ellpj maxabsof" _
         & "fset maxmin maxwell_boltzmann_cdf maxwell_boltzman" _
         & "n_pdf maxwell_juttner_pdf minabsoffset n2perm nbd_" _
         & "cdf nbd_pdf pareto_cdf pareto_pdf pareto_quantile "
   desc_string = desc_string _
         & "pendulum pmean polya_cdf polya_pdf print_kevy remq" _
         & "uou roundy sigma_f sigmoid3 sigmoid3d stts_updatex" _
         & " taninv3 trap_cdf trap_pdf trap_quantile ymd2dow y" _
         & "md2doy ymd2j2k ymd2jd zipf_cdf zipf_pdf zipf_quant" _
         & "ile" _
         & vbNewLine
   desc_string = desc_string _
...
Public Function kw_desc() As String
   ...
   desc_string = desc_string _
         ...
         & " h h_ERR h_REC HALAQIM(_PER_HOUR)? HART(LEY)? HBAR"
   desc_string = desc_string _
         & "(_ERR)? HECT(ARE|O) HELION(_MASS|MASS(_ERR)?) HENR" _
         & "Y HERTZ HFENERGY HFHz HFWAVE(LENGTH|NUMBER) HI HI_" _
         & "ERR HIENERGY HIHz HIWAVE(LENGTH|NUMBER) HORSEPOWER" _
         & " HOUR HP HPMETRIC HUBBLE(_ERR)? HXENERGY HXHz HXWA"
   desc_string = desc_string _
         & "VE(LENGTH|NUMBER) HYDROGEN(LINE(_ERR)?|RADIUS(_ERR" _
         & ")?) INCH INDUCTANCE INHG INTMAX J2K(DAY)? JC JCENT" _
         & "URY JD JDAY JDSEC_AT_0(GREGORIAN|J2K|KWT|UET) JEWI" _
         & "SH_FIRST_MONTH JM JMILLENNIUM JOSEPHSON(_ERR)? JOU"
   desc_string = desc_string _
         & "LE JULIAN(CENTURY|DAY|MILLENNIUM|YEAR) JY JYEAR K_" _
         & "AT_0TEMP[CFR] kB kB_(ERR|REC) KCD(_ERR)? KELVIN KG" _
         & " KGENERGY KGF KGHz KGWAVE(LENGTH|NUMBER) KIBI KILO" _
         & "(GRAM)? KPGBOUNDARY KWT LB LBF LC_(CIRCLE_(RADIUS|"
   desc_string = desc_string _
         & "[XY])|EPS|GD_(COUNT|D(AY|OW)|HOUR|JD|M(IN|ONTH)|NU" _
         & "M|SEC|YEAR)|KNUTH_(ARRAY_COUNT|KK_COUNT|LL|MAX|QUA" _
         & "LITY_COUNT|TT)|MA(GIC_INT(_NOT)?|X_FACTORS)|PARABO" _
         & "LA_(COEFF_[ABC]|R(EAL_ROOTS|OOT_[AB])|X_AXIS|Y_EXT"
   desc_string = desc_string _
         & "REMA)|STTS(_(COUNT|M(A(GIC|X(_KEY)?)|EAN|IN|SQ)|NU" _
         & "M)|C_(CO(UNT|VAR)|MAGIC|XX|YY))) LENGTH LFENERGY L" _
         & "FHz LFWAVE(LENGTH|NUMBER) LIFEAGE LIGHT(_(ERR|REC)" _
         & "|YEAR)? LIT(ER|RE) LNT(EN|WO) LUMEN LUX MACH MAGNE"
   desc_string = desc_string _
         & "TIC(_ERR|FLUX|INDUCTION)? MARATHON MASS MEBI MEGA " _
         & "MET(ER|RE) MFENERGY MFHz MFWAVE(LENGTH|NUMBER) MIC" _
         & "RO(|WAVE(ENERGY|Hz|WAVE(LENGTH|NUMBER))) MIL(E|KYW" _
         & "AY(AGE|DAY|MASS|RADIUS)|LI) MINUTE MIR(ENERGY|Hz|W"
   desc_string = desc_string _
         & "AVE(LENGTH|NUMBER)) MM MMHG MOL(ARMASS(_ERR|X(_ERR" _
         & ")?)?|E) MONTHS_IN_YEAR MOONMONTH MPH MPSS? MU0(_ER" _
         & "R)? MUON(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) N" _
         & "ANO NAT NEUTRON(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELE"
   desc_string = desc_string _
         & "NGTH) NEWTON NICKEL(MAS|RADIU|THICKNES)S NINEVOLT(" _
         & "BATTERY(CHARGE|ENERGY|VOLTAGE)?|CHARGE|ENERGY|VOLT" _
         & "AGE)? NIR(ENERGY|Hz|WAVE(LENGTH|NUMBER)) NPBOUNDAR" _
         & "Y NUV(ENERGY|Hz|WAVE(LENGTH|NUMBER)) OHM ORANGE(EN"
   desc_string = desc_string _
         & "ERGY|Hz|WAVE(LENGTH|NUMBER)) OUNCE PA PARSEC PEBI " _
         & "PENNY(MAS|RADIU|THICKNES)S PETA PHI PHONEBATTERY(C" _
         & "HARGE|ENERGY|VOLTAGE)? PI PICO PIN(GPONGBALL(MASS|" _
         & "RADIUS)|T) PLANCK(|_(ERR|REC)|BAR(_ERR)?|CHARGE|EN"
   desc_string = desc_string _
         & "ERGY|LENGTH|MASS|T(EMP|IME)) POINT POUND POWER PPB" _
         & " PPM PPQ PPT PRESSURE PRO(TON(_MASS|ENERGY|Hz|MASS" _
         & "(_ERR)?|RADIUS(_ERR)?|WAVELENGTH)|XIMACENTAURI) PS" _
         & "I PTRBOUNDARY QUART(ER(MAS|RADIU|THICKNES)S)? RAD("
   desc_string = desc_string _
         & "IAN)? RED(ENERGY|Hz|WAVE(LENGTH|NUMBER)) RESISTANC" _
         & "E RPM RPS RYDBERG(_ERR|ENERGY|Hz|WAVE(LENGTH|NUMBE" _
         & "R))? SECOND SHANNON SHF(ENERGY|Hz|WAVE(LENGTH|NUMB" _
         & "ER)) SI16M(AX|IN) SI32M(AX|IN) SIEMENS SOCCERBALL("
   desc_string = desc_string _
         & "MASS|RADIUS) SOFTBALL(MASS|RADIUS) SOL(ARCONSTANT|" _
         & "ID_ANGLE) SPE(CIFICHEAT|ED) SPHERESURFACE SQDEG SQ" _
         & "RTTWO SQUAREDEGREE STANDARD(ATMOSPHERE|GRAVITY) ST" _
         & "E(FAN(_ERR)?|RADIAN) SXENERGY SXHz SXWAVE(LENGTH|N"
   desc_string = desc_string _
         & "UMBER) SXX(ENERGY|Hz|WAVE(LENGTH|NUMBER)) TAU(_MAS" _
         & "S|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH)? TBLSP TEBI TE" _
         & "MPERATURE TENNISBALL(MASS|RADIUS) TERA TESLA THF(E" _
         & "NERGY|Hz|WAVE(LENGTH|NUMBER)) TIME TON(NE)? TORR T"
   desc_string = desc_string _
         & "RITON(_MASS|MASS(_ERR)?) TRJBOUNDARY TSP TT_AT_0(T" _
         & "AI|UT1) TURN UAMU(_ERR)? UET UHF(ENERGY|Hz|WAVE(LE" _
         & "NGTH|NUMBER)) UI16MAX UI32MAX UNI(TGM|VERSE(AGE|MA" _
         & "SS|RADIUS)) UPQUARK(_MASS|ENERGY|Hz|MASS(_ERR)?|WA"
   desc_string = desc_string _
         & "VELENGTH) UVA(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UVB(E" _
         & "NERGY|Hz|WAVE(LENGTH|NUMBER)) UVC(ENERGY|Hz|WAVE(L" _
         & "ENGTH|NUMBER)) VHF(ENERGY|Hz|WAVE(LENGTH|NUMBER)) " _
         & "VIOLET(ENERGY|Hz|WAVE(LENGTH|NUMBER)) VISCOSITY VO"
   desc_string = desc_string _
         & "L(T(AGE)?|UME) VONKLITZING(_ERR)? WATT WEBER WEEK " _
         & "YARD YELLOW(ENERGY|GREEN(ENERGY|Hz|WAVE(LENGTH|NUM" _
         & "BER))|Hz|WAVE(LENGTH|NUMBER)) YOBI YOCTO YOTTA ZEB" _
         & "I ZEPTO ZETTA" _
         & vbNewLine
   desc_string = desc_string _
         & "   Kw 0-ary Functions: corr_new euler__1 gau_rand " _
   ...
   desc_string = desc_string _
         ...
         & "hmean1 almean1 amean1 aqmean1 b2m bankers bb_pdf b" _
         & "ellx? benford_rand bernoulli[dn]? bess(I[01]|J[01]"
   desc_string = desc_string _
         & "|K[01]|Y(0|1(__1)?)) bit(s_(count|ls1b(pos)?|ms1b(" _
         & "pos)?)|wisenot) blackbody(_pdf|mode|power) cantor " _
         & "carmichael catalan cauchy_rand cbrt ceil chisqr_ra" _
         & "nd circle_get clip clock(hour|min|s(ec|tdev|um)) c"
   desc_string = desc_string _
         & "nv_dbl2si16 corr(_(delete|handle[xy])|corr|s(lope|" _
         & "tderr)|y0) cos(|__1|d(inv)?|h(inv)?|in(tegral|v)|m" _
         & "1(__1)?|t(inv)?) cot([dht]?(inv)?)? csc([dht]?(inv" _
         & ")?)? ctz cu cube(root)? date_(easter|pesach|rosh_h"
   desc_string = desc_string _
         & "ashanah) day2(dhms(inv)?|hour) deg2(dms|rad|sec|tu" _
         & "r) digamma(__1|inv)? dms2(deg|rad) doomsday ecc2fl" _
         & "at Ein elliptic(1([ak]|m(__[12])?)|2([ak]|m(__1)?)" _
         & "|[EK]) erf(|__([12]|[34])|c(inv|x(inv)?)?|inv) eta"
   desc_string = desc_string _
         & " euler(phi|x) exp(_(_[12]|rand)|integral[1i]|m1)? " _
         & "fac(inv|torial(double|inv)?)? fibo(x(inv)?)? flat2" _
         & "ecc floor frac fubini fusc g2jewish gamma_rand gau" _
         & "_(cdf|pdf|quantile) gd gdinv geo_rand ghmean1(inv)"
   desc_string = desc_string _
         & "? glmean1 gmean1 gqmean1 has_primitiveroot haversi" _
         & "n heaviside heronianmean1 hlmean1 hmean1 hn hn__1 " _
         & "hour2day hqmean1 hypot1(inv)? id int_rand iround i" _
         & "s(even|int|jewish8short|jewish9short|jewishleap|le"
   desc_string = desc_string _
         & "apyear|magic|neg|negint|odd|pos|posint|practical|p" _
         & "rime|squarefree|zero) j2k2(dow|jd|kwt|uet|ymdhms) " _
         & "jacobicir jd2(dow|j2k|kwt|uet|ymdhms) jewish(2(g|j" _
         & "dx?)|_(months_in_year|yearlength)) k2a k2m k2temp["
   desc_string = desc_string _
         & "cfr] ks_a_cdf kwt2(j(2k|d)|uet) l10 lg lgamma(__[1" _
         & "2]|inv)? lix(inv)? lmean1 ln ln1p ln__[12] lns log" _
         & "(10|2|i(ntegral|stic_rand))? lqmean1 lucasx? m2a m" _
         & "2b m2k mertens minkowski mobius neg nom normal_(cd"
   desc_string = desc_string _
         & "f(__1)?|pdf|quantile(__1)?) par(abola_(get|roots)|" _
         & "titionq?) pcf pfg pfl poi_rand pow(10|2) pri(m(e([" _
         & "01]|countx?|n(ext|th(__1)?)|prev)|itiveroot)|nt_(c" _
         & "ontfra(cd?)?|factor|jd264|num2char)) qmean1 rad2(d"
   desc_string = desc_string _
         & "(eg|ms2?)|sec|tur) rand(_init|l) reci reimann roun" _
         & "d rto(125|[iz]) sba search_(check|search) sec(|2(d" _
         & "(eg|hms)|rad|tur)|[dht]?(inv)?) shc_s(hft2steps|te" _
         & "ps2shft(inv)?) sig(m(a[01]|oid(inv)?)|n) sin(|__1|"
   desc_string = desc_string _
         & "c(__1|c|inv)?|d(inv)?|h(inv)?|in(tegral|v)|t(inv)?" _
         & ") smooth sq sqinv sqrt(__[123]|x)? square(root)? s" _
         & "tair stts(_(delete|reset)|count|m(a(gic|x)|ean|in|" _
         & "sq)|s(pread|tdev(mean)?|um)|var) supercatalan tan("
   desc_string = desc_string _
         & "[dht]?(inv)?)? temp(c(2(k|tempf))?|f(2(k|tempc))?|" _
         & "r(2k)?) tgamma(__([123]|stirling)|double|inv)? top" _
         & "yh1 totient tri(_rand|inv|p)? trunc tur2(deg|rad|s" _
         & "ec) uet2(j(2k|d)|kwt) uni_rand versin wm(inv)? wp(" _
         & "inv)? ymdhms(2j(2k|d)|_get) zag zeta zig(zag)?" _
         & vbNewLine
   desc_string = desc_string _
   ...
   desc_string = desc_string _
         & "?|ecc|flatness|m)|tic(1i([ak]|m(__1)?)|2i([ak]|m(_" _
         & "_1)?)|3([ak]|m(__1)?)|Ei|[FP]))) entringer euleria" _
         & "n exp(_(cdf|pdf|quantile)|integraln) factor(ialt)?" _
         & " floor2 fmod([suy]?)? fmul gamma_(cdf|pdf) gcda? g"
   desc_string = desc_string _
         & "eo_(cdf|pdf|quantile) ghmean glmean gmean gompertz" _
         & "_rand gqmean has_primitiveroot_f heronianmean hlme" _
         & "an hmean hnm hqmean hypot int(_(cdf|pdf|quantile)|" _
         & "s_rand) is(eq|ge|gt|le|lt|mult|multl|neq|practical"
   desc_string = desc_string _
         & "_f|primitiveroot|signsame|squarefree_f|ss) jacobip" _
         & "hi jewish_month(begin|length) ks_(b_cdf|cdf|quanti" _
         & "le) lbeta lca(ms?|ntim) lcm lcombx ligamma(inv)? l" _
         & "mean logistic_(cdf|pdf|quantile) lpermx lqmean max"
   desc_string = desc_string _
         & "(2|abs2?|i) mb_(cdf|pdf) mean min(2|abs2?|i) mobiu" _
         & "s_f mod([fs]|ulo) nbd_rand nc nd nevilletheta([cd]" _
         & "|[ns]) ns nthroot__1 pareto_rand perm(utation|x)? " _
         & "pochhammer poi_(cdf|pdf|quantile) poly(a_rand|cnum"
   desc_string = desc_string _
         & "|num) powi? pri(me0_f|nt_base_outf?) qmean rand_in" _
         & "it_array ratio repetendlen rligamma rms round2 rto" _
         & "msd ruigamma sc sd shc_shftpoles2steps sigma(0_f|1" _
         & "_f)? sn sn__1 spread2stdev stdev2spread stirling[1"
   desc_string = desc_string _
         & "2] stts_(copy|downdate|newx|s(cale|hift)|update2?)" _
         & " t_cdf(__1)? t_pdf t_quantile(__1)? tetra(cnum|num" _
         & ") theta([12]|[34]) Tn topyh totient_f trap_rand tr" _
         & "i_(cdf|pdf|quantile) uigamma(__1|inv)? Un uni_(cdf" _
         & "|pdf|quantile) variance zeta_(cdf|pdf) zipf_rand z" _
         & "norder(__1)?" _
         & vbNewLine
   desc_string = desc_string _
         & "   Kw 3-ary Functions: agcmean aghmean atothenmod[" _
         & "px] beta(_(cdf|pdf|quantile)|inc(__1)?) binomial_(" _
         & "cdf|pdf) bits_assign bkbn cantor(ll|ul|xx) carlson"
   desc_string = desc_string _
         & "R[DF] chebeval clip2x? corr_update cossin_ev divi " _
         & "dlogx? elliptic(3i([ak]|m(__1)?)|Pi) epdf2cdf f11 " _
         & "f_cdf f_quantile(__1)? fibo3 fit(_(ls0?|minmax0?|p" _
         & "oly)|x_minmax) fmod2 gompertz_(cdf|pdf|quantile) h"
   desc_string = desc_string _
         & "ms2day horner hypot3 ifzero is(almostequal|between" _
         & "|betweenx|floorsame|within) jewishymd2jd lv_ellpj " _
         & "max(absoffset|min|well_(boltzmann_(cdf|pdf)|juttne" _
         & "r_pdf)) minabsoffset n2perm nbd_(cdf|pdf) pareto_("
   desc_string = desc_string _
         & "cdf|pdf|quantile) pendulum pmean polya_(cdf|pdf) p" _
         & "rint_kevy remquou roundy sigm(a_f|oid3d?) stts_upd" _
         & "atex taninv3 trap_(cdf|pdf|quantile) ymd2(do[wy]|j" _
         & "(2k|d)) zipf_(cdf|pdf|quantile)" _
         & vbNewLine
   desc_string = desc_string _
         & "   Kw 4-ary Functions: carlsonRJ f21 great_circle_" _
         & "distance n2comb sphere_d" _
