...
Public Shared Function lixinv(ByVal yy As Double) As Double
   ...
   lixinv = (scvx_xx)
End Function
Public Shared Function n2primish(ByVal nn As Long) As Long
   Dim retvalu As Long
   If (nn < 0) Then
...
End Function
Public Shared Function ymd2j2k__1(ByVal g_year As Double, _
      ByVal g_month As Double, ByVal g_day As Double) As Double
   Dim yr As Double
   Dim mn As Double
   Dim jtwok As Double
   Dim jcen As Double
   ...
   jtwok = (Math.Floor(yr * Kw.JYEAR / Kw.JDAY) + _
...
Public Shared Function ymd2j2k(ByVal g_year As Double, ByVal _
   ...
   jtwok = (Math.Floor(yr * Kw.JYEAR / Kw.JDAY - 0.0001) + _
         Math.Floor(jcen / 4.0) - jcen + ymd2doy(yr, mn, _
         g_day) - 0.5)
   ymd2j2k = (jtwok)
End Function
...
Public Shared Function jd2ymdhms(ByVal jjulid As Double) As _
   ...
   bdiff = bbdays - Math.Floor(g_years * Kw.JYEAR / Kw.JDAY) _
         + 1522
...
Public Shared Function jewish2jdx(ByVal hebyear As Long) As _
   ...
   months_el = (235 * Math.Floor((hebyear - 1) / _
         LC_YEAR_PER_METONIC) + 12 * hymod + Math.Floor((7 * _
         hymod + 1) / LC_YEAR_PER_METONIC))
   halaqims_el = 204 + (793 * (months_el Mod _
         LC_HALAQIM_PER_HOUR))
   hour_el = (5 + (12 * months_el) + 793 * _
         Math.Floor(months_el / LC_HALAQIM_PER_HOUR) + _
         Math.Floor(halaqims_el / LC_HALAQIM_PER_HOUR))
...
Public Shared Function jewish_yearlength(ByVal hebyear As _
   ...
   retvalu = (Math.Floor(Kw.JYEAR / Kw.JDAY) + _
...
Public Shared Function shc_steps2shftinv(ByVal shft As _
      Double) As Double
   shc_steps2shftinv _
         = ((Math.Pow(2.0, shft + LC_SHC_SHIFTSHIFT) - _
               LC_SHC_STEPSHIFT))
End Function
   ...
   Else
      ...
      Else
         ...
         Else
            ...
            Loop
            temp = eliptwomm * (Math.Atan2(tt, 1.0) + modd * _
...
Public Shared Function nevillethetad(ByVal mm As Double, _
   ...
   Loop
   nevillethetad _
         = (((1.0 + 2.0 * sum_curr) * Math.Sqrt(Kw.TAU / km) _
               / 2.0))
End Function
...
End Function
Public Shared Function bhmass_to_temp(ByVal bhmass As Double) _
      As Double
   bhmass_to_temp = (BHMASSTEMP / bhmass)
End Function
Public Shared Function bhtemp_to_mass(ByVal bhtempk As _
      Double) As Double
   bhtemp_to_mass = (BHMASSTEMP / bhtempk)
End Function
Public Shared Function bhmass_to_radius(ByVal bhmass As _
      Double) As Double
   bhmass_to_radius = (bhmass / BHMASS_RADIUS)
End Function
Public Shared Function bhradius_to_mass(ByVal bhradius As _
      Double) As Double
   bhradius_to_mass = (BHMASS_RADIUS * bhradius)
End Function
Public Shared Function bhmass_to_entropy(ByVal bhmass As _
      Double) As Double
   bhmass_to_entropy = (((bhmass * bhmass) / BHMASS2_ENTROPY))
End Function
Public Shared Function bhentropy_to_mass(ByVal bhentropy As _
      Double) As Double
   bhentropy_to_mass = ((Math.Sqrt(bhentropy * BHMASS2_ENTROPY)))
End Function
Public Shared Function bhmass_to_power(ByVal bhmass As _
      Double) As Double
   bhmass_to_power = ((BHMASS2POWER / (bhmass * bhmass)))
End Function
Public Shared Function bhpower_to_mass(ByVal bhpower As _
      Double) As Double
   bhpower_to_mass = ((Math.Sqrt(BHMASS2POWER / bhpower)))
End Function
Public Shared Function bhmass_to_area(ByVal bhmass As Double) _
      As Double
   bhmass_to_area = (((bhmass * bhmass) / BHMASS2_AREA))
End Function
Public Shared Function bharea_to_mass(ByVal bharea As Double) _
      As Double
   bharea_to_mass = ((Math.Sqrt(BHMASS2_AREA * bharea)))
End Function
Public Shared Function bhmass_to_lifetime(ByVal bhmass As _
      Double) As Double
   bhmass_to_lifetime _
         = (((bhmass * bhmass * bhmass) / BHMASS3_LIFETIME))
End Function
Public Shared Function bhlifetime_to_mass(ByVal bhlifetime As _
      Double) As Double
   bhlifetime_to_mass = ((cbrt(BHMASS3_LIFETIME * bhlifetime)))
End Function
Public Shared Function bhmass_to_density(ByVal bhmass As _
      Double) As Double
   bhmass_to_density = (((bhmass * bhmass) / BHMASS2_DENSITY))
End Function
Public Shared Function bhdensity_to_mass(ByVal bhdensity As _
      Double) As Double
...
Public Shared Function pendulum(ByVal len_m As Double, ByVal _
   ...
   pendulum _
         = ((Kw.TAU * Math.Sqrt(len_m / grav) / Kw.agmean(1.0 _
