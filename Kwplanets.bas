...
' 2020-10-13 kdw  For Changelog, See File Kwplanets.varylog
...
Public Function kwplanets_description() As String
   ...
   desc_string = desc_string _
         & "RFACE CERESVOLUME CERESYEAR EARTH_A EARTH_B EARTH_" _
         & "C EARTHANOMALISTICYEAR EARTHASCENDING EARTHASCENDI" _
         & "NG_DT EARTHDAY EARTHDENSITY EARTHECCENTRICITY EART" _
         & "HECCENTRICITY_DT EARTHFLATNESS EARTHGM EARTHGRAVIT"
   desc_string = desc_string _
         & "Y EARTHINCLINATION EARTHINCLINATION_DT EARTHLONGIT" _
         & "UDE EARTHLONGITUDE_DT EARTHMASS EARTHORBIT EARTHOR" _
         & "BIT_DT EARTHPERIAPSIS EARTHPERIAPSIS_DT EARTHPRECE" _
         & "SSION EARTHRADIUS EARTHSIDEREALDAY EARTHSIDEREALYE"
   desc_string = desc_string _
         & "AR EARTHSTELLARDAY EARTHSURFACE EARTHTHETA_0 EARTH" _
         & "TROPICALYEAR EARTHVOLUME EARTHYEAR ERIS_A ERIS_B E" _
         & "RIS_C ERISASCENDING ERISASCENDING_DT ERISDAY ERISD" _
         & "ENSITY ERISECCENTRICITY ERISECCENTRICITY_DT ERISFL"
   desc_string = desc_string _
         & "ATNESS ERISGM ERISGRAVITY ERISINCLINATION ERISINCL" _
         & "INATION_DT ERISLONGITUDE ERISLONGITUDE_DT ERISMASS" _
         & " ERISORBIT ERISORBIT_DT ERISPERIAPSIS ERISPERIAPSI" _
         & "S_DT ERISRADIUS ERISSURFACE ERISVOLUME ERISYEAR HA"
   desc_string = desc_string _
         & "UMEA_A HAUMEA_B HAUMEA_C HAUMEAASCENDING HAUMEAASC" _
         & "ENDING_DT HAUMEADAY HAUMEADENSITY HAUMEAECCENTRICI" _
         & "TY HAUMEAECCENTRICITY_DT HAUMEAFLATNESS HAUMEAGM H" _
         & "AUMEAGRAVITY HAUMEAINCLINATION HAUMEAINCLINATION_D"
   desc_string = desc_string _
         & "T HAUMEALONGITUDE HAUMEALONGITUDE_DT HAUMEAMASS HA" _
         & "UMEAORBIT HAUMEAORBIT_DT HAUMEAPERIAPSIS HAUMEAPER" _
         & "IAPSIS_DT HAUMEARADIUS HAUMEASURFACE HAUMEAVOLUME " _
         & "HAUMEAYEAR JUPITER_A JUPITER_B JUPITER_C JUPITERAS"
   desc_string = desc_string _
         & "CENDING JUPITERASCENDING_DT JUPITERDAY JUPITERDENS" _
         & "ITY JUPITERECCENTRICITY JUPITERECCENTRICITY_DT JUP" _
         & "ITERFLATNESS JUPITERGM JUPITERGRAVITY JUPITERINCLI" _
         & "NATION JUPITERINCLINATION_DT JUPITERLONGITUDE JUPI"
   desc_string = desc_string _
         & "TERLONGITUDE_DT JUPITERMASS JUPITERORBIT JUPITEROR" _
         & "BIT_DT JUPITERPERIAPSIS JUPITERPERIAPSIS_DT JUPITE" _
         & "RRADIUS JUPITERSURFACE JUPITERVOLUME JUPITERYEAR L" _
         & "C_ISA_DENSITY LC_ISA_PRESSURE LC_ISA_TEMPERATURE L"
   desc_string = desc_string _
         & "C_ISA_XDENSITY LC_ISA_XHEIGHT LC_ISA_XLAPSERATE LC" _
         & "_ISA_XPRESSURE LC_ISA_XTEMPERATURE LC_P1_CERES LC_" _
         & "P1_COUNT LC_P1_EARTH LC_P1_ERIS LC_P1_ERR LC_P1_HA" _
         & "UMEA LC_P1_JUPITER LC_P1_MAKEMAKE LC_P1_MARS LC_P1"
   desc_string = desc_string _
         & "_MERCURY LC_P1_NEPTUNE LC_P1_PLUTO LC_P1_PREV_PL L" _
         & "C_P1_SATURN LC_P1_SUN LC_P1_URANUS LC_P1_VENUS LC_" _
         & "P2_A LC_P2_ASC LC_P2_ASC_DT LC_P2_C LC_P2_COUNT LC" _
         & "_P2_DAY LC_P2_ECC LC_P2_ECC_DT LC_P2_FLATNESS LC_P"
   desc_string = desc_string _
         & "2_GM LC_P2_INC LC_P2_INC_DT LC_P2_LON LC_P2_LON_DT" _
         & " LC_P2_ORB LC_P2_ORB_DT LC_P2_PER LC_P2_PER_DT LC_" _
         & "P2_YEAR LC_PREM_DENSITY LC_PREM_MASS LC_PREM_XCOEA" _
         & " LC_PREM_XCOEB LC_PREM_XCOEC LC_PREM_XHEIGHT LC_PR"
   desc_string = desc_string _
         & "EM_XMASSD MAKEMAKE_A MAKEMAKE_B MAKEMAKE_C MAKEMAK" _
         & "EASCENDING MAKEMAKEASCENDING_DT MAKEMAKEDAY MAKEMA" _
         & "KEDENSITY MAKEMAKEECCENTRICITY MAKEMAKEECCENTRICIT" _
         & "Y_DT MAKEMAKEFLATNESS MAKEMAKEGM MAKEMAKEGRAVITY M"
   desc_string = desc_string _
         & "AKEMAKEINCLINATION MAKEMAKEINCLINATION_DT MAKEMAKE" _
         & "LONGITUDE MAKEMAKELONGITUDE_DT MAKEMAKEMASS MAKEMA" _
         & "KEORBIT MAKEMAKEORBIT_DT MAKEMAKEPERIAPSIS MAKEMAK" _
         & "EPERIAPSIS_DT MAKEMAKERADIUS MAKEMAKESURFACE MAKEM"
   desc_string = desc_string _
         & "AKEVOLUME MAKEMAKEYEAR MARS_A MARS_B MARS_C MARSAS" _
         & "CENDING MARSASCENDING_DT MARSDAY MARSDENSITY MARSE" _
         & "CCENTRICITY MARSECCENTRICITY_DT MARSFLATNESS MARSG" _
         & "M MARSGRAVITY MARSINCLINATION MARSINCLINATION_DT M"
   desc_string = desc_string _
         & "ARSLONGITUDE MARSLONGITUDE_DT MARSMASS MARSORBIT M" _
         & "ARSORBIT_DT MARSPERIAPSIS MARSPERIAPSIS_DT MARSRAD" _
         & "IUS MARSSURFACE MARSVOLUME MARSYEAR MERCURY_A MERC" _
         & "URY_B MERCURY_C MERCURYASCENDING MERCURYASCENDING_"
   desc_string = desc_string _
         & "DT MERCURYDAY MERCURYDENSITY MERCURYECCENTRICITY M" _
         & "ERCURYECCENTRICITY_DT MERCURYFLATNESS MERCURYGM ME" _
         & "RCURYGRAVITY MERCURYINCLINATION MERCURYINCLINATION" _
         & "_DT MERCURYLONGITUDE MERCURYLONGITUDE_DT MERCURYMA"
   desc_string = desc_string _
         & "SS MERCURYORBIT MERCURYORBIT_DT MERCURYPERIAPSIS M" _
         & "ERCURYPERIAPSIS_DT MERCURYRADIUS MERCURYSURFACE ME" _
         & "RCURYVOLUME MERCURYYEAR MOON_A MOON_B MOON_C MOOND" _
         & "AY MOONDENSITY MOONECCENTRICITY MOONFLATNESS MOONG"
   desc_string = desc_string _
         & "M MOONGRAVITY MOONINCLINATION MOONMASS MOONORBIT M" _
         & "OONRADIUS MOONSURFACE MOONVOLUME MOONYEAR NEPTUNE_" _
         & "A NEPTUNE_B NEPTUNE_C NEPTUNEASCENDING NEPTUNEASCE" _
         & "NDING_DT NEPTUNEDAY NEPTUNEDENSITY NEPTUNEECCENTRI"
   desc_string = desc_string _
         & "CITY NEPTUNEECCENTRICITY_DT NEPTUNEFLATNESS NEPTUN" _
         & "EGM NEPTUNEGRAVITY NEPTUNEINCLINATION NEPTUNEINCLI" _
         & "NATION_DT NEPTUNELONGITUDE NEPTUNELONGITUDE_DT NEP" _
         & "TUNEMASS NEPTUNEORBIT NEPTUNEORBIT_DT NEPTUNEPERIA"
   desc_string = desc_string _
         & "PSIS NEPTUNEPERIAPSIS_DT NEPTUNERADIUS NEPTUNESURF" _
         & "ACE NEPTUNEVOLUME NEPTUNEYEAR PLUTO_A PLUTO_B PLUT" _
         & "O_C PLUTOASCENDING PLUTOASCENDING_DT PLUTODAY PLUT" _
         & "ODENSITY PLUTOECCENTRICITY PLUTOECCENTRICITY_DT PL"
   desc_string = desc_string _
         & "UTOFLATNESS PLUTOGM PLUTOGRAVITY PLUTOINCLINATION " _
         & "PLUTOINCLINATION_DT PLUTOLONGITUDE PLUTOLONGITUDE_" _
         & "DT PLUTOMASS PLUTOORBIT PLUTOORBIT_DT PLUTOPERIAPS" _
         & "IS PLUTOPERIAPSIS_DT PLUTORADIUS PLUTOSURFACE PLUT"
   desc_string = desc_string _
         & "OVOLUME PLUTOYEAR SATURN_A SATURN_B SATURN_C SATUR" _
         & "NASCENDING SATURNASCENDING_DT SATURNDAY SATURNDENS" _
         & "ITY SATURNECCENTRICITY SATURNECCENTRICITY_DT SATUR" _
         & "NFLATNESS SATURNGM SATURNGRAVITY SATURNINCLINATION"
   desc_string = desc_string _
         & " SATURNINCLINATION_DT SATURNLONGITUDE SATURNLONGIT" _
         & "UDE_DT SATURNMASS SATURNORBIT SATURNORBIT_DT SATUR" _
         & "NPERIAPSIS SATURNPERIAPSIS_DT SATURNRADIUS SATURNS" _
         & "URFACE SATURNVOLUME SATURNYEAR SIDEREALDAY SIDEREA"
   desc_string = desc_string _
         & "LYEAR STELLARDAY SUN_A SUN_B SUN_C SUNASCENDING SU" _
         & "NASCENDING_DT SUNDAY SUNDENSITY SUNECCENTRICITY SU" _
         & "NECCENTRICITY_DT SUNFLATNESS SUNGM SUNGMIERS SUNGM" _
         & "NASA SUNGRAVITY SUNINCLINATION SUNINCLINATION_DT S"
   desc_string = desc_string _
         & "UNLONGITUDE SUNLONGITUDE_DT SUNMASS SUNORBIT SUNOR" _
         & "BIT_DT SUNPERIAPSIS SUNPERIAPSIS_DT SUNRADIUS SUNS" _
         & "URFACE SUNVOLUME SUNYEAR TROPICALYEAR URANUS_A URA" _
         & "NUS_B URANUS_C URANUSASCENDING URANUSASCENDING_DT "
   desc_string = desc_string _
         & "URANUSDAY URANUSDENSITY URANUSECCENTRICITY URANUSE" _
         & "CCENTRICITY_DT URANUSFLATNESS URANUSGM URANUSGRAVI" _
         & "TY URANUSINCLINATION URANUSINCLINATION_DT URANUSLO" _
         & "NGITUDE URANUSLONGITUDE_DT URANUSMASS URANUSORBIT "
   desc_string = desc_string _
         & "URANUSORBIT_DT URANUSPERIAPSIS URANUSPERIAPSIS_DT " _
         & "URANUSRADIUS URANUSSURFACE URANUSVOLUME URANUSYEAR" _
         & " VENUS_A VENUS_B VENUS_C VENUSASCENDING VENUSASCEN" _
         & "DING_DT VENUSDAY VENUSDENSITY VENUSECCENTRICITY VE"
   desc_string = desc_string _
         & "NUSECCENTRICITY_DT VENUSFLATNESS VENUSGM VENUSGRAV" _
         ...
         & "IUS VENUSSURFACE VENUSVOLUME VENUSYEAR" _
         & vbNewLine
   desc_string = desc_string _
...
Public Function kwplanets_desc() As String
   ...
   desc_string = desc_string _
         & "_DT)?|MASS|ORBIT(_DT)?|PERIAPSIS(_DT)?|RADIUS|SURF" _
         & "ACE|VOLUME|YEAR) EARTH(_[ABC]|A(NOMALISTICYEAR|SCE" _
         & "NDING(_DT)?)|D(AY|ENSITY)|ECCENTRICITY(_DT)?|FLATN" _
         & "ESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|"
   desc_string = desc_string _
         & "MASS|ORBIT(_DT)?|P(ERIAPSIS(_DT)?|RECESSION)|RADIU" _
         & "S|S(IDEREAL(DAY|YEAR)|TELLARDAY|URFACE)|T(HETA_0|R" _
         & "OPICALYEAR)|VOLUME|YEAR) ERIS(_[ABC]|ASCENDING(_DT" _
         & ")?|D(AY|ENSITY)|ECCENTRICITY(_DT)?|FLATNESS|G(M|RA"
   desc_string = desc_string _
         & "VITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|ORBIT" _
         & "(_DT)?|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR)" _
         & " HAUMEA(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|ECCENT" _
         & "RICITY(_DT)?|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)"
   desc_string = desc_string _
         & "?|LONGITUDE(_DT)?|MASS|ORBIT(_DT)?|PERIAPSIS(_DT)?" _
         & "|RADIUS|SURFACE|VOLUME|YEAR) JUPITER(_[ABC]|ASCEND" _
         & "ING(_DT)?|D(AY|ENSITY)|ECCENTRICITY(_DT)?|FLATNESS" _
         & "|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MAS"
   desc_string = desc_string _
         & "S|ORBIT(_DT)?|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUM" _
         & "E|YEAR) LC_(ISA_(DENSITY|PRESSURE|TEMPERATURE|X(DE" _
         & "NSITY|HEIGHT|LAPSERATE|PRESSURE|TEMPERATURE))|P(1_" _
         & "(C(ERES|OUNT)|E(ARTH|R(IS|R))|HAUMEA|JUPITER|M(A(K"
   desc_string = desc_string _
         & "EMAKE|RS)|ERCURY)|NEPTUNE|P(LUTO|REV_PL)|S(ATURN|U" _
         & "N)|URANUS|VENUS)|2_(A(SC(_DT)?)?|C(OUNT)?|DAY|ECC(" _
         & "_DT)?|FLATNESS|GM|INC(_DT)?|LON(_DT)?|ORB(_DT)?|PE" _
         & "R(_DT)?|YEAR)|REM_(DENSITY|MASS|X(COE[ABC]|HEIGHT|"
   desc_string = desc_string _
         & "MASSD)))) MAKEMAKE(_[ABC]|ASCENDING(_DT)?|D(AY|ENS" _
         & "ITY)|ECCENTRICITY(_DT)?|FLATNESS|G(M|RAVITY)|INCLI" _
         & "NATION(_DT)?|LONGITUDE(_DT)?|MASS|ORBIT(_DT)?|PERI" _
         & "APSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) MARS(_[ABC"
   desc_string = desc_string _
         & "]|ASCENDING(_DT)?|D(AY|ENSITY)|ECCENTRICITY(_DT)?|" _
         & "FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_" _
         & "DT)?|MASS|ORBIT(_DT)?|PERIAPSIS(_DT)?|RADIUS|SURFA" _
         & "CE|VOLUME|YEAR) MERCURY(_[ABC]|ASCENDING(_DT)?|D(A"
   desc_string = desc_string _
         & "Y|ENSITY)|ECCENTRICITY(_DT)?|FLATNESS|G(M|RAVITY)|" _
         & "INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|ORBIT(_DT)?" _
         & "|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) MOON(" _
         & "_[ABC]|D(AY|ENSITY)|ECCENTRICITY|FLATNESS|G(M|RAVI"
   desc_string = desc_string _
         & "TY)|INCLINATION|MASS|ORBIT|RADIUS|SURFACE|VOLUME|Y" _
         & "EAR) NEPTUNE(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E" _
         & "CCENTRICITY(_DT)?|FLATNESS|G(M|RAVITY)|INCLINATION" _
         & "(_DT)?|LONGITUDE(_DT)?|MASS|ORBIT(_DT)?|PERIAPSIS("
   desc_string = desc_string _
         & "_DT)?|RADIUS|SURFACE|VOLUME|YEAR) PLUTO(_[ABC]|ASC" _
         & "ENDING(_DT)?|D(AY|ENSITY)|ECCENTRICITY(_DT)?|FLATN" _
         & "ESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|" _
         & "MASS|ORBIT(_DT)?|PERIAPSIS(_DT)?|RADIUS|SURFACE|VO"
   desc_string = desc_string _
         & "LUME|YEAR) SATURN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSI" _
         & "TY)|ECCENTRICITY(_DT)?|FLATNESS|G(M|RAVITY)|INCLIN" _
         & "ATION(_DT)?|LONGITUDE(_DT)?|MASS|ORBIT(_DT)?|PERIA" _
         & "PSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) SIDEREAL(DA"
   desc_string = desc_string _
         & "Y|YEAR) STELLARDAY SUN(_[ABC]|ASCENDING(_DT)?|D(AY" _
         & "|ENSITY)|ECCENTRICITY(_DT)?|FLATNESS|G(M(IERS|NASA" _
         & ")?|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|" _
         & "ORBIT(_DT)?|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|"
   desc_string = desc_string _
         & "YEAR) TROPICALYEAR URANUS(_[ABC]|ASCENDING(_DT)?|D" _
         & "(AY|ENSITY)|ECCENTRICITY(_DT)?|FLATNESS|G(M|RAVITY" _
         & ")|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|ORBIT(_DT" _
         & ")?|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) VEN"
   desc_string = desc_string _
         & "US(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|ECCENTRICIT" _
         & "Y(_DT)?|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LON" _
         & "GITUDE(_DT)?|MASS|ORBIT(_DT)?|PERIAPSIS(_DT)?|RADI" _
         & "US|SURFACE|VOLUME|YEAR)" _
         & vbNewLine
   desc_string = desc_string _
   ...
   desc_string = desc_string _
         ...
         & "o plsettime prem_(density|g|mass) water_boiling" _
         & vbNewLine
   desc_string = desc_string _
         & "   Kwplanets 2-ary Functions: earth_gravity_height" _
