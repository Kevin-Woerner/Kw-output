...
Private lv_plsun_arr(3) As Double
Private lv_plgeo_arr(3) As Double
Private lv_pl_ind As Long
Private lv_pl_mtrx(LC_P1_CNT, LC_P2_CNT) As Double
...
Private lv_isa_mtrx(LC_ISA_CNT, LC_ISA_KEY_CNT) As Double
...
Private lv_prem_mtrx(12, 6) As Double
Private lv_prem_magic As Double
'IMPORT "Kw"
'IMPORT "Kwelements"
Public Function orbitgm_v(ByVal gm_gm As Double, ByVal orbit_m As Double) _
         As Double
   orbitgm_v = Sqr(gm_gm / orbit_m)
End Function
Public Function orbit_v(ByVal mass_kg As Double, ByVal orbit_m As Double) _
         As Double
   orbit_v = orbitgm_v(Kw.GRAVITATION * mass_kg, orbit_m)
End Function
Public Function margot(ByVal pmass As Double, ByVal porbit As Double) As _
         Double
   ...
   margot = retvalu
End Function
Public Function sternlevison(ByVal pmass As Double, ByVal porbit As _
         Double) As Double
   Dim retvalu As Double
   Dim xx As Double
   If (pmass <= 0.0 Or porbit <= 0.0) Then
...
End Function
Private Function lf_val(ByVal pa_ind As Long, ByVal pb_bb As Long, ByVal _
         pb_bbd As Long) As Double
   Dim pl_ind As Long
   Dim retvalu As Double
...
End Function
Public Function pl_surface(ByVal plnt As Long) As Double
   Dim retvalu As Double
   If (plnt < LC_P1_PREV_PL Or LC_P1_CNT <= plnt) Then
      retvalu = LC_P1_ERR
   Else
   ...
   pl_surface = retvalu
End Function
Public Function plsurface() As Double
   ' local-use Vb6 lv_pl_ind
...
End Function
Public Function eccentric_anomaly(ByVal mean_ano_rad As Double, ByVal _
         eccen As Double) As Double
   Dim mrad As Double
   Dim xrad As Double
   Dim nrvx_ii As Long
...
End Function
Public Function pl_heliocentric(ByVal plnt As Long, ByVal jtwok As _
         Double) As Double
   ' local-use Vb6 lv_plsun_arr
   ' local-use Vb6 lv_plgeo_arr
   Dim orb_m As Double
   Dim eccen As Double
...
End Function
Public Function earthradius(ByVal lat_deg As Double) As Double
   earthradius = pl_aradius(LC_P1_EARTH, lat_deg)
End Function
Public Function earthtropicalyear(ByVal jtwokdate As Double) As Double
   Dim jy As Double
   jy = jtwokdate * Kw.EARTH_SOLARDAY / Kw.JYEAR
   earthtropicalyear = ((((2.64E-16) * jy - 7.29E-14) * jy - 6.15359E-8) _
            * jy + 365.2421896698)
End Function
Public Function earthdistance(ByVal lata_deg As Double, ByVal lona_deg As _
         Double, ByVal latb_deg As Double, ByVal lonb_deg As Double) As _
         Double
...
Public Function plaradius(ByVal lat_deg As Double) As Double
   ...
   plaradius = Sqr((aa * calat + bb * sblat) / (calat + sblat))
End Function
Public Function pl_aradius(ByVal plnt As Long, ByVal lat_deg As Double) _
         As Double
   Call pl(plnt)
   pl_aradius = plaradius(lat_deg)
End Function
Public Function earthobliquity(ByVal jtwok As Double) As Double
   Dim tmill As Double
...
End Function
Public Function earthprecession(ByVal jtwok As Double) As Double
   Dim tmill As Double
   Dim ob_arcsec As Double
   tmill = jtwok * Kw.EARTH_SOLARDAY / (1.0E+4 * Kw.JYEAR)
...
End Function
Public Function earthgravity(ByVal lat_deg As Double) As Double
   ...
   earthgravity = (EARTH_GRAVITYA + kk * slatsq) / Sqr(1.0 - obltsq * slatsq)
End Function
Public Function earthgravity_height(ByVal lat_deg As Double, ByVal _
         height_m As Double) As Double
   earthgravity_height = (earthgravity(lat_deg) - height_m * 2.0 * _
            EARTH_GM / Kw.cube(EARTH_A))
End Function
Private Function lf_isa_calc(ByVal height_m As Double, ByVal state_x As _
         Long) As Double
...
End Function
Public Function vin_distance(ByVal lata_deg As Double, ByVal lona_deg As _
         Double, ByVal latb_deg As Double, ByVal lonb_deg As Double, _
         ByRef ret_bearings_arr_p() As Double) As Double
   Dim retvalu As Double
...
End Function
Public Function vin_destination(ByVal lata_deg As Double, ByVal lona_deg _
         As Double, ByVal heading_deg As Double, ByVal dist_m As Double, _
         ByRef ret_dest_arr_p() As Double) As Double
...
End Function
Private Function lf_prem(ByVal height_m As Double, ByVal state_x As Long) _
         As Double
   Dim coec As Double
   Dim coeb As Double
   Dim coea As Double
   ...
   lf_prem = retvalu
End Function
Public Function prem_density(ByVal height_m As Double) As Double
   prem_density = lf_prem(height_m, LC_PREM_DENS)
End Function
Public Function prem_mass(ByVal height_m As Double) As Double
   prem_mass = lf_prem(height_m, LC_PREM_MASS)
End Function
Public Function prem_g(ByVal height_m As Double) As Double
   Dim retvalu As Double
   If (height_m <= 0.0) Then
      retvalu = 0.0
   Else
