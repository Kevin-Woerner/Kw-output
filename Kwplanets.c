...
double cxsunsurface(void) { return (SUNSURFACE); }
...
double cxmercurysurface(void) { return (MERCURYSURFACE); }
...
double cxvenussurface(void) { return (VENUSSURFACE); }
...
double cxearthsurface(void) { return (EARTHSURFACE); }
...
double cxmarssurface(void) { return (MARSSURFACE); }
...
double cxjupitersurface(void) { return (JUPITERSURFACE); }
...
double cxsaturnsurface(void) { return (SATURNSURFACE); }
...
double cxuranussurface(void) { return (URANUSSURFACE); }
...
double cxneptunesurface(void) { return (NEPTUNESURFACE); }
...
double cxplutosurface(void) { return (PLUTOSURFACE); }
...
double cxmoonsurface(void) { return (MOONSURFACE); }
...
double cxceressurface(void) { return (CERESSURFACE); }
...
double cxerissurface(void) { return (ERISSURFACE); }
...
double cxmakemakesurface(void) { return (MAKEMAKESURFACE); }
...
double cxhaumeasurface(void) { return (HAUMEASURFACE); }
...
double pl_surface(long plnt)
{
   ...
   if (plnt < LC_P1_PREV_PL || LC_P1_COUNT <= plnt) {
      ...
      retvalu = ellipsoid_surface(pl_a(plnt), pl_b(plnt),\
            pl_c(plnt));
   }
   return (retvalu);
}
...
#define LC_PREM_DENSITY 0
#define LC_PREM_MASS 1
#define LC_PREM_XHEIGHT 0
#define LC_PREM_XCOEA 1
#define LC_PREM_XCOEB 2
#define LC_PREM_XCOEC 3
#define LC_PREM_XMASSD 4
      ...
      , long state_x)
{
   ...
   if (height_m <= 0) {
      ...
      if (state_x == 0) {
         ...
         mass_a = 2.0 * TAU * height_m * height_m * height_m\
               * ((coec / 5.0 * height_m + coeb / 4.0) *\
               height_m + coea / 3.0);
...
double prem_g(double height_m)
{
   ...
   if (height_m <= 0) {
      ...
      retvalu = GRAVITATION * prem_mass(height_m) / (height_m\
            * height_m);
   }
   return (retvalu);
}
