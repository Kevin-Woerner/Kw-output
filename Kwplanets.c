...
double cxmercurysynodic(void) { return (MERCURYSYNODIC); }
...
double cxvenussynodic(void) { return (VENUSSYNODIC); }
...
double cxmarssynodic(void) { return (MARSSYNODIC); }
...
double cxjupitersynodic(void) { return (JUPITERSYNODIC); }
...
double cxsaturnsynodic(void) { return (SATURNSYNODIC); }
...
double cxuranussynodic(void) { return (URANUSSYNODIC); }
...
double cxneptunesynodic(void) { return (NEPTUNESYNODIC); }
...
double cxplutosynodic(void) { return (PLUTOSYNODIC); }
...
double cxmoonsynodic(void) { return (MOONSYNODIC); }
...
double cxceressynodic(void) { return (CERESSYNODIC); }
...
double cxerissynodic(void) { return (ERISSYNODIC); }
...
double cxmakemakesynodic(void) { return (MAKEMAKESYNODIC); }
...
double cxhaumeasynodic(void) { return (HAUMEASYNODIC); }
