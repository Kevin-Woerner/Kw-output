...
'IMPORT "Kw"
Public Shared Function watervapor_pressure(ByVal temp_k As Double) As Double
...
End Function
Public Shared Function watervaporization(ByVal temp_k As Double) As Double
   Dim retvalu As Double
   If (WATER_CRITICAL <= temp_k) Then
      retvalu = 0.0
   Else
      retvalu = Math.Pow((WATER_CRITICAL - temp_k) / (WATER_CRITICAL - _
               373.15), 0.37) * WATER_VAPORIZATION_JPMOLE
   End If
   watervaporization = retvalu
End Function
Public Shared Function waterboiling(ByVal pressure_pa As Double) As Double
   Dim retvalu As Double
...
End Function
Public Shared Function waterdensity_airfree(ByVal temp_k As Double) As Double
   Dim temp_c As Double
   Dim retvalu As Double
   temp_c = Kw.k2tempc(temp_k)
...
End Function
Public Shared Function waterdensity(ByVal temp_k As Double) As Double
   Dim temp_c As Double
   Dim retvalu As Double
   temp_c = Kw.k2tempc(temp_k)
   If (temp_c < 0.0) Then
...
End Function
Public Shared Function waterdensity_airfree__1(ByVal temp_k As Double) As _
         Double
   Dim temp_c As Double
   Dim retvalu As Double
   temp_c = Kw.k2tempc(temp_k)
