...
def kwplanets_description():
   ...
   "UME JUPITERYEAR MAKEMAKE_A MAKEMAKE_B MAKEMAKE_C MAKEMAK" + \
   ...
   "ERIAPSIS_DT MAKEMAKERADIUS MAKEMAKEVOLUME MAKEMAKEYEAR M" + \
   "ARS_A MARS_B MARS_C MARSASCENDING MARSASCENDING_DT MARSD" + \
   "AY MARSDENSITY MARSECCENTRICITY MARSECCENTRICITY_DT MARS" + \
   "ESCAPE MARSFLATNESS MARSGM MARSGRAVITY MARSINCLINATION M" + \
   "ARSINCLINATION_DT MARSLONGITUDE MARSLONGITUDE_DT MARSMAS" + \
   "S MARSOBLATENESS MARSORBIT MARSORBIT_DT MARSPERIAPSIS MA" + \
   "RSPERIAPSIS_DT MARSRADIUS MARSVOLUME MARSYEAR MERCURY_A " + \
   "MERCURY_B MERCURY_C MERCURYASCENDING MERCURYASCENDING_DT" + \
   " MERCURYDAY MERCURYDENSITY MERCURYECCENTRICITY MERCURYEC" + \
   "CENTRICITY_DT MERCURYESCAPE MERCURYFLATNESS MERCURYGM ME" + \
   "RCURYGRAVITY MERCURYINCLINATION MERCURYINCLINATION_DT ME" + \
   "RCURYLONGITUDE MERCURYLONGITUDE_DT MERCURYMASS MERCURYOB" + \
   "LATENESS MERCURYORBIT MERCURYORBIT_DT MERCURYPERIAPSIS M" + \
   "ERCURYPERIAPSIS_DT MERCURYRADIUS MERCURYVOLUME MERCURYYE" + \
   "AR MOON_A MOON_B MOON_C MOONDAY MOONDENSITY MOONECCENTRI" + \
   "CITY MOONESCAPE MOONFLATNESS MOONGM MOONGRAVITY MOONINCL" + \
   "INATION MOONMASS MOONOBLATENESS MOONORBIT MOONRADIUS MOO" + \
   "NVOLUME MOONYEAR NEPTUNE_A NEPTUNE_B NEPTUNE_C NEPTUNEAS" + \
   "CENDING NEPTUNEASCENDING_DT NEPTUNEDAY NEPTUNEDENSITY NE" + \
   "PTUNEECCENTRICITY NEPTUNEECCENTRICITY_DT NEPTUNEESCAPE N" + \
   "EPTUNEFLATNESS NEPTUNEGM NEPTUNEGRAVITY NEPTUNEINCLINATI" + \
   "ON NEPTUNEINCLINATION_DT NEPTUNELONGITUDE NEPTUNELONGITU" + \
   "DE_DT NEPTUNEMASS NEPTUNEOBLATENESS NEPTUNEORBIT NEPTUNE" + \
   "ORBIT_DT NEPTUNEPERIAPSIS NEPTUNEPERIAPSIS_DT NEPTUNERAD" + \
   "IUS NEPTUNEVOLUME NEPTUNEYEAR PLUTO_A PLUTO_B PLUTO_C PL" + \
   "UTOASCENDING PLUTOASCENDING_DT PLUTODAY PLUTODENSITY PLU" + \
   "TOECCENTRICITY PLUTOECCENTRICITY_DT PLUTOESCAPE PLUTOFLA" + \
   "TNESS PLUTOGM PLUTOGRAVITY PLUTOINCLINATION PLUTOINCLINA" + \
   "TION_DT PLUTOLONGITUDE PLUTOLONGITUDE_DT PLUTOMASS PLUTO" + \
   "OBLATENESS PLUTOORBIT PLUTOORBIT_DT PLUTOPERIAPSIS PLUTO" + \
   "PERIAPSIS_DT PLUTORADIUS PLUTOVOLUME PLUTOYEAR SATURN_A " + \
   "SATURN_B SATURN_C SATURNASCENDING SATURNASCENDING_DT SAT" + \
   "URNDAY SATURNDENSITY SATURNECCENTRICITY SATURNECCENTRICI" + \
   "TY_DT SATURNESCAPE SATURNFLATNESS SATURNGM SATURNGRAVITY" + \
   " SATURNINCLINATION SATURNINCLINATION_DT SATURNLONGITUDE " + \
   "SATURNLONGITUDE_DT SATURNMASS SATURNOBLATENESS SATURNORB" + \
   "IT SATURNORBIT_DT SATURNPERIAPSIS SATURNPERIAPSIS_DT SAT" + \
   "URNRADIUS SATURNVOLUME SATURNYEAR SIDEREALDAY SIDEREALYE" + \
   "AR STELLARDAY SUN_A SUN_B SUN_C SUNASCENDING SUNASCENDIN" + \
   "G_DT SUNDAY SUNDENSITY SUNECCENTRICITY SUNECCENTRICITY_D" + \
   "T SUNESCAPE SUNFLATNESS SUNGM SUNGMIERS SUNGMNASA SUNGRA" + \
   "VITY SUNINCLINATION SUNINCLINATION_DT SUNLONGITUDE SUNLO" + \
   "NGITUDE_DT SUNMASS SUNOBLATENESS SUNORBIT SUNORBIT_DT SU" + \
   "NPERIAPSIS SUNPERIAPSIS_DT SUNRADIUS SUNVOLUME SUNYEAR T" + \
   "ROPICALYEAR URANUS_A URANUS_B URANUS_C URANUSASCENDING U" + \
   "RANUSASCENDING_DT URANUSDAY URANUSDENSITY URANUSECCENTRI" + \
   "CITY URANUSECCENTRICITY_DT URANUSESCAPE URANUSFLATNESS U" + \
   "RANUSGM URANUSGRAVITY URANUSINCLINATION URANUSINCLINATIO" + \
   "N_DT URANUSLONGITUDE URANUSLONGITUDE_DT URANUSMASS URANU" + \
   "SOBLATENESS URANUSORBIT URANUSORBIT_DT URANUSPERIAPSIS U" + \
   "RANUSPERIAPSIS_DT URANUSRADIUS URANUSVOLUME URANUSYEAR V" + \
   "ENUS_A VENUS_B VENUS_C VENUSASCENDING VENUSASCENDING_DT " + \
   "VENUSDAY VENUSDENSITY VENUSECCENTRICITY VENUSECCENTRICIT" + \
   "Y_DT VENUSESCAPE VENUSFLATNESS VENUSGM VENUSGRAVITY VENU" + \
   "SINCLINATION VENUSINCLINATION_DT VENUSLONGITUDE VENUSLON" + \
   "GITUDE_DT VENUSMASS VENUSOBLATENESS VENUSORBIT VENUSORBI" + \
   "T_DT VENUSPERIAPSIS VENUSPERIAPSIS_DT VENUSRADIUS VENUSV" + \
   "OLUME VENUSYEAR" + \
   "\n" + \
...
def kwplanets_desc():
   ...
   "TNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS" + \
   "|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|Y" + \
   "EAR) MAKEMAKE(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCEN" + \
   "TRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_D" + \
   "T)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPS" + \
   "IS(_DT)?|RADIUS|VOLUME|YEAR) MARS(_[ABC]|ASCENDING(_DT)?" + \
   "|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RA" + \
   "VITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS" + \
   "|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) MERCURY" + \
   "(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?" + \
   "|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE" + \
   "(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADI" + \
   "US|VOLUME|YEAR) MOON(_[ABC]|D(AY|ENSITY)|E(CCENTRICITY|S" + \
   "CAPE)|FLATNESS|G(M|RAVITY)|INCLINATION|MASS|O(BLATENESS|" + \
   "RBIT)|RADIUS|VOLUME|YEAR) NEPTUNE(_[ABC]|ASCENDING(_DT)?" + \
   "|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RA" + \
   "VITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS" + \
   "|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) PLUTO(_" + \
   ...
   "|VOLUME|YEAR) SATURN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)" + \
   "|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINA" + \
   "TION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|" + \
   "PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) SIDEREAL(DAY|YEAR) S" + \
   "TELLARDAY SUN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCEN" + \
   "TRICITY(_DT)?|SCAPE)|FLATNESS|G(M(IERS|NASA)?|RAVITY)|IN" + \
   "CLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_D" + \
   "T)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) TROPICALYEAR UR" + \
   "ANUS(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_" + \
   "DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGI" + \
   "TUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|" + \
   "RADIUS|VOLUME|YEAR) VENUS(_[ABC]|ASCENDING(_DT)?|D(AY|EN" + \
   "SITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|IN" + \
   "CLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_D" + \
   "T)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR)" + \
   "\n" + \
