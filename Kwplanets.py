...
def kwplanets_description():
   ...
   "PSIS CERESPERIAPSIS_DT CERESRADIUS CERESSURFACE CERESVOL" + \
   "UME CERESYEAR EARTH_A EARTH_B EARTH_C EARTHANOMALISTICYE" + \
   "AR EARTHASCENDING EARTHASCENDING_DT EARTHDAY EARTHDENSIT" + \
   "Y EARTHECCENTRICITY EARTHECCENTRICITY_DT EARTHESCAPE EAR" + \
   "THFLATNESS EARTHGM EARTHGRAVITY EARTHINCLINATION EARTHIN" + \
   "CLINATION_DT EARTHLONGITUDE EARTHLONGITUDE_DT EARTHMASS " + \
   "EARTHOBLATENESS EARTHORBIT EARTHORBIT_DT EARTHPERIAPSIS " + \
   "EARTHPERIAPSIS_DT EARTHPRECESSION EARTHRADIUS EARTHSIDER" + \
   "EALDAY EARTHSIDEREALYEAR EARTHSTELLARDAY EARTHSURFACE EA" + \
   "RTHTHETA_0 EARTHTROPICALYEAR EARTHVOLUME EARTHYEAR ERIS_" + \
   "A ERIS_B ERIS_C ERISASCENDING ERISASCENDING_DT ERISDAY E" + \
   "RISDENSITY ERISECCENTRICITY ERISECCENTRICITY_DT ERISESCA" + \
   "PE ERISFLATNESS ERISGM ERISGRAVITY ERISINCLINATION ERISI" + \
   "NCLINATION_DT ERISLONGITUDE ERISLONGITUDE_DT ERISMASS ER" + \
   "ISOBLATENESS ERISORBIT ERISORBIT_DT ERISPERIAPSIS ERISPE" + \
   "RIAPSIS_DT ERISRADIUS ERISSURFACE ERISVOLUME ERISYEAR HA" + \
   "UMEA_A HAUMEA_B HAUMEA_C HAUMEAASCENDING HAUMEAASCENDING" + \
   "_DT HAUMEADAY HAUMEADENSITY HAUMEAECCENTRICITY HAUMEAECC" + \
   "ENTRICITY_DT HAUMEAESCAPE HAUMEAFLATNESS HAUMEAGM HAUMEA" + \
   "GRAVITY HAUMEAINCLINATION HAUMEAINCLINATION_DT HAUMEALON" + \
   "GITUDE HAUMEALONGITUDE_DT HAUMEAMASS HAUMEAOBLATENESS HA" + \
   "UMEAORBIT HAUMEAORBIT_DT HAUMEAPERIAPSIS HAUMEAPERIAPSIS" + \
   "_DT HAUMEARADIUS HAUMEASURFACE HAUMEAVOLUME HAUMEAYEAR J" + \
   "UPITER_A JUPITER_B JUPITER_C JUPITERASCENDING JUPITERASC" + \
   "ENDING_DT JUPITERDAY JUPITERDENSITY JUPITERECCENTRICITY " + \
   "JUPITERECCENTRICITY_DT JUPITERESCAPE JUPITERFLATNESS JUP" + \
   "ITERGM JUPITERGRAVITY JUPITERINCLINATION JUPITERINCLINAT" + \
   "ION_DT JUPITERLONGITUDE JUPITERLONGITUDE_DT JUPITERMASS " + \
   "JUPITEROBLATENESS JUPITERORBIT JUPITERORBIT_DT JUPITERPE" + \
   "RIAPSIS JUPITERPERIAPSIS_DT JUPITERRADIUS JUPITERSURFACE" + \
   " JUPITERVOLUME JUPITERYEAR LC_ISA_DENSITY LC_ISA_PRESSUR" + \
   "E LC_ISA_TEMPERATURE LC_ISA_XDENSITY LC_ISA_XHEIGHT LC_I" + \
   "SA_XLAPSERATE LC_ISA_XPRESSURE LC_ISA_XTEMPERATURE LC_P1" + \
   "_CERES LC_P1_COUNT LC_P1_EARTH LC_P1_ERIS LC_P1_ERR LC_P" + \
   "1_HAUMEA LC_P1_JUPITER LC_P1_MAKEMAKE LC_P1_MARS LC_P1_M" + \
   "ERCURY LC_P1_NEPTUNE LC_P1_PLUTO LC_P1_PREV_PL LC_P1_SAT" + \
   "URN LC_P1_SUN LC_P1_URANUS LC_P1_VENUS LC_P2_A LC_P2_ASC" + \
   " LC_P2_ASC_DT LC_P2_C LC_P2_COUNT LC_P2_DAY LC_P2_ECC LC" + \
   "_P2_ECC_DT LC_P2_FLATNESS LC_P2_GM LC_P2_INC LC_P2_INC_D" + \
   "T LC_P2_LON LC_P2_LON_DT LC_P2_ORB LC_P2_ORB_DT LC_P2_PE" + \
   "R LC_P2_PER_DT LC_P2_YEAR LC_PREM_DENSITY LC_PREM_MASS L" + \
   "C_PREM_XCOEA LC_PREM_XCOEB LC_PREM_XCOEC LC_PREM_XHEIGHT" + \
   " LC_PREM_XMASSD MAKEMAKE_A MAKEMAKE_B MAKEMAKE_C MAKEMAK" + \
   "EASCENDING MAKEMAKEASCENDING_DT MAKEMAKEDAY MAKEMAKEDENS" + \
   "ITY MAKEMAKEECCENTRICITY MAKEMAKEECCENTRICITY_DT MAKEMAK" + \
   "EESCAPE MAKEMAKEFLATNESS MAKEMAKEGM MAKEMAKEGRAVITY MAKE" + \
   "MAKEINCLINATION MAKEMAKEINCLINATION_DT MAKEMAKELONGITUDE" + \
   " MAKEMAKELONGITUDE_DT MAKEMAKEMASS MAKEMAKEOBLATENESS MA" + \
   "KEMAKEORBIT MAKEMAKEORBIT_DT MAKEMAKEPERIAPSIS MAKEMAKEP" + \
   "ERIAPSIS_DT MAKEMAKERADIUS MAKEMAKESURFACE MAKEMAKEVOLUM" + \
   "E MAKEMAKEYEAR MARS_A MARS_B MARS_C MARSASCENDING MARSAS" + \
   "CENDING_DT MARSDAY MARSDENSITY MARSECCENTRICITY MARSECCE" + \
   "NTRICITY_DT MARSESCAPE MARSFLATNESS MARSGM MARSGRAVITY M" + \
   "ARSINCLINATION MARSINCLINATION_DT MARSLONGITUDE MARSLONG" + \
   "ITUDE_DT MARSMASS MARSOBLATENESS MARSORBIT MARSORBIT_DT " + \
   "MARSPERIAPSIS MARSPERIAPSIS_DT MARSRADIUS MARSSURFACE MA" + \
   "RSVOLUME MARSYEAR MERCURY_A MERCURY_B MERCURY_C MERCURYA" + \
   "SCENDING MERCURYASCENDING_DT MERCURYDAY MERCURYDENSITY M" + \
   "ERCURYECCENTRICITY MERCURYECCENTRICITY_DT MERCURYESCAPE " + \
   "MERCURYFLATNESS MERCURYGM MERCURYGRAVITY MERCURYINCLINAT" + \
   "ION MERCURYINCLINATION_DT MERCURYLONGITUDE MERCURYLONGIT" + \
   "UDE_DT MERCURYMASS MERCURYOBLATENESS MERCURYORBIT MERCUR" + \
   "YORBIT_DT MERCURYPERIAPSIS MERCURYPERIAPSIS_DT MERCURYRA" + \
   "DIUS MERCURYSURFACE MERCURYVOLUME MERCURYYEAR MOON_A MOO" + \
   "N_B MOON_C MOONDAY MOONDENSITY MOONECCENTRICITY MOONESCA" + \
   "PE MOONFLATNESS MOONGM MOONGRAVITY MOONINCLINATION MOONM" + \
   "ASS MOONOBLATENESS MOONORBIT MOONRADIUS MOONSURFACE MOON" + \
   ...
   "US NEPTUNESURFACE NEPTUNEVOLUME NEPTUNEYEAR PLUTO_A PLUT" + \
   "O_B PLUTO_C PLUTOASCENDING PLUTOASCENDING_DT PLUTODAY PL" + \
   "UTODENSITY PLUTOECCENTRICITY PLUTOECCENTRICITY_DT PLUTOE" + \
   "SCAPE PLUTOFLATNESS PLUTOGM PLUTOGRAVITY PLUTOINCLINATIO" + \
   "N PLUTOINCLINATION_DT PLUTOLONGITUDE PLUTOLONGITUDE_DT P" + \
   "LUTOMASS PLUTOOBLATENESS PLUTOORBIT PLUTOORBIT_DT PLUTOP" + \
   "ERIAPSIS PLUTOPERIAPSIS_DT PLUTORADIUS PLUTOSURFACE PLUT" + \
   "OVOLUME PLUTOYEAR SATURN_A SATURN_B SATURN_C SATURNASCEN" + \
   "DING SATURNASCENDING_DT SATURNDAY SATURNDENSITY SATURNEC" + \
   "CENTRICITY SATURNECCENTRICITY_DT SATURNESCAPE SATURNFLAT" + \
   "NESS SATURNGM SATURNGRAVITY SATURNINCLINATION SATURNINCL" + \
   "INATION_DT SATURNLONGITUDE SATURNLONGITUDE_DT SATURNMASS" + \
   " SATURNOBLATENESS SATURNORBIT SATURNORBIT_DT SATURNPERIA" + \
   "PSIS SATURNPERIAPSIS_DT SATURNRADIUS SATURNSURFACE SATUR" + \
   "NVOLUME SATURNYEAR SIDEREALDAY SIDEREALYEAR STELLARDAY S" + \
   "UN_A SUN_B SUN_C SUNASCENDING SUNASCENDING_DT SUNDAY SUN" + \
   "DENSITY SUNECCENTRICITY SUNECCENTRICITY_DT SUNESCAPE SUN" + \
   "FLATNESS SUNGM SUNGMIERS SUNGMNASA SUNGRAVITY SUNINCLINA" + \
   "TION SUNINCLINATION_DT SUNLONGITUDE SUNLONGITUDE_DT SUNM" + \
   "ASS SUNOBLATENESS SUNORBIT SUNORBIT_DT SUNPERIAPSIS SUNP" + \
   "ERIAPSIS_DT SUNRADIUS SUNSURFACE SUNVOLUME SUNYEAR TROPI" + \
   "CALYEAR URANUS_A URANUS_B URANUS_C URANUSASCENDING URANU" + \
   "SASCENDING_DT URANUSDAY URANUSDENSITY URANUSECCENTRICITY" + \
   " URANUSECCENTRICITY_DT URANUSESCAPE URANUSFLATNESS URANU" + \
   "SGM URANUSGRAVITY URANUSINCLINATION URANUSINCLINATION_DT" + \
   " URANUSLONGITUDE URANUSLONGITUDE_DT URANUSMASS URANUSOBL" + \
   "ATENESS URANUSORBIT URANUSORBIT_DT URANUSPERIAPSIS URANU" + \
   "SPERIAPSIS_DT URANUSRADIUS URANUSSURFACE URANUSVOLUME UR" + \
   "ANUSYEAR VENUS_A VENUS_B VENUS_C VENUSASCENDING VENUSASC" + \
   "ENDING_DT VENUSDAY VENUSDENSITY VENUSECCENTRICITY VENUSE" + \
   "CCENTRICITY_DT VENUSESCAPE VENUSFLATNESS VENUSGM VENUSGR" + \
   "AVITY VENUSINCLINATION VENUSINCLINATION_DT VENUSLONGITUD" + \
   "E VENUSLONGITUDE_DT VENUSMASS VENUSOBLATENESS VENUSORBIT" + \
   " VENUSORBIT_DT VENUSPERIAPSIS VENUSPERIAPSIS_DT VENUSRAD" + \
   "IUS VENUSSURFACE VENUSVOLUME VENUSYEAR" + \
   "\n" + \
   ...
   "plgeo plhelio plsettime prem_density prem_g prem_mass wa" + \
   "ter_boiling" + \
   "\n" + \
...
def kwplanets_desc():
   ...
   "|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|" + \
   "VOLUME|YEAR) EARTH(_[ABC]|A(NOMALISTICYEAR|SCENDING(_DT)" + \
   "?)|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|" + \
   "RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENE" + \
   "SS|RBIT(_DT)?)|P(ERIAPSIS(_DT)?|RECESSION)|RADIUS|S(IDER" + \
   "EAL(DAY|YEAR)|TELLARDAY|URFACE)|T(HETA_0|ROPICALYEAR)|VO" + \
   "LUME|YEAR) ERIS(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CC" + \
   "ENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(" + \
   "_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIA" + \
   "PSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) HAUMEA(_[ABC]|ASC" + \
   "ENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLA" + \
   "TNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS" + \
   "|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|" + \
   "VOLUME|YEAR) JUPITER(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)" + \
   "|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINA" + \
   "TION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|" + \
   "PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) LC_(ISA_(DEN" + \
   "SITY|PRESSURE|TEMPERATURE|X(DENSITY|HEIGHT|LAPSERATE|PRE" + \
   "SSURE|TEMPERATURE))|P(1_(C(ERES|OUNT)|E(ARTH|R(IS|R))|HA" + \
   "UMEA|JUPITER|M(A(KEMAKE|RS)|ERCURY)|NEPTUNE|P(LUTO|REV_P" + \
   "L)|S(ATURN|UN)|URANUS|VENUS)|2_(A(SC(_DT)?)?|C(OUNT)?|DA" + \
   "Y|ECC(_DT)?|FLATNESS|GM|INC(_DT)?|LON(_DT)?|ORB(_DT)?|PE" + \
   "R(_DT)?|YEAR)|REM_(DENSITY|MASS|X(COE[ABC]|HEIGHT|MASSD)" + \
   "))) MAKEMAKE(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENT" + \
   "RICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT" + \
   ")?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSI" + \
   "S(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) MARS(_[ABC]|ASCENDIN" + \
   "G(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS" + \
   "|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BL" + \
   "ATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUM" + \
   "E|YEAR) MERCURY(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CC" + \
   "ENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(" + \
   "_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIA" + \
   "PSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) MOON(_[ABC]|D(AY|" + \
   "ENSITY)|E(CCENTRICITY|SCAPE)|FLATNESS|G(M|RAVITY)|INCLIN" + \
   "ATION|MASS|O(BLATENESS|RBIT)|RADIUS|SURFACE|VOLUME|YEAR)" + \
   " NEPTUNE(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICI" + \
   "TY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|L" + \
   "ONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_D" + \
   "T)?|RADIUS|SURFACE|VOLUME|YEAR) PLUTO(_[ABC]|ASCENDING(_" + \
   "DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(" + \
   "M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATE" + \
   "NESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|Y" + \
   "EAR) SATURN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTR" + \
   "ICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)" + \
   "?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS" + \
   "(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) SIDEREAL(DAY|YEAR) ST" + \
   "ELLARDAY SUN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENT" + \
   "RICITY(_DT)?|SCAPE)|FLATNESS|G(M(IERS|NASA)?|RAVITY)|INC" + \
   "LINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT" + \
   ")?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) TROPICAL" + \
   "YEAR URANUS(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTR" + \
   "ICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)" + \
   "?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS" + \
   "(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) VENUS(_[ABC]|ASCENDIN" + \
   "G(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS" + \
   "|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BL" + \
   "ATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUM" + \
   "E|YEAR)" + \
   ...
   "s plgeo plhelio plsettime prem_(density|g|mass) water_bo" + \
   "iling" + \
   "\n" + \
   "   Kwplanets 2-ary Functions: earth_gravity_height eccen" + \
