...
@EXPORT_OK = ( qw(
   ...
   elliptic1__1 elliptic1__2 elliptic1i elliptic1i__1 elliptic2
   elliptic2__1 elliptic2i elliptic2i__1 elliptic3 elliptic3__1
   elliptic3i elliptic3i__1 ellipticE ellipticEi ellipticF
   ...
   facinv factor factorial factorialdouble factorialinv
   factorialt fibo fibo3 fibox fiboxinv fit_ls fit_ls0 fit_minmax
   fit_minmax0 fit_poly fitx_minmax flat2ecc floor floor2 fmod
   fmod2 fmods fmodu fmody fmul frac fubini fusc g2jewish
   gamma_cdf gamma_pdf gamma_rand gau_cdf gau_pdf gau_quantile
   gau_rand gcd gcda gd gdinv geo_cdf geo_pdf geo_quantile
   geo_rand ghmean ghmean1 ghmean1inv glmean glmean1 gmean gmean1
   gompertz_cdf gompertz_pdf gompertz_quantile gompertz_rand
   gqmean gqmean1 great_circle_distance h h_ERR h_REC
   has_primitiveroot has_primitiveroot_f haversin heaviside
   ...
   j2k2jd j2k2kwt j2k2uet j2k2ymdhms jacobicir jacobiphi jd2dow
   jd2j2k jd2kwt jd2uet jd2ymdhms jd2ymdhmsinv jewish2g jewish2jd
   jewish2jdx jewish_monthbegin jewish_monthlength
   jewish_months_in_year jewish_yearlength jewishymd2jd k2m
   k2tempc k2tempf k2tempr kB kB_ERR kB_REC ks_a_cdf ks_b_cdf
   ks_cdf ks_quantile kwt2j2k kwt2jd kwt2uet l10 lbeta lcam lcams
   lcantim lcm lcombx lg lgamma lgamma__1 lgamma__2 lgammainv
   ligamma ligammainv lix lixinv lmean lmean1 ln ln1p ln__1 ln__2
   lns log10 log2 logintegral logistic_cdf logistic_pdf
   logistic_quantile logistic_rand lpermx lqmean lqmean1 lucas
   lucasx lv_ellpj m2b m2k magicnot magicset max2 maxabs maxabs2
   maxabsoffset maxi maxmin maxwell_boltzmann_cdf
   maxwell_boltzmann_pdf maxwell_juttner_pdf mb_cdf mb_pdf mean
   mertens min2 minabs minabs2 minabsoffset mini minkowski mobius
   mobius_f modf mods modulo n2comb n2perm nbd_cdf nbd_pdf
   ...
   parabola_get parabola_realroots parabola_roots parabola_solve
...
sub nom($ ) {
   my ($mm) = @_;
   return (exp(-Kw::PI * Kw::elliptic1(1.0 - $mm) /
         Kw::elliptic1($mm)));
}
sub theta1($$ ) {
   my ($mm, $zz) = @_;
...
sub nevillethetac($$ ) {
   ...
   my $cos_inc;
   $km = Kw::elliptic1($mm);
   $qq = exp(-Kw::PI * Kw::elliptic1(1.0 - $mm) / $km);
   $sum_curr = 0;
   $cos_inc = Kw::PI * $zz / $km;
...
sub kw_description() {
   ...
   "lliptic1 elliptic1__1 elliptic1__2 elliptic2 elliptic2__1 " .
   "ellipticE ellipticK erf erf__1 erf__2 erf__3 erf__4 erfc e" .
   "rfcinv erfcx erfcxinv erfinv eta eulerphi eulerx exp exp__" .
   "1 exp__2 exp_rand expintegral1 expintegrali expm1 fac faci" .
   "nv factorial factorialdouble factorialinv fibo fibox fibox" .
   "inv flat2ecc floor frac fubini fusc g2jewish gamma_rand ga" .
   "u_cdf gau_pdf gau_quantile gd gdinv geo_rand ghmean1 ghmea" .
   "n1inv glmean1 gmean1 gqmean1 has_primitiveroot haversin he" .
   "aviside heronianmean1 hlmean1 hmean1 hn hn__1 hour2day hqm" .
   "ean1 hypot1 hypot1inv id int_rand iround iseven isint isje" .
   "wish8short isjewish9short isjewishleap isleapyear ismagic " .
   "isneg isnegint isodd ispos isposint ispractical isprime is" .
   "squarefree iszero j2k2dow j2k2jd j2k2kwt j2k2uet j2k2ymdhm" .
   "s jacobicir jd2dow jd2j2k jd2kwt jd2uet jd2ymdhms jewish2g" .
   " jewish2jd jewish2jdx jewish_months_in_year jewish_yearlen" .
   "gth k2m k2tempc k2tempf k2tempr ks_a_cdf kwt2j2k kwt2jd kw" .
   "t2uet l10 lg lgamma lgamma__1 lgamma__2 lgammainv lix lixi" .
   "nv lmean1 ln ln1p ln__1 ln__2 lns log log10 log2 logintegr" .
   "al logistic_rand lqmean1 lucas lucasx m2b m2k mertens mink" .
   "owski mobius neg nom normal_cdf normal_cdf__1 normal_pdf n" .
   "ormal_quantile normal_quantile__1 parabola_get parabola_ro" .
   "ots partition partitionq pcf pfg pfl poi_rand pow10 pow2 p" .
   "rime0 prime1 primecount primecountx primenext primenth pri" .
   "menth__1 primeprev primitiveroot print_contfra print_contf" .
   "rac print_contfracd print_factor print_jd264 print_num2cha" .
   "r qmean1 rad2deg rad2dms rad2dms2 rad2sec rad2tur rand_ini" .
   "t randl reci reimann round rto125 rtoi rtoz sba search_che" .
   "ck search_search sec sec2deg sec2dhms sec2rad sec2tur secd" .
   " secdinv sech sechinv secinv sect sectinv shc_shft2steps s" .
   "hc_steps2shft shc_steps2shftinv sigma0 sigma1 sigmoid sigm" .
   "oidinv sign sin sin__1 sinc sinc__1 sincc sincinv sind sin" .
   "dinv sinh sinhinv sinintegral sininv sint sintinv smooth s" .
   "q sqinv sqrt sqrt__1 sqrt__2 sqrt__3 sqrtx square squarero" .
   "ot stair stts_delete stts_reset sttscount sttsmagic sttsma" .
   "x sttsmean sttsmin sttsmsq sttsspread sttsstdev sttsstdevm" .
   "ean sttssum sttsvar supercatalan tan tand tandinv tanh tan" .
   "hinv taninv tant tantinv tempc tempc2k tempc2tempf tempf t" .
   "empf2k tempf2tempc tempr tempr2k tgamma tgamma__1 tgamma__" .
   "2 tgamma__3 tgamma__stirling tgammadouble tgammainv topyh1" .
   " totient tri tri_rand triinv trip trunc tur2deg tur2rad tu" .
   "r2sec uet2j2k uet2jd uet2kwt uni_rand versin wm wminv wp w" .
   "pinv ymdhms2j2k ymdhms2jd ymdhms_get zag zeta zig zigzag" .
   "\n" .
   ...
   "e ints_rand iseq isge isgt isle islt ismult ismultl isneq " .
   "ispractical_f isprimitiveroot issignsame issquarefree_f is" .
   "ss jacobiphi jewish_monthbegin jewish_monthlength ks_b_cdf" .
   " ks_cdf ks_quantile lbeta lcam lcams lcantim lcm lcombx li" .
   "gamma ligammainv lmean logistic_cdf logistic_pdf logistic_" .
   "quantile lpermx lqmean max2 maxabs maxabs2 maxi mb_cdf mb_" .
   "pdf mean min2 minabs minabs2 mini mobius_f modf mods modul" .
   "o nbd_rand nc nd nevillethetac nevillethetad nevillethetan" .
   " nevillethetas ns nthroot__1 pareto_rand perm permutation " .
   "permx poi_cdf poi_pdf poi_quantile polya_rand polycnum pol" .
   "ynum pow powi prime0_f print_base_out print_base_outf qmea" .
   "n rand_init_array ratio repetendlen rligamma rms round2 rt" .
   "omsd ruigamma sc sd shc_shftpoles2steps sigma sigma0_f sig" .
   "ma1_f sn sn__1 spread2stdev stdev2spread stirling1 stirlin" .
   "g2 stts_copy stts_downdate stts_newx stts_scale stts_shift" .
   " stts_update stts_update2 t_cdf t_cdf__1 t_pdf t_quantile " .
   "t_quantile__1 tetracnum tetranum theta1 theta2 theta3 thet" .
   "a4 Tn topyh totient_f trap_rand tri_cdf tri_pdf tri_quanti" .
   "le uigamma uigamma__1 uigammainv Un uni_cdf uni_pdf uni_qu" .
   "antile variance zeta_cdf zeta_pdf zipf_rand znorder znorde" .
   "r__1" .
   "\n" .
...
sub kw_desc() {
   ...
   "msday ecc2flat Ein elliptic(1(__[12])?|2(__1)?|[EK]) erf(|" .
   "__([12]|[34])|c(inv|x(inv)?)?|inv) eta euler(phi|x) exp(_(" .
   "_[12]|rand)|integral[1i]|m1)? fac(inv|torial(double|inv)?)" .
   "? fibo(x(inv)?)? flat2ecc floor frac fubini fusc g2jewish " .
   "gamma_rand gau_(cdf|pdf|quantile) gd gdinv geo_rand ghmean" .
   "1(inv)? glmean1 gmean1 gqmean1 has_primitiveroot haversin " .
   "heaviside heronianmean1 hlmean1 hmean1 hn hn__1 hour2day h" .
   "qmean1 hypot1(inv)? id int_rand iround is(even|int|jewish8" .
   "short|jewish9short|jewishleap|leapyear|magic|neg|negint|od" .
   "d|pos|posint|practical|prime|squarefree|zero) j2k2(dow|jd|" .
   "kwt|uet|ymdhms) jacobicir jd2(dow|j2k|kwt|uet|ymdhms) jewi" .
   "sh(2(g|jdx?)|_(months_in_year|yearlength)) k2m k2temp[cfr]" .
   " ks_a_cdf kwt2(j(2k|d)|uet) l10 lg lgamma(__[12]|inv)? lix" .
   "(inv)? lmean1 ln ln1p ln__[12] lns log(10|2|i(ntegral|stic" .
   "_rand))? lqmean1 lucasx? m2b m2k mertens minkowski mobius " .
   "neg nom normal_(cdf(__1)?|pdf|quantile(__1)?) par(abola_(g" .
   "et|roots)|titionq?) pcf pfg pfl poi_rand pow(10|2) pri(m(e" .
   "([01]|countx?|n(ext|th(__1)?)|prev)|itiveroot)|nt_(contfra" .
   "(cd?)?|factor|jd264|num2char)) qmean1 rad2(d(eg|ms2?)|sec|" .
   "tur) rand(_init|l) reci reimann round rto(125|[iz]) sba se" .
   "arch_(check|search) sec(|2(d(eg|hms)|rad|tur)|[dht]?(inv)?" .
   ") shc_s(hft2steps|teps2shft(inv)?) sig(m(a[01]|oid(inv)?)|" .
   "n) sin(|__1|c(__1|c|inv)?|d(inv)?|h(inv)?|in(tegral|v)|t(i" .
   "nv)?) smooth sq sqinv sqrt(__[123]|x)? square(root)? stair" .
   " stts(_(delete|reset)|count|m(a(gic|x)|ean|in|sq)|s(pread|" .
   "tdev(mean)?|um)|var) supercatalan tan([dht]?(inv)?)? temp(" .
   "c(2(k|tempf))?|f(2(k|tempc))?|r(2k)?) tgamma(__([123]|stir" .
   "ling)|double|inv)? topyh1 totient tri(_rand|inv|p)? trunc " .
   "tur2(deg|rad|sec) uet2(j(2k|d)|kwt) uni_rand versin wm(inv" .
   ...
   "tile)|s_rand) is(eq|ge|gt|le|lt|mult|multl|neq|practical_f" .
   "|primitiveroot|signsame|squarefree_f|ss) jacobiphi jewish_" .
   "month(begin|length) ks_(b_cdf|cdf|quantile) lbeta lca(ms?|" .
   "ntim) lcm lcombx ligamma(inv)? lmean logistic_(cdf|pdf|qua" .
   "ntile) lpermx lqmean max(2|abs2?|i) mb_(cdf|pdf) mean min(" .
   "2|abs2?|i) mobius_f mod([fs]|ulo) nbd_rand nc nd nevilleth" .
   "eta([cd]|[ns]) ns nthroot__1 pareto_rand perm(utation|x)? " .
   "poi_(cdf|pdf|quantile) poly(a_rand|cnum|num) powi? pri(me0" .
   "_f|nt_base_outf?) qmean rand_init_array ratio repetendlen " .
   "rligamma rms round2 rtomsd ruigamma sc sd shc_shftpoles2st" .
   "eps sigma(0_f|1_f)? sn sn__1 spread2stdev stdev2spread sti" .
   "rling[12] stts_(copy|downdate|newx|s(cale|hift)|update2?) " .
   "t_cdf(__1)? t_pdf t_quantile(__1)? tetra(cnum|num) theta([" .
   "12]|[34]) Tn topyh totient_f trap_rand tri_(cdf|pdf|quanti" .
   "le) uigamma(__1|inv)? Un uni_(cdf|pdf|quantile) variance z" .
   "eta_(cdf|pdf) zipf_rand znorder(__1)?" .
   "\n" .
