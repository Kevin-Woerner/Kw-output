...
@EXPORT_OK = ( qw(
   ...
   ACCELERATION ACRE ACTION AH ALPHA ALPHAENERGY ALPHAHz
   ALPHAMASS ALPHAMASS_ERR ALPHAWAVELENGTH ALPHA_ERR ALPHA_MASS
   ALPHA_REC ALPHA_REC_ERR AMP AMPERE AMU AMU_ERR ANGLE APERY
   ARCDEG ARCDEGREE ARCMIN ARCMINUTE ARCSEC ARCSECOND ARE AREA
   ASTRONOMICALUNIT ATM ATMOSPHERE ATMOSPHERE_ERR ATOMICMASSUNIT
   ATOMICMASSUNIT_ERR ATTO AU AU_ERR AVOGADRO AVOGADROCONST
   AVOGADROCONST_ERR AVOGADRO_ERR AVOGADRO_REC BAN BAR BARN
   BARREL BASEBALLMASS BASEBALLRADIUS BASKETBALLMASS
   BASKETBALLRADIUS BEKENSTEINENTROPY BEKENSTEININFORMATION
   BHENTROPY_AREA BHMASS2POWER BHMASS2_AREA BHMASS2_DENSITY
   BHMASS2_ENTROPY BHMASS3_LIFETIME BHMASSTEMP BHMASS_RADIUS
   BHRADIUS2DENSITY BIT BLUEENERGY BLUEHz BLUEWAVELENGTH
   BLUEWAVENUMBER BOHRRADIUS BOHRRADIUS_ERR BOLTZMANN
   BOLTZMANNCONST BOLTZMANNCONST_ERR BOLTZMANN_ERR BOLTZMANN_REC
   BTU BTU_IT BTU_TH CAL CALORIE CAL_IT CAL_TH CANDELA
   CAPACITANCE CARAT CARBATTERY CARBATTERYCHARGE CARBATTERYENERGY
   ...
   DEUTERONENERGY DEUTERONHz DEUTERONMASS DEUTERONMASS_ERR
   DEUTERONWAVELENGTH DEUTERON_MASS DIMEMASS DIMERADIUS
   DIMETHICKNESS DISTANCE DIT DOWNQUARKENERGY DOWNQUARKHz
   DOWNQUARKMASS DOWNQUARKMASS_ERR DOWNQUARKWAVELENGTH
   DOWNQUARK_MASS E EARTHAGE EARTHGRAVITYA EARTHGRAVITYB
   EARTHSOLARDAY EHFENERGY EHFHz EHFWAVELENGTH EHFWAVENUMBER
   EINSTEIN EINSTEIN_ERR ELECTRIC ELECTRICCONST ELECTRICCONST_ERR
   ELECTRIC_ERR ELECTRONCHARGE ELECTRONCHARGE_ERR
   ELECTRONCHARGE_REC ELECTRONENERGY ELECTRONHz ELECTRONMASS
   ELECTRONMASSA ELECTRONMASSA_ERR ELECTRONMASS_ERR ELECTRONVOLT
   ...
   EUVWAVENUMBER EXA EXBI Ein FARAD FARADAY FARADAYCONST
   FARADAYCONST_ERR FARADAY_ERR FEET FEIGENBAUM FEMTO
   FINESTRUCTURE FINESTRUCTURECONST FINESTRUCTURECONST_ERR
   FINESTRUCTURE_ERR FINESTRUCTURE_REC FINESTRUCTURE_REC_ERR
   FIRENERGY FIRHz FIRWAVELENGTH FIRWAVENUMBER FLICK FLOZ FLTEPS
   FLTMAN FLTMAX FLTSIG FOE FOOT FORCE FREQUENCY FT G
   GALACTICCENTER GALLON GAMMAENERGY GAMMAHz GAMMAMIN
   GAMMAWAVELENGTH GAMMAWAVENUMBER GAS GASCONST GASCONST_ERR
   GAS_ERR GIANTIMPACT GIBI GIGA GOLFBALLMASS GOLFBALLRADIUS GRAD
   GRAIN GRAM GRAVITATION GRAVITATIONCONST GRAVITATIONCONST_ERR
   GRAVITATIONIERS GRAVITATIONNASA GRAVITATION_ERR GRAVITY
   GRAVITY_ERR GREENENERGY GREENHz GREENWAVELENGTH
   GREENWAVENUMBER GREGORIANYEAR GYEAR G_ERR HAND HART HARTLEY
   HBAR HBAR_ERR HECTARE HECTO HELIONENERGY HELIONHz HELIONMASS
   HELIONMASS_ERR HELIONWAVELENGTH HELION_MASS HENRY HERTZ
   HFENERGY HFHz HFWAVELENGTH HFWAVENUMBER HI HIENERGY HIHz
   HIWAVELENGTH HIWAVENUMBER HI_ERR HORSE HORSEPOWER HOUR HP
   HPMETRIC HUBBLE HUBBLECONST HUBBLECONST_ERR HUBBLERADIUS
   HUBBLE_ERR HXENERGY HXHz HXWAVELENGTH HXWAVENUMBER
   ...
   LIGHTCONST LIGHTCONST_ERR LIGHTYEAR LIGHT_ERR LIGHT_REC LITER
   ...
   MIRWAVENUMBER MM MMHG MOLARMASS MOLARMASSCONST
   MOLARMASSCONST_ERR MOLARMASSX MOLARMASSX_ERR MOLARMASS_ERR
   MOLE MONTHS_IN_YEAR MOONMONTH MPH MPS MPSS MU0 MU0_ERR
   MUONENERGY MUONHz MUONMASS MUONMASS_ERR MUONWAVELENGTH
   ...
   NPBOUNDARY NUVENERGY NUVHz NUVWAVELENGTH NUVWAVENUMBER
   Nm_PER_lbfin OHM ORANGEENERGY ORANGEHz ORANGEWAVELENGTH
   ORANGEWAVENUMBER OUNCE OZ PA PARSEC PEBI PENNYMASS PENNYRADIUS
   PENNYTHICKNESS PETA PHI PHONEBATTERY PHONEBATTERYCHARGE
   PHONEBATTERYENERGY PHONEBATTERYVOLTAGE PI PICO
   PINGPONGBALLMASS PINGPONGBALLRADIUS PINT PLANCK PLANCKBAR
   PLANCKBAR_ERR PLANCKCHARGE PLANCKCONST PLANCKCONST_ERR
   PLANCKENERGY PLANCKLENGTH PLANCKMASS PLANCKTEMP PLANCKTIME
   PLANCK_ERR PLANCK_REC POINT POUND POWER PPB PPM PPQ PPT
   PRESSURE PROTONENERGY PROTONHz PROTONMASS PROTONMASS_ERR
   ...
   REDWAVELENGTH REDWAVENUMBER RESISTANCE RPH RPM RPS RYDBERG
   RYDBERGCONST RYDBERGCONST_ERR RYDBERGENERGY RYDBERGHz
   RYDBERGWAVELENGTH RYDBERGWAVENUMBER RYDBERG_ERR SECOND SHANNON
   SHFENERGY SHFHz SHFWAVELENGTH SHFWAVENUMBER SI16MAX SI16MIN
   SI32MAX SI32MIN SIEMENS SOCCERBALLMASS SOCCERBALLRADIUS
   SOFTBALLMASS SOFTBALLRADIUS SOLARCONSTANT SOLID_ANGLE
   SPECIFICHEAT SPEED SPHERESURFACE SQDEG SQRTTWO SQUAREDEGREE
   STANDARDATMOSPHERE STANDARDGRAVITY STEFAN STEFANCONST
   STEFANCONST_ERR STEFAN_ERR STERADIAN SXENERGY SXHz
   SXWAVELENGTH SXWAVENUMBER SXXENERGY SXXHz SXXWAVELENGTH
   SXXWAVENUMBER TAU TAUENERGY TAUHz TAUMASS TAUMASS_ERR
   TAUWAVELENGTH TAU_MASS TBLSP TEBI TEMPERATURE TENNISBALLMASS
   TENNISBALLRADIUS TERA TESLA THFENERGY THFHz THFWAVELENGTH
   THFWAVENUMBER TIME TON TONNE TORR TRITONENERGY TRITONHz
   TRITONMASS TRITONMASS_ERR TRITONWAVELENGTH TRITON_MASS
   TRJBOUNDARY TSP TT_AT_0TAI TT_AT_0UT1 TURN Tn UAMU UAMU_ERR
   UET UHFENERGY UHFHz UHFWAVELENGTH UHFWAVENUMBER UI16MAX
   UI32MAX UNITGM UNIVERSEAGE UNIVERSEMASS UNIVERSERADIUS
   UPQUARKENERGY UPQUARKHz UPQUARKMASS UPQUARKMASS_ERR
   UPQUARKWAVELENGTH UPQUARK_MASS UVAENERGY UVAHz UVAWAVELENGTH
   UVAWAVENUMBER UVBENERGY UVBHz UVBWAVELENGTH UVBWAVENUMBER
   UVCENERGY UVCHz UVCWAVELENGTH UVCWAVENUMBER Un VHFENERGY VHFHz
   VHFWAVELENGTH VHFWAVENUMBER VIOLETENERGY VIOLETHz
   VIOLETWAVELENGTH VIOLETWAVENUMBER VISCOSITY VOLT VOLTAGE
   VOLUME VONKLITZING VONKLITZING_ERR WATT WEBER WEEK YARD
   YELLOWENERGY YELLOWGREENENERGY YELLOWGREENHz
   YELLOWGREENWAVELENGTH YELLOWGREENWAVENUMBER YELLOWHz
   YELLOWWAVELENGTH YELLOWWAVENUMBER YOBI YOCTO YOTTA ZEBI ZEPTO
   ZETTA a2k a2m agcmean aghmean agmean agmean1 agmean1inv
   agmean__1 agmeaninva agmeaninvg ahmean ahmean1 almean almean1
   amean amean1 aqmean aqmean1 atan2d atan2h atan2t atan2u
   atothenmodp atothenmodx b2m ballot ballots bankers
   base_out_fix_print base_out_print base_outf_print bell bellx
   benford_cdf benford_pdf benford_rand bernoulli bernoullid
   bernoullin bessI0 bessI1 bessIn bessIn_ps bessJ0 bessJ1 bessJn
   bessJn_ps bessJv bessK0 bessK1 bessKn bessY0 bessY1 bessY1__1
   bessYn bessYn_ps bessYv bess_jn bess_yn beta beta_cdf beta_pdf
   beta_quantile beta_rand betainc betainc__1 bharea_to_mass
   bhdensity_to_mass bhentropy_to_mass bhlifetime_to_mass
   bhmass_to_area bhmass_to_density bhmass_to_entropy
   bhmass_to_lifetime bhmass_to_power bhmass_to_radius
   bhmass_to_temp bhpower_to_mass bhradius_to_mass bhtemp_to_mass
   binomial binomial_cdf binomial_pdf binomial_rand binomialx
   birthday birthdayinv birthdayx bits_assign bits_count bits_get
   bits_ls1b bits_ls1bpos bits_ms1b bits_ms1bpos bits_set
   bitshiftl bitshiftr bitwiseand bitwisenot bitwiseor bitwisexor
   bkbn bkn blackbodyf blackbodyf_pdf blackbodyl blackbodyl_pdf
   blackbodymode blackbodypower cantor cantorll cantorul cantorxx
   carlsonRC carlsonRD carlsonRF carlsonRJ carmichael catalan
   cauchy_cdf cauchy_pdf cauchy_quantile cauchy_rand cbrt cd ceil
   ceil2 chebeval chisqr_cdf chisqr_pdf chisqr_rand cir2ell
   circle_get circle_solve clip clip2 clip2x clockhour clockmin
   clocksec clockstdev clocksum cn cn__1 cnv_dbl2si16 comb
   combination combx contfra_print contfrac_print contfracd_print
   contraharmonic corr_delete corr_handlex corr_handley corr_new
   corr_update corrcorr corrslope corrstderr corry0 cos__1 cosd
   cosdinv cosh coshinv cosintegral cosinv cosm1 cosm1__1
   cossin_ev cost costinv cot cotd cotdinv coth cothinv cotinv
   cott cottinv cs csc cscd cscdinv csch cschinv cscinv csct
   csctinv ctz cu cube cuberoot cxaaabattery cxaaabatterycharge
   cxaaabatteryenergy cxaaabatteryvoltage cxaabattery
   cxaabatterycharge cxaabatteryenergy cxaabatteryvoltage
   cxacceleration cxacre cxaction cxah cxalpha cxalpha_err
   cxalpha_mass cxalpha_rec cxalpha_rec_err cxalphaenergy
   cxalphahz cxalphamass cxalphamass_err cxalphawavelength cxamp
   cxampere cxamu cxamu_err cxangle cxapery cxarcdeg cxarcdegree
   cxarcmin cxarcminute cxarcsec cxarcsecond cxare cxarea
   cxastronomicalunit cxatm cxatmosphere cxatmosphere_err
   cxatomicmassunit cxatomicmassunit_err cxatto cxau cxau_err
   cxavogadro cxavogadro_err cxavogadro_rec cxavogadroconst
   cxavogadroconst_err cxban cxbar cxbarn cxbarrel cxbaseballmass
   cxbaseballradius cxbasketballmass cxbasketballradius
   cxbekensteinentropy cxbekensteininformation cxbhentropy_area
   cxbhmass2_area cxbhmass2_density cxbhmass2_entropy
   cxbhmass2power cxbhmass3_lifetime cxbhmass_radius cxbhmasstemp
   cxbhradius2density cxbit cxblueenergy cxbluehz
   cxbluewavelength cxbluewavenumber cxbohrradius
   cxbohrradius_err cxboltzmann cxboltzmann_err cxboltzmann_rec
   cxboltzmannconst cxboltzmannconst_err cxbtu cxbtu_it cxbtu_th
   cxcal cxcal_it cxcal_th cxcalorie cxcandela cxcapacitance
   cxcarat cxcarbattery cxcarbatterycharge cxcarbatteryenergy
   cxcarbatteryvoltage cxcbattery cxcbatterycharge
   cxcbatteryenergy cxcbatteryvoltage cxcenti cxcharge
   cxconductance cxcoulomb cxcoulombconst cxcoulombconst_err
   cxcup cxcurrent cxdalton cxdalton_err cxday cxdbattery
   cxdbatterycharge cxdbatteryenergy cxdbatteryvoltage cxdbleps
   cxdblman cxdblmax cxdblmaxln cxdblsig cxdeca cxdeci cxdegc
   cxdegf cxdegr cxdensity cxdeuteron_mass cxdeuteronenergy
   cxdeuteronhz cxdeuteronmass cxdeuteronmass_err
   cxdeuteronwavelength cxdimemass cxdimeradius cxdimethickness
   ...
   cxeinstein_err cxelectric cxelectric_err cxelectricconst
   cxelectricconst_err cxelectron_mass cxelectroncharge
   cxelectroncharge_err cxelectroncharge_rec cxelectronenergy
   cxelectronhz cxelectronmass cxelectronmass_err cxelectronmassa
   cxelectronmassa_err cxelectronvolt cxelectronwavelength
   cxelementarycharge cxelementarycharge_err cxelevationmax
   cxelevationmin cxenergy cxepsilon0 cxepsilon0_err cxerg
   cxeuler cxeuvenergy cxeuvhz cxeuvwavelength cxeuvwavenumber
   cxexa cxexbi cxfarad cxfaraday cxfaraday_err cxfaradayconst
   cxfaradayconst_err cxfeet cxfeigenbaum cxfemto cxfinestructure
   cxfinestructure_err cxfinestructure_rec
   cxfinestructure_rec_err cxfinestructureconst
   cxfinestructureconst_err cxfirenergy cxfirhz cxfirwavelength
   cxfirwavenumber cxflick cxfloz cxflteps cxfltman cxfltmax
   cxfltsig cxfoe cxfoot cxforce cxfrequency cxft cxg cxg_err
   cxgalacticcenter cxgallon cxgammaenergy cxgammahz cxgammamin
   cxgammawavelength cxgammawavenumber cxgas cxgas_err cxgasconst
   cxgasconst_err cxgiantimpact cxgibi cxgiga cxgolfballmass
   cxgolfballradius cxgrad cxgrain cxgram cxgravitation
   cxgravitation_err cxgravitationconst cxgravitationconst_err
   cxgravitationiers cxgravitationnasa cxgravity cxgravity_err
   cxgreenenergy cxgreenhz cxgreenwavelength cxgreenwavenumber
   cxgregorianyear cxgyear cxh cxh_err cxh_rec cxhand cxhart
   cxhartley cxhbar cxhbar_err cxhectare cxhecto cxhelion_mass
   cxhelionenergy cxhelionhz cxhelionmass cxhelionmass_err
   cxhelionwavelength cxhenry cxhertz cxhfenergy cxhfhz
   cxhfwavelength cxhfwavenumber cxhi cxhi_err cxhienergy cxhihz
   cxhiwavelength cxhiwavenumber cxhorse cxhorsepower cxhour cxhp
   cxhpmetric cxhubble cxhubble_err cxhubbleconst
   cxhubbleconst_err cxhubbleradius cxhxenergy cxhxhz
   ...
   cxkgf cxkgfm_per_lbfin cxkghz cxkgwavelength cxkgwavenumber
   cxkibi cxkilo cxkilogram cxkpgboundary cxkwt cxlb cxlbf
   cxlbfin cxlbfinrpm_per_hp cxlc_circle_radius cxlc_circle_x
   cxlc_circle_y cxlc_elliptic_eps cxlc_eps cxlc_gd_count
   cxlc_gd_day cxlc_gd_dow cxlc_gd_hour cxlc_gd_jd cxlc_gd_min
   cxlc_gd_month cxlc_gd_num cxlc_gd_sec cxlc_gd_year
   cxlc_halaqim cxlc_halaqim_per_hour cxlc_knuth_array_count
   cxlc_knuth_kk_count cxlc_knuth_ll cxlc_knuth_max
   cxlc_knuth_quality_count cxlc_knuth_tt cxlc_magic_int
   cxlc_magic_int_not cxlc_max_factors cxlc_parabola_coeff_a
   cxlc_parabola_coeff_b cxlc_parabola_coeff_c
   cxlc_parabola_real_roots cxlc_parabola_root_a
   cxlc_parabola_root_b cxlc_parabola_x_axis
   cxlc_parabola_y_extrema cxlc_shc_shiftshift cxlc_shc_stepshift
   cxlc_stts_count cxlc_stts_magic cxlc_stts_max
   cxlc_stts_max_key cxlc_stts_mean cxlc_stts_min cxlc_stts_msq
   cxlc_stts_num cxlc_sttsc_count cxlc_sttsc_covar
   cxlc_sttsc_magic cxlc_sttsc_xx cxlc_sttsc_yy
   cxlc_year_per_metonic cxlength cxlfenergy cxlfhz
   cxlfwavelength cxlfwavenumber cxlifeage cxlight cxlight_err
   cxlight_rec cxlightconst cxlightconst_err cxlightyear cxliter
   cxlitre cxlnten cxlntwo cxlumen cxlux cxmach cxmagnetic
   cxmagnetic_err cxmagneticflux cxmagneticinduction cxmarathon
   cxmass cxmebi cxmega cxmeter cxmetre cxmfenergy cxmfhz
   cxmfwavelength cxmfwavenumber cxmicro cxmicrowaveenergy
   cxmicrowavehz cxmicrowavewavelength cxmicrowavewavenumber
   cxmile cxmilkywayage cxmilkywayday cxmilkywaymass
   cxmilkywayradius cxmilli cxminute cxmirenergy cxmirhz
   cxmirwavelength cxmirwavenumber cxmm cxmmhg cxmolarmass
   cxmolarmass_err cxmolarmassconst cxmolarmassconst_err
   ...
   cxnirwavenumber cxnm_per_lbfin cxnpboundary cxnuvenergy
   cxnuvhz cxnuvwavelength cxnuvwavenumber cxohm cxorangeenergy
   cxorangehz cxorangewavelength cxorangewavenumber cxounce cxoz
   cxpa cxparsec cxpebi cxpennymass cxpennyradius
   cxpennythickness cxpeta cxphi cxphonebattery
   cxphonebatterycharge cxphonebatteryenergy
   cxphonebatteryvoltage cxpi cxpico cxpingpongballmass
   cxpingpongballradius cxpint cxplanck cxplanck_err cxplanck_rec
   cxplanckbar cxplanckbar_err cxplanckcharge cxplanckconst
   cxplanckconst_err cxplanckenergy cxplancklength cxplanckmass
   ...
   cxredwavelength cxredwavenumber cxresistance cxrph cxrpm cxrps
   cxrydberg cxrydberg_err cxrydbergconst cxrydbergconst_err
   cxrydbergenergy cxrydberghz cxrydbergwavelength
   cxrydbergwavenumber cxsecond cxshannon cxshfenergy cxshfhz
   cxshfwavelength cxshfwavenumber cxsi16max cxsi16min cxsi32max
   cxsi32min cxsiemens cxsoccerballmass cxsoccerballradius
   cxsoftballmass cxsoftballradius cxsolarconstant cxsolid_angle
   cxspecificheat cxspeed cxspheresurface cxsqdeg cxsqrttwo
   cxsquaredegree cxstandardatmosphere cxstandardgravity cxstefan
   cxstefan_err cxstefanconst cxstefanconst_err cxsteradian
   cxsxenergy cxsxhz cxsxwavelength cxsxwavenumber cxsxxenergy
   cxsxxhz cxsxxwavelength cxsxxwavenumber cxtau cxtau_mass
   cxtauenergy cxtauhz cxtaumass cxtaumass_err cxtauwavelength
   cxtblsp cxtebi cxtemperature cxtennisballmass
   cxtennisballradius cxtera cxtesla cxthfenergy cxthfhz
   cxthfwavelength cxthfwavenumber cxtime cxton cxtonne cxtorr
   cxtriton_mass cxtritonenergy cxtritonhz cxtritonmass
   cxtritonmass_err cxtritonwavelength cxtrjboundary cxtsp
   cxtt_at_0tai cxtt_at_0ut1 cxturn cxuamu cxuamu_err cxuet
   ...
   ellipsecir__1 ellipseecc ellipseflatness ellipsem ellipsen
   ellipsoid_destination ellipsoid_distance ellipsoid_surface
   ellipsoid_volume elliptic1a elliptic1ia elliptic1ik
   ...
   elliptic2im__1 elliptic2k elliptic2m elliptic2m__1 elliptic3a
   elliptic3ia elliptic3ik elliptic3im elliptic3im__1 elliptic3k
   elliptic3m elliptic3m__1 ellipticE ellipticEi ellipticF
   ellipticK ellipticP ellipticPi entringer epdf epdf2cdf erf
   erf__1 erf__2 erf__3 erf__4 erfc erfcinv erfcx erfcxinv erfinv
   eta euler__1 eulerian eulerphi eulerx exp__1 exp__2 exp_cdf
   exp_pdf exp_quantile exp_rand expintegral1 expintegrali
   expintegraln expm1 f11 f21 f_cdf f_quantile f_quantile__1 fac
   facinv factor factor_print factorial factorialdouble
   factorialinv factorialt fibo fibo3 fibox fiboxinv fit_ls
   fit_ls0 fit_minmax fit_minmax0 fit_poly fitx_minmax flat2ecc
   floor floor2 fmod fmod2 fmods fmodu fmody fmul frac fubini
   fusc g2jewish gamma_cdf gamma_pdf gamma_rand gau_cdf gau_pdf
   gau_quantile gau_rand gcd gcda gd gdinv geo_cdf geo_pdf
   ...
   ismult ismultl isneg isnegint isneq isodd ispos isposint
   ispractical ispractical_f isprime isprimitiveroot issignsame
   issquarefree issquarefree_f isss iswithin iszero j2k2dow
   j2k2jd j2k2kwt j2k2uet j2k2ymdhms jacobicir jacobiphi
   jd264_print jd2dow jd2j2k jd2kwt jd2uet jd2ymdhms jd2ymdhmsinv
   jewish2g jewish2jd jewish2jdx jewish_monthbegin
   jewish_monthlength jewish_months_in_year jewish_yearlength
   jewishymd2jd k2a k2m k2tempc k2tempf k2tempr kB kB_ERR kB_REC
   kevy_print kgfm_PER_lbfin ks_a_cdf ks_b_cdf ks_cdf ks_quantile
   kwt2j2k kwt2jd kwt2uet l10 lbeta lbfin lbfinrpm_PER_Hp lcam
   lcams lcantim lcm lcombx lg lgamma lgamma__1 lgamma__2
   lgammainv ligamma ligammainv lix lixinv lmean lmean1 ln ln1p
   ln__1 ln__2 lns log10 log2 logintegral logistic_cdf
   logistic_pdf logistic_quantile logistic_rand logx lpermx
   lqmean lqmean1 lucas lucasx lv_ellpj m2a m2b m2k magicnot
   magicset max2 maxabs maxabs2 maxabsoffset maxi maxmin
   ...
   modulo n2comb n2comb_print n2perm n2perm_print n2primish
   nbd_cdf nbd_pdf nbd_rand nc nd neg nevillethetac nevillethetad
   nevillethetan nevillethetas nom normal_cdf normal_cdf__1
   normal_pdf normal_quantile normal_quantile__1 normal_rand ns
   nthroot__1 num2char_print parabola_get parabola_realroots
   parabola_roots parabola_solve parabola_xaxis parabola_yextrema
   pareto_cdf pareto_pdf pareto_quantile pareto_rand partition
   partitionq pcf pendulum perm permutation permx pfg pfl pmean
   pochhammer poi_cdf poi_pdf poi_quantile poi_rand polya_cdf
   polya_pdf polya_rand polycnum polynum pow pow10 pow2 powi
   prime0 prime0_f prime1 primecount primecountx primenext
   primenth primenth__1 primeprev primitiveroot qmean qmean1
   rad2deg rad2dms rad2dms2 rad2sec rad2tur rand_init
   rand_init_array randd randl ratio reci reimann remquou
   repetendlen rligamma rms round round2 roundy rto125 rtoi
   rtomsd rtoz ruigamma sba sc sd search_check search_search sec
   sec2deg sec2dhms sec2rad sec2tur secd secdinv sech sechinv
   secinv sect sectinv shc_shft2steps shc_shftpoles2steps
   shc_steps2shft shc_steps2shftinv sigma sigma0 sigma0_f sigma1
   sigma1_f sigma_f sigmoid sigmoid3 sigmoid3d sigmoidinv sign
   sin__1 sinc sinc__1 sincc sincinv sind sindinv sinh sinhinv
   sinintegral sininv sint sintinv smooth sn sn__1 sphere_d
   sphere_distance spread2stdev sq sqinv sqrt__1 sqrt__2 sqrt__3
   sqrtx square squareroot stair stdev2spread stirling1 stirling2
   stts_copy stts_delete stts_downdate stts_init stts_initx
   stts_new stts_newx stts_reset stts_scale stts_shift
   stts_update stts_update2 stts_updatex sttscount sttsmagic
   sttsmax sttsmean sttsmin sttsmsq sttsspread sttsstdev
   sttsstdevmean sttssum sttsvar supercatalan t_cdf t_cdf__1
   t_pdf t_quantile t_quantile__1 tan tand tandinv tanh tanhinv
   taninv taninv3 tant tantinv tempc tempc2k tempc2tempf tempf
   tempf2k tempf2tempc tempr tempr2k tetracnum tetranum tgamma
   tgamma__1 tgamma__2 tgamma__3 tgamma__stirling tgammadouble
   tgammainv theta1 theta2 theta3 theta4 timee topyh topyh1
   totient totient_f trap_cdf trap_pdf trap_quantile trap_rand
   tri tri_cdf tri_pdf tri_quantile tri_rand triinv trip trunc
   ...
   ymd2j2k__1 ymd2jd ymdhms2j2k ymdhms2jd ymdhms_get zag zeta
   zeta_cdf zeta_pdf zig zigzag zipf_cdf zipf_pdf zipf_quantile
   zipf_rand znorder znorder__1
)); # End of EXPORT_OK
...
sub BOLTZMANNCONST() { BOLTZMANN; }
sub BOLTZMANNCONST_ERR() { 0.0; }
sub ELECTRONCHARGE() { 1.602176634E-19 * COULOMB; }
sub ELECTRONCHARGE_ERR() { 0.0; }
sub LIGHT() { 2.99792458E+8 * METER / SECOND; }
sub LIGHT_ERR() { 0.0; }
sub LIGHTCONST() { LIGHT; }
sub LIGHTCONST_ERR() { 0.0; }
sub AVOGADRO() { 6.02214076E+23 / MOLE; }
sub AVOGADRO_ERR() { 0.0; }
sub AVOGADROCONST() { AVOGADRO; }
sub AVOGADROCONST_ERR() { 0.0; }
sub PLANCK() { 6.62607015E-34 * JOULE * SECOND; }
sub PLANCK_ERR() { 0.0; }
sub PLANCKCONST() { PLANCK; }
sub PLANCKCONST_ERR() { 0.0; }
...
sub JULIANCENTURY() { 100.0 * JULIANYEAR; }
sub JULIANMILLENNIUM() { 1000.0 * JULIANYEAR; }
sub JDAY() { JULIANDAY; }
...
sub FINESTRUCTURECONST() { FINESTRUCTURE; }
sub FINESTRUCTURECONST_ERR() { ALPHA_ERR; }
...
sub ELECTRICCONST() { ELECTRIC; }
sub ELECTRICCONST_ERR() { ALPHA_ERR; }
...
sub MOLARMASSCONST() { MOLARMASS; }
sub MOLARMASSCONST_ERR() { 2.0E-10; }
...
sub DEUTERONENERGY() { DEUTERONMASS * (LIGHT * LIGHT); }
sub DEUTERONHz() { DEUTERONENERGY / PLANCK; }
sub DEUTERONWAVELENGTH() { LIGHT / DEUTERONHz; }
sub HELIONMASS() { 3.0149322467175 * AMU; }
sub HELIONMASS_ERR() { 3.2E-11; }
sub HELION_MASS() { HELIONMASS * AVOGADRO; }
sub HELIONENERGY() { HELIONMASS * (LIGHT * LIGHT); }
sub HELIONHz() { HELIONENERGY / PLANCK; }
sub HELIONWAVELENGTH() { LIGHT / HELIONHz; }
sub TRITONMASS() { 3.01550071621 * AMU; }
sub TRITONMASS_ERR() { 4.0E-11; }
sub TRITON_MASS() { TRITONMASS * AVOGADRO; }
sub TRITONENERGY() { TRITONMASS * (LIGHT * LIGHT); }
sub TRITONHz() { TRITONENERGY / PLANCK; }
sub TRITONWAVELENGTH() { LIGHT / TRITONHz; }
sub ALPHAMASS() { 4.001506179127 * AMU; }
sub ALPHAMASS_ERR() { 1.6E-11; }
sub ALPHA_MASS() { ALPHAMASS * AVOGADRO; }
sub ALPHAENERGY() { ALPHAMASS * (LIGHT * LIGHT); }
sub ALPHAHz() { ALPHAENERGY / PLANCK; }
sub ALPHAWAVELENGTH() { LIGHT / ALPHAHz; }
...
sub STEFAN_ERR() { 0.0; }
sub STEFANCONST() { STEFAN; }
sub STEFANCONST_ERR() { 0.0; }
...
sub SOFTBALLRADIUS() { 12.0 * INCH / TAU; }
sub SOCCERBALLRADIUS() { 0.69 * METER / TAU; }
sub BASKETBALLRADIUS() { 0.75 * METER / TAU; }
sub PINGPONGBALLMASS() { 0.0027 * KG; }
sub GOLFBALLMASS() { 0.04593 * KG; }
sub TENNISBALLMASS() { 0.0577 * KG; }
sub BASEBALLMASS() { 0.1465 * KG; }
sub SOFTBALLMASS() { 0.187 * KG; }
sub BASKETBALLMASS() { 0.620 * KG; }
sub SOCCERBALLMASS() { 0.430 * KG; }
...
sub UNIVERSERADIUS() { 14.26E+9 * PARSEC; }
sub UNIVERSEMASS() { 1.46E+53 * KILOGRAM; }
sub EINSTEIN() { 4.0 * TAU * GRAVITATION / (LIGHT * LIGHT *
      LIGHT * LIGHT); }
sub EINSTEIN_ERR() { GRAVITATION_ERR; }
sub HUBBLE() { 67.66E-3 * METER / (SECOND * PARSEC); }
sub HUBBLE_ERR() { 6.0E-3; }
sub HUBBLECONST() { HUBBLE; }
sub HUBBLECONST_ERR() { 6.0E-3; }
...
sub BHMASS2_ENTROPY() { (PLANCK * LIGHT) / (2.0 * TAU * TAU *
      GRAVITATION * BOLTZMANN); }
sub BHENTROPY_AREA() { (TAU * (LIGHT * LIGHT * LIGHT) *
      BOLTZMANN) / (4.0 * PLANCK * GRAVITATION); }
sub BHMASS2POWER() { PLANCK * (LIGHT * LIGHT * LIGHT * LIGHT
      * LIGHT * LIGHT) / (7680.0 * (TAU * TAU) * (GRAVITATION
      * GRAVITATION)); }
...
sub cxboltzmannconst() { BOLTZMANNCONST }
sub cxboltzmannconst_err() { BOLTZMANNCONST_ERR }
sub cxelectroncharge() { ELECTRONCHARGE }
sub cxelectroncharge_err() { ELECTRONCHARGE_ERR }
sub cxlight() { LIGHT }
sub cxlight_err() { LIGHT_ERR }
sub cxlightconst() { LIGHTCONST }
sub cxlightconst_err() { LIGHTCONST_ERR }
sub cxavogadro() { AVOGADRO }
sub cxavogadro_err() { AVOGADRO_ERR }
sub cxavogadroconst() { AVOGADROCONST }
sub cxavogadroconst_err() { AVOGADROCONST_ERR }
sub cxplanck() { PLANCK }
sub cxplanck_err() { PLANCK_ERR }
sub cxplanckconst() { PLANCKCONST }
sub cxplanckconst_err() { PLANCKCONST_ERR }
sub cxkcd() { KCD }
...
sub cxfaradayconst() { FARADAYCONST }
sub cxfaradayconst_err() { FARADAYCONST_ERR }
sub cxgas() { GAS }
sub cxgas_err() { GAS_ERR }
sub cxgasconst() { GASCONST }
sub cxgasconst_err() { GASCONST_ERR }
sub cxgravitation() { GRAVITATION }
sub cxgravitation_err() { GRAVITATION_ERR }
sub cxgravitationconst() { GRAVITATIONCONST }
sub cxgravitationconst_err() { GRAVITATIONCONST_ERR }
sub cxrydberg() { RYDBERG }
sub cxrydberg_err() { RYDBERG_ERR }
sub cxrydbergconst() { RYDBERGCONST }
sub cxrydbergconst_err() { RYDBERGCONST_ERR }
sub cxg() { G }
sub cxg_err() { G_ERR }
sub cxalpha() { ALPHA }
...
sub cxrph() { RPH }
sub cxlbfin() { lbfin }
sub cxnm_per_lbfin() { Nm_PER_lbfin }
sub cxkgfm_per_lbfin() { kgfm_PER_lbfin }
sub cxlbfinrpm_per_hp() { lbfinrpm_PER_Hp }
sub cxfinestructure() { FINESTRUCTURE }
sub cxfinestructure_err() { FINESTRUCTURE_ERR }
sub cxfinestructureconst() { FINESTRUCTURECONST }
sub cxfinestructureconst_err() { FINESTRUCTURECONST_ERR }
...
sub cxelectricconst() { ELECTRICCONST }
sub cxelectricconst_err() { ELECTRICCONST_ERR }
...
sub cxmolarmassconst() { MOLARMASSCONST }
sub cxmolarmassconst_err() { MOLARMASSCONST_ERR }
...
sub cxdeuteronenergy() { DEUTERONENERGY }
sub cxdeuteronhz() { DEUTERONHz }
sub cxdeuteronwavelength() { DEUTERONWAVELENGTH }
sub cxhelionmass() { HELIONMASS }
sub cxhelionmass_err() { HELIONMASS_ERR }
sub cxhelion_mass() { HELION_MASS }
sub cxhelionenergy() { HELIONENERGY }
sub cxhelionhz() { HELIONHz }
sub cxhelionwavelength() { HELIONWAVELENGTH }
sub cxtritonmass() { TRITONMASS }
sub cxtritonmass_err() { TRITONMASS_ERR }
sub cxtriton_mass() { TRITON_MASS }
sub cxtritonenergy() { TRITONENERGY }
sub cxtritonhz() { TRITONHz }
sub cxtritonwavelength() { TRITONWAVELENGTH }
sub cxalphamass() { ALPHAMASS }
sub cxalphamass_err() { ALPHAMASS_ERR }
sub cxalpha_mass() { ALPHA_MASS }
sub cxalphaenergy() { ALPHAENERGY }
sub cxalphahz() { ALPHAHz }
sub cxalphawavelength() { ALPHAWAVELENGTH }
...
sub cxstefanconst() { STEFANCONST }
sub cxstefanconst_err() { STEFANCONST_ERR }
...
sub cxhubbleconst() { HUBBLECONST }
sub cxhubbleconst_err() { HUBBLECONST_ERR }
sub cxhubbleradius() { HUBBLERADIUS }
...
sub cxbhmass2_entropy() { BHMASS2_ENTROPY }
sub cxbhentropy_area() { BHENTROPY_AREA }
sub cxbhmass2power() { BHMASS2POWER }
sub cxbhmass2_area() { BHMASS2_AREA }
sub cxbhmass2_density() { BHMASS2_DENSITY }
...
sub dlog($$$ ) {
   ...
   if ($aa == $bb) {
      ...
      $retvalu = -1;
   } elsif (1 < gcd($aa, $nn) or (not isprimitiveroot($aa,
         $nn))) {
...
sub kevy_print($$$ ) {
   ...
   $baseek = Kw::pow($basee, $digits_in_start);
   $overall_len = (Kw::dlog($basee, $den, $den * $baseek - 1)
         + 3) * $digits_in_start;
   use integer;
   $leny = 0;
   $numer = $start;
   $valu = $start;
   for (;;) {
      base_out_fix_print($valu, $basee, $digits_in_start);
...
sub lf_calerf($$ ) {
   my ($xx, $jint) = @_;
      ...
      if ($absx <= 0.46875) {
         ...
         $denom = (((((1.0) * $xsq + 2.36012909523441209E+1)
...
sub ymd2j2k__1($$$ ) {
   ...
   $jtwok = (floor($yr * Kw::JYEAR / Kw::JDAY) +
...
sub ymd2j2k($$$ ) {
   ...
   $mn = $g_month;
   $jcen = floor(($yr - 1) / 100);
   $jtwok = (floor($yr * Kw::JYEAR / Kw::JDAY - 0.0001) +
         floor($jcen / 4.0) - $jcen + ymd2doy($yr, $mn,
         $g_day) - 0.5);
   return ($jtwok);
}
sub ymd2jd($$$ ) {
...
sub LC_GD_YEAR() { 0; }
   ...
   sub jd2ymdhms($ ) {
      ...
      $g_years = floor(($bbdays + 1399.9) * Kw::JDAY /
            Kw::JYEAR);
...
sub LC_HALAQIM_PER_HOUR() { 1080; }
   sub LC_HALAQIM() { Kw::HOUR / LC_HALAQIM_PER_HOUR; }
   ...
   sub date_rosh_hashanah($ ) {
      ...
      $dos = (floor($g_year / 100) - floor($g_year / 400) - 2
            ...
            Kw::LC_HALAQIM) * $aa - 1565.0 * $g_year -
            445405) / (LC_YEAR_PER_METONIC * Kw::DAY /
            LC_HALAQIM));
      $day_of_september = floor($dos);
      $parts = Kw::frac($dos) * Kw::DAY / LC_HALAQIM;
   ...
   sub jewish2jdx($ ) {
      ...
      $months_el = (235 * floor(($hebyear - 1) /
            LC_YEAR_PER_METONIC) + 12 * $hymod + floor((7 *
            $hymod + 1) / LC_YEAR_PER_METONIC));
      $halaqims_el = 204 + (793 * ($months_el %
            LC_HALAQIM_PER_HOUR));
      $hour_el = (5 + (12 * $months_el) + 793 *
            floor($months_el / LC_HALAQIM_PER_HOUR) +
...
sub jewish_yearlength($ ) {
   ...
   $retvalu = (floor(Kw::JYEAR / Kw::JDAY) +
...
sub agmean($$ ) {
   ...
   if ($xa <= 0.0 or $xb <= 0.0) {
      ...
      for (;;) {
         ...
         $xb = $xtmp;
         $cdifff = $xa - $xb;
         if (Kw::iswithin($xa, $xb, 10.0 * Kw::DBLEPS) or
               $pdifff < $cdifff) {
            last; # loop AWAIT
         }
         $ii += 1;
   ...
   if ($yy <= 0.0) {
      ...
      if ($yy <= 0.5) {
         ...
         $x_init = ((((((((-0.09765625) * $cc + 0.12890625) *
               $cc + 0.1875) * $cc + 0.1875) * $cc - 0.25) *
               $cc + 0.5) * $cc + 2.0) * $cc + 1.0);
      } else {
         $cc = -(Kw::PI / 2.0);
...
sub gamma_rand($ ) {
   ...
   if ($shap < 5) {
      ...
      $yy = 0.0;
      $ff = 0.0;
      while ($rval <= 0.0 or (1.0 + $yy * $yy) * exp($ee *
...
sub blackbodyl_pdf($ ) {
   ...
   if ($wavelen <= 0.0) {
      ...
      $retvalu = Kw::pow($wavelen, -5.0) / (exp(1.0 /
            $wavelen) - 1.0);
   }
...
sub LC_STTS_NUM() { 0; }
   ...
   sub stts_init($$$$$$ ) {
      ...
      $lv_sttx_mtrx[$ix_hndl][LC_STTS_MSQ] = $var * ($n_count
            - 1.0);
   ...
   sub stts_scale($$ ) {
      ...
      my $newmin;
      if (0 < $xfactor) {
         $newmax = $lv_sttx_mtrx[$ix_hndl][LC_STTS_MAX] *
               $xfactor;
         $newmin = $lv_sttx_mtrx[$ix_hndl][LC_STTS_MIN] *
               $xfactor;
      } else {
         $newmax = $lv_sttx_mtrx[$ix_hndl][LC_STTS_MIN] *
               $xfactor;
         $newmin = $lv_sttx_mtrx[$ix_hndl][LC_STTS_MAX] *
               $xfactor;
      }
      $lv_sttx_mtrx[$ix_hndl][LC_STTS_MIN] = $newmin;
      $lv_sttx_mtrx[$ix_hndl][LC_STTS_MAX] = $newmax;
      $lv_sttx_mtrx[$ix_hndl][LC_STTS_MEAN] *= $xfactor;
      $lv_sttx_mtrx[$ix_hndl][LC_STTS_MSQ] *= $xfactor *
            $xfactor;
      return ($ix_hndl);
   }
   sub stts_copy($$ ) {
   ...
   }
{
   sub LC_STTSC_XX() { 0; }
      ...
      sub corr_update($$$ ) {
         ...
         $lv_crx_mtrx[$ix_chnd][LC_STTSC_COVAR] += ($ddxx *
               $ddyy * $num / ($num + 1.0));
...
sub euler__1() {
   ...
   return ($twon * $sum_curr / $exptwon - ($nn + 1.0) *
         Kw::LNTWO);
}
sub sphere_d($$$$ ) {
...
sub ellipsoid_surface($$$ ) {
   ...
   if ($abscc < $absaa) {
      ...
      $retvalu = Kw::TAU * ($abscc * $abscc + $absaa * $absbb
            / $sinphi * ($sinphi * $sinphi *
            Kw::elliptic2ik($kk, $phi) + $cosphi * $cosphi *
            Kw::elliptic1ik($kk, $phi)));
   } else {
...
sub LC_SHC_SHIFTSHIFT() { 3.85514; }
sub LC_SHC_STEPSHIFT() { 8.5; }
sub shc_shftpoles2steps($$ ) {
   my ($shft, $poles) = @_;
   my @step_arr;
   my $retvalu;
...
sub shc_steps2shft($ ) {
   my ($steps) = @_;
   return (Kw::lg($steps + LC_SHC_STEPSHIFT) -
         LC_SHC_SHIFTSHIFT);
}
sub shc_steps2shftinv($ ) {
   my ($shft) = @_;
   return (Kw::pow(2.0, $shft + LC_SHC_SHIFTSHIFT) -
         LC_SHC_STEPSHIFT);
}
sub shc_shft2steps($ ) {
   my ($shft) = @_;
...
sub elliptic1im($$ ) {
   ...
   if (Kw::iszero($mm)) {
      ...
      if (Kw::PI / 2.0 <= abs($circ_rad)) {
         ...
         $retvalu = log(Kw::tan((Kw::PI / 2.0 + $circ_rad) /
               2.0));
      }
   } else {
      ...
      if (not $skip_flag) {
         ...
         for (;;) {
            $temp = $ggn / $aan;
            $lcirc_rad += atan2($tt * $temp, 1.0) + $modd *
                  Kw::PI;
...
sub elliptic1im__1($$ ) {
   ...
   return ($sinphi *
         Kw::carlsonRF(Kw::square(cos($lcirc_rad)), 1.0 - $mm
         * Kw::square($sinphi), 1.0) + $kresult);
}
sub elliptic2m($ ) {
   my ($mm) = @_;
   my $aan;
...
sub elliptic2m__1($ ) {
   my ($mm) = @_;
   return (Kw::carlsonRF(0.0, 1.0 - $mm, 1.0) - $mm *
         Kw::carlsonRD(0.0, 1.0 - $mm, 1.0) / 3.0);
}
sub elliptic2im($$ ) {
   my ($mm, $circ_rad) = @_;
   my $aan;
   ...
   if (Kw::iszero($mm)) {
      ...
      if (Kw::iszero($mmc)) {
         ...
         if (0.0 < abs($errsum) and abs($errsum) < 1000.0) {
            ...
            $temp = $eliptwomm * (atan2($tt, 1.0) + $modd *
...
sub elliptic3im($$$ ) {
   ...
   $spm = 1.0 - $mm * $spq;
   $spn = 1.0 - $nn * $spq;
   return ($sp * (Kw::carlsonRF($cpq, $spm, 1.0) + $spq * $nn
...
sub elliptic3m__1($$ ) {
   my ($nn, $mm) = @_;
   return (Kw::carlsonRF(0.0, 1.0 - $mm, 1.0) + $nn *
         Kw::carlsonRJ(0.0, 1.0 - $mm, 1.0, 1.0 - $nn) / 3.0);
}
sub elliptic3im__1($$$ ) {
   my ($nn, $mm, $circ_rad) = @_;
   my $sinphi;
   ...
   return ($sinphi * carlsonRF($cosphisq, $argb, 1.0) + ($nn
         / 3.0) * $sinphicu * carlsonRJ($cosphisq, $argb, 1.0
         , 1.0 - $nn * $sinphisq) + $kresult);
}
sub jacobiphi($$ ) {
   my ($mm, $elli_rad) = @_;
   my $ai;
...
sub LC_ELLIPTIC_EPS() { 1.0E-9; }
   ...
   sub sn($$ ) {
      ...
      if ($mm < 0.0) {
         ...
         $csx = Kw::cosh($elli_rad);
         $snx = Kw::sinh($elli_rad);
         $retvalu = ($snx + $snx * $ai - $ai * $elli_rad /
               $csx) / $csx;
      } else {
         $kk = m2k($mm);
...
sub nevillethetan($$ ) {
   ...
   return ((1.0 + 2.0 * $sum_curr) * sqrt(Kw::TAU / ($km *
         sqrt(1.0 - $mm))) / 2.0);
}
sub nevillethetas($$ ) {
   my ($mm, $zz) = @_;
   ...
   return ($sum_curr * sqrt(Kw::TAU * sqrt($qq / ($mm * (1.0
         - $mm))) / $km));
}
sub ellipsearea($$ ) {
   my ($aa, $bb) = @_;
...
sub ellipsecir($$ ) {
   ...
   if ($bbb <= sqrt(Kw::DBLEPS) * $aaa) {
      ...
      $retvalu = Kw::PI * (Kw::square($aa_orig + $bb_orig) -
            $suma) / ($aaa + $bbb);
   }
   return ($retvalu);
}
...
sub blackbodyl($$ ) {
   my ($wavelen, $temperk) = @_;
   my $hc;
   my $hc_kt;
   my $retvalu;
   if ($wavelen <= 0.0 or $temperk <= 0.0) {
      $retvalu = 0.0;
   } else {
      $hc = Kw::PLANCK * Kw::LIGHT;
      $hc_kt = $hc / (Kw::BOLTZMANN * $temperk);
      $retvalu = 2.0 * $hc * Kw::LIGHT / (Kw::pow($wavelen,
            5) * (exp($hc_kt / $wavelen) - 1.0));
   }
   return ($retvalu);
}
sub blackbodyf($$ ) {
   my ($wavefreq, $temperk) = @_;
   my $h_kt;
   my $retvalu;
   if ($wavefreq <= 0.0 or $temperk <= 0.0) {
      $retvalu = 0.0;
   } else {
      $h_kt = Kw::PLANCK / (Kw::BOLTZMANN * $temperk);
      $retvalu = 2.0 * Kw::PLANCK * Kw::pow($wavefreq, 3) /
            (Kw::pow(Kw::LIGHT, 2) * (exp($h_kt * $wavefreq)
            - 1.0));
   }
   return ($retvalu);
}
...
sub kw_description() {
   ...
   "LPHA_ERR ALPHA_MASS ALPHA_REC ALPHA_REC_ERR ALPHAENERGY AL" .
   "PHAHz ALPHAMASS ALPHAMASS_ERR ALPHAWAVELENGTH AMP AMPERE A" .
   "MU AMU_ERR ANGLE APERY ARCDEG ARCDEGREE ARCMIN ARCMINUTE A" .
   "RCSEC ARCSECOND ARE AREA ASTRONOMICALUNIT ATM ATMOSPHERE A" .
   "TMOSPHERE_ERR ATOMICMASSUNIT ATOMICMASSUNIT_ERR ATTO AU AU" .
   "_ERR AVOGADRO AVOGADRO_ERR AVOGADRO_REC AVOGADROCONST AVOG" .
   "ADROCONST_ERR BAN BAR BARN BARREL BASEBALLMASS BASEBALLRAD" .
   "IUS BASKETBALLMASS BASKETBALLRADIUS BEKENSTEINENTROPY BEKE" .
   "NSTEININFORMATION BHENTROPY_AREA BHMASS2_AREA BHMASS2_DENS" .
   "ITY BHMASS2_ENTROPY BHMASS2POWER BHMASS3_LIFETIME BHMASS_R" .
   "ADIUS BHMASSTEMP BHRADIUS2DENSITY BIT BLUEENERGY BLUEHz BL" .
   "UEWAVELENGTH BLUEWAVENUMBER BOHRRADIUS BOHRRADIUS_ERR BOLT" .
   "ZMANN BOLTZMANN_ERR BOLTZMANN_REC BOLTZMANNCONST BOLTZMANN" .
   "CONST_ERR BTU BTU_IT BTU_TH CAL CAL_IT CAL_TH CALORIE CAND" .
   "ELA CAPACITANCE CARAT CARBATTERY CARBATTERYCHARGE CARBATTE" .
   "RYENERGY CARBATTERYVOLTAGE CBATTERY CBATTERYCHARGE CBATTER" .
   "YENERGY CBATTERYVOLTAGE CENTI CHARGE CONDUCTANCE COULOMB C" .
   "OULOMBCONST COULOMBCONST_ERR CUP CURRENT DALTON DALTON_ERR" .
   " DAY DBATTERY DBATTERYCHARGE DBATTERYENERGY DBATTERYVOLTAG" .
   "E DBLEPS DBLMAN DBLMAX DBLMAXLN DBLSIG DECA DECI DEGC DEGF" .
   " DEGR DENSITY DEUTERON_MASS DEUTERONENERGY DEUTERONHz DEUT" .
   "ERONMASS DEUTERONMASS_ERR DEUTERONWAVELENGTH DIMEMASS DIME" .
   "RADIUS DIMETHICKNESS DISTANCE DIT DOWNQUARK_MASS DOWNQUARK" .
   "ENERGY DOWNQUARKHz DOWNQUARKMASS DOWNQUARKMASS_ERR DOWNQUA" .
   "RKWAVELENGTH dvCs_ERR dvCsENERGY dvCsHz dvCsHz_REC dvCsWAV" .
   "ELENGTH dvCsWAVENUMBER E EARTHAGE EARTHGRAVITYA EARTHGRAVI" .
   "TYB EARTHSOLARDAY EHFENERGY EHFHz EHFWAVELENGTH EHFWAVENUM" .
   "BER EINSTEIN EINSTEIN_ERR ELECTRIC ELECTRIC_ERR ELECTRICCO" .
   "NST ELECTRICCONST_ERR ELECTRON_MASS ELECTRONCHARGE ELECTRO" .
   "NCHARGE_ERR ELECTRONCHARGE_REC ELECTRONENERGY ELECTRONHz E" .
   "LECTRONMASS ELECTRONMASS_ERR ELECTRONMASSA ELECTRONMASSA_E" .
   "RR ELECTRONVOLT ELECTRONWAVELENGTH ELEMENTARYCHARGE ELEMEN" .
   "TARYCHARGE_ERR ELEVATIONMAX ELEVATIONMIN ENERGY EPSILON0 E" .
   "PSILON0_ERR ERG EULER EUVENERGY EUVHz EUVWAVELENGTH EUVWAV" .
   "ENUMBER EXA EXBI FARAD FARADAY FARADAY_ERR FARADAYCONST FA" .
   "RADAYCONST_ERR FEET FEIGENBAUM FEMTO FINESTRUCTURE FINESTR" .
   "UCTURE_ERR FINESTRUCTURE_REC FINESTRUCTURE_REC_ERR FINESTR" .
   "UCTURECONST FINESTRUCTURECONST_ERR FIRENERGY FIRHz FIRWAVE" .
   "LENGTH FIRWAVENUMBER FLICK FLOZ FLTEPS FLTMAN FLTMAX FLTSI" .
   "G FOE FOOT FORCE FREQUENCY FT G G_ERR GALACTICCENTER GALLO" .
   "N GAMMAENERGY GAMMAHz GAMMAMIN GAMMAWAVELENGTH GAMMAWAVENU" .
   "MBER GAS GAS_ERR GASCONST GASCONST_ERR GIANTIMPACT GIBI GI" .
   "GA GOLFBALLMASS GOLFBALLRADIUS GRAD GRAIN GRAM GRAVITATION" .
   " GRAVITATION_ERR GRAVITATIONCONST GRAVITATIONCONST_ERR GRA" .
   "VITATIONIERS GRAVITATIONNASA GRAVITY GRAVITY_ERR GREENENER" .
   "GY GREENHz GREENWAVELENGTH GREENWAVENUMBER GREGORIANYEAR G" .
   "YEAR h h_ERR h_REC HAND HART HARTLEY HBAR HBAR_ERR HECTARE" .
   " HECTO HELION_MASS HELIONENERGY HELIONHz HELIONMASS HELION" .
   "MASS_ERR HELIONWAVELENGTH HENRY HERTZ HFENERGY HFHz HFWAVE" .
   "LENGTH HFWAVENUMBER HI HI_ERR HIENERGY HIHz HIWAVELENGTH H" .
   "IWAVENUMBER HORSE HORSEPOWER HOUR HP HPMETRIC HUBBLE HUBBL" .
   "E_ERR HUBBLECONST HUBBLECONST_ERR HUBBLERADIUS HXENERGY HX" .
   "Hz HXWAVELENGTH HXWAVENUMBER HYDROGENLINE HYDROGENLINE_ERR" .
   " HYDROGENRADIUS HYDROGENRADIUS_ERR INCH INDUCTANCE INHG IN" .
   "TMAX J2K J2KDAY JC JCENTURY JD JDAY JDSEC_AT_0GREGORIAN JD" .
   "SEC_AT_0J2K JDSEC_AT_0KWT JDSEC_AT_0UET JEWISH_FIRST_MONTH" .
   " JM JMILLENNIUM JOSEPHSON JOSEPHSON_ERR JOULE JULIANCENTUR" .
   "Y JULIANDAY JULIANMILLENNIUM JULIANYEAR JY JYEAR K_AT_0TEM" .
   "PC K_AT_0TEMPF K_AT_0TEMPR kB kB_ERR kB_REC KCD KCD_ERR KE" .
   "LVIN KG KGENERGY KGF kgfm_PER_lbfin KGHz KGWAVELENGTH KGWA" .
   "VENUMBER KIBI KILO KILOGRAM KPGBOUNDARY KWT LB LBF lbfin l" .
   "bfinrpm_PER_Hp LC_CIRCLE_RADIUS LC_CIRCLE_X LC_CIRCLE_Y LC" .
   "_ELLIPTIC_EPS LC_EPS LC_GD_COUNT LC_GD_DAY LC_GD_DOW LC_GD" .
   "_HOUR LC_GD_JD LC_GD_MIN LC_GD_MONTH LC_GD_NUM LC_GD_SEC L" .
   "C_GD_YEAR LC_HALAQIM LC_HALAQIM_PER_HOUR LC_KNUTH_ARRAY_CO" .
   "UNT LC_KNUTH_KK_COUNT LC_KNUTH_LL LC_KNUTH_MAX LC_KNUTH_QU" .
   "ALITY_COUNT LC_KNUTH_TT LC_MAGIC_INT LC_MAGIC_INT_NOT LC_M" .
   "AX_FACTORS LC_PARABOLA_COEFF_A LC_PARABOLA_COEFF_B LC_PARA" .
   "BOLA_COEFF_C LC_PARABOLA_REAL_ROOTS LC_PARABOLA_ROOT_A LC_" .
   "PARABOLA_ROOT_B LC_PARABOLA_X_AXIS LC_PARABOLA_Y_EXTREMA L" .
   "C_SHC_SHIFTSHIFT LC_SHC_STEPSHIFT LC_STTS_COUNT LC_STTS_MA" .
   "GIC LC_STTS_MAX LC_STTS_MAX_KEY LC_STTS_MEAN LC_STTS_MIN L" .
   "C_STTS_MSQ LC_STTS_NUM LC_STTSC_COUNT LC_STTSC_COVAR LC_ST" .
   "TSC_MAGIC LC_STTSC_XX LC_STTSC_YY LC_YEAR_PER_METONIC LENG" .
   "TH LFENERGY LFHz LFWAVELENGTH LFWAVENUMBER LIFEAGE LIGHT L" .
   "IGHT_ERR LIGHT_REC LIGHTCONST LIGHTCONST_ERR LIGHTYEAR LIT" .
   "ER LITRE LNTEN LNTWO LUMEN LUX MACH MAGNETIC MAGNETIC_ERR " .
   "MAGNETICFLUX MAGNETICINDUCTION MARATHON MASS MEBI MEGA MET" .
   "ER METRE MFENERGY MFHz MFWAVELENGTH MFWAVENUMBER MICRO MIC" .
   "ROWAVEENERGY MICROWAVEHz MICROWAVEWAVELENGTH MICROWAVEWAVE" .
   "NUMBER MILE MILKYWAYAGE MILKYWAYDAY MILKYWAYMASS MILKYWAYR" .
   "ADIUS MILLI MINUTE MIRENERGY MIRHz MIRWAVELENGTH MIRWAVENU" .
   "MBER MM MMHG MOLARMASS MOLARMASS_ERR MOLARMASSCONST MOLARM" .
   "ASSCONST_ERR MOLARMASSX MOLARMASSX_ERR MOLE MONTHS_IN_YEAR" .
   " MOONMONTH MPH MPS MPSS MU0 MU0_ERR MUON_MASS MUONENERGY M" .
   "UONHz MUONMASS MUONMASS_ERR MUONWAVELENGTH NANO NAT NEUTRO" .
   "N_MASS NEUTRONENERGY NEUTRONHz NEUTRONMASS NEUTRONMASS_ERR" .
   " NEUTRONWAVELENGTH NEWTON NICKELMASS NICKELRADIUS NICKELTH" .
   "ICKNESS NINEVOLT NINEVOLTBATTERY NINEVOLTBATTERYCHARGE NIN" .
   "EVOLTBATTERYENERGY NINEVOLTBATTERYVOLTAGE NINEVOLTCHARGE N" .
   "INEVOLTENERGY NINEVOLTVOLTAGE NIRENERGY NIRHz NIRWAVELENGT" .
   "H NIRWAVENUMBER Nm_PER_lbfin NPBOUNDARY NUVENERGY NUVHz NU" .
   "VWAVELENGTH NUVWAVENUMBER OHM ORANGEENERGY ORANGEHz ORANGE" .
   "WAVELENGTH ORANGEWAVENUMBER OUNCE OZ PA PARSEC PEBI PENNYM" .
   "ASS PENNYRADIUS PENNYTHICKNESS PETA PHI PHONEBATTERY PHONE" .
   "BATTERYCHARGE PHONEBATTERYENERGY PHONEBATTERYVOLTAGE PI PI" .
   "CO PINGPONGBALLMASS PINGPONGBALLRADIUS PINT PLANCK PLANCK_" .
   "ERR PLANCK_REC PLANCKBAR PLANCKBAR_ERR PLANCKCHARGE PLANCK" .
   "CONST PLANCKCONST_ERR PLANCKENERGY PLANCKLENGTH PLANCKMASS" .
   " PLANCKTEMP PLANCKTIME POINT POUND POWER PPB PPM PPQ PPT P" .
   "RESSURE PROTON_MASS PROTONENERGY PROTONHz PROTONMASS PROTO" .
   "NMASS_ERR PROTONRADIUS PROTONRADIUS_ERR PROTONWAVELENGTH P" .
   "ROXIMACENTAURI PSI PTRBOUNDARY QUART QUARTERMASS QUARTERRA" .
   "DIUS QUARTERTHICKNESS RAD RADIAN REDENERGY REDHz REDWAVELE" .
   "NGTH REDWAVENUMBER RESISTANCE RPH RPM RPS RYDBERG RYDBERG_" .
   "ERR RYDBERGCONST RYDBERGCONST_ERR RYDBERGENERGY RYDBERGHz " .
   "RYDBERGWAVELENGTH RYDBERGWAVENUMBER SECOND SHANNON SHFENER" .
   "GY SHFHz SHFWAVELENGTH SHFWAVENUMBER SI16MAX SI16MIN SI32M" .
   "AX SI32MIN SIEMENS SOCCERBALLMASS SOCCERBALLRADIUS SOFTBAL" .
   "LMASS SOFTBALLRADIUS SOLARCONSTANT SOLID_ANGLE SPECIFICHEA" .
   "T SPEED SPHERESURFACE SQDEG SQRTTWO SQUAREDEGREE STANDARDA" .
   "TMOSPHERE STANDARDGRAVITY STEFAN STEFAN_ERR STEFANCONST ST" .
   "EFANCONST_ERR STERADIAN SXENERGY SXHz SXWAVELENGTH SXWAVEN" .
   ...
   "TONNE TORR TRITON_MASS TRITONENERGY TRITONHz TRITONMASS TR" .
   "ITONMASS_ERR TRITONWAVELENGTH TRJBOUNDARY TSP TT_AT_0TAI T" .
   "T_AT_0UT1 TURN UAMU UAMU_ERR UET UHFENERGY UHFHz UHFWAVELE" .
   "NGTH UHFWAVENUMBER UI16MAX UI32MAX UNITGM UNIVERSEAGE UNIV" .
   "ERSEMASS UNIVERSERADIUS UPQUARK_MASS UPQUARKENERGY UPQUARK" .
   "Hz UPQUARKMASS UPQUARKMASS_ERR UPQUARKWAVELENGTH UVAENERGY" .
   " UVAHz UVAWAVELENGTH UVAWAVENUMBER UVBENERGY UVBHz UVBWAVE" .
   "LENGTH UVBWAVENUMBER UVCENERGY UVCHz UVCWAVELENGTH UVCWAVE" .
   "NUMBER VHFENERGY VHFHz VHFWAVELENGTH VHFWAVENUMBER VIOLETE" .
   "NERGY VIOLETHz VIOLETWAVELENGTH VIOLETWAVENUMBER VISCOSITY" .
   " VOLT VOLTAGE VOLUME VONKLITZING VONKLITZING_ERR WATT WEBE" .
   "R WEEK YARD YELLOWENERGY YELLOWGREENENERGY YELLOWGREENHz Y" .
   "ELLOWGREENWAVELENGTH YELLOWGREENWAVENUMBER YELLOWHz YELLOW" .
   "WAVELENGTH YELLOWWAVENUMBER YOBI YOCTO YOTTA ZEBI ZEPTO ZE" .
   "TTA" .
   "\n" .
   ...
   "an1 almean1 amean1 aqmean1 b2m bankers bell bellx benford_" .
   "rand bernoulli bernoullid bernoullin bessI0 bessI1 bessJ0 " .
   "bessJ1 bessK0 bessK1 bessY0 bessY1 bessY1__1 bharea_to_mas" .
   "s bhdensity_to_mass bhentropy_to_mass bhlifetime_to_mass b" .
   "hmass_to_area bhmass_to_density bhmass_to_entropy bhmass_t" .
   "o_lifetime bhmass_to_power bhmass_to_radius bhmass_to_temp" .
   " bhpower_to_mass bhradius_to_mass bhtemp_to_mass bits_coun" .
   "t bits_ls1b bits_ls1bpos bits_ms1b bits_ms1bpos bitwisenot" .
   " blackbodyf_pdf blackbodyl_pdf blackbodymode blackbodypowe" .
   "r cantor carmichael catalan cauchy_rand cbrt ceil chisqr_r" .
   "and circle_get clip clockhour clockmin clocksec clockstdev" .
   " clocksum cnv_dbl2si16 contfra_print contfrac_print contfr" .
   "acd_print corr_delete corr_handlex corr_handley corrcorr c" .
   ...
   "v factor_print factorial factorialdouble factorialinv fibo" .
   " fibox fiboxinv flat2ecc floor frac fubini fusc g2jewish g" .
   "amma_rand gau_cdf gau_pdf gau_quantile gd gdinv geo_rand g" .
   "hmean1 ghmean1inv glmean1 gmean1 gqmean1 has_primitiveroot" .
   " haversin heaviside heronianmean1 hlmean1 hmean1 hn hn__1 " .
   "hour2day hqmean1 hypot1 hypot1inv id int_rand iround iseve" .
   "n isint isjewish8short isjewish9short isjewishleap isleapy" .
   "ear ismagic isneg isnegint isodd ispos isposint ispractica" .
   "l isprime issquarefree iszero j2k2dow j2k2jd j2k2kwt j2k2u" .
   "et j2k2ymdhms jacobicir jd264_print jd2dow jd2j2k jd2kwt j" .
   "d2uet jd2ymdhms jewish2g jewish2jd jewish2jdx jewish_month" .
   "s_in_year jewish_yearlength k2a k2m k2tempc k2tempf k2temp" .
   "r ks_a_cdf kwt2j2k kwt2jd kwt2uet l10 lg lgamma lgamma__1 " .
   "lgamma__2 lgammainv lix lixinv lmean1 ln ln1p ln__1 ln__2 " .
   "lns log log10 log2 logintegral logistic_rand lqmean1 lucas" .
   " lucasx m2a m2b m2k mertens minkowski mobius n2primish neg" .
   " nom normal_cdf normal_cdf__1 normal_pdf normal_quantile n" .
   "ormal_quantile__1 num2char_print parabola_get parabola_roo" .
   "ts partition partitionq pcf pfg pfl poi_rand pow10 pow2 pr" .
   "ime0 prime1 primecount primecountx primenext primenth prim" .
   "enth__1 primeprev primitiveroot qmean1 rad2deg rad2dms rad" .
   "2dms2 rad2sec rad2tur rand_init randl reci reimann round r" .
   "to125 rtoi rtoz sba search_check search_search sec sec2deg" .
   " sec2dhms sec2rad sec2tur secd secdinv sech sechinv secinv" .
   " sect sectinv shc_shft2steps shc_steps2shft shc_steps2shft" .
   "inv sigma0 sigma1 sigmoid sigmoidinv sign sin sin__1 sinc " .
   "sinc__1 sincc sincinv sind sindinv sinh sinhinv sinintegra" .
   "l sininv sint sintinv smooth sq sqinv sqrt sqrt__1 sqrt__2" .
   " sqrt__3 sqrtx square squareroot stair stts_delete stts_re" .
   "set sttscount sttsmagic sttsmax sttsmean sttsmin sttsmsq s" .
   "ttsspread sttsstdev sttsstdevmean sttssum sttsvar supercat" .
   "alan tan tand tandinv tanh tanhinv taninv tant tantinv tem" .
   "pc tempc2k tempc2tempf tempf tempf2k tempf2tempc tempr tem" .
   "pr2k tgamma tgamma__1 tgamma__2 tgamma__3 tgamma__stirling" .
   " tgammadouble tgammainv topyh1 totient tri tri_rand triinv" .
   " trip trunc tur2deg tur2rad tur2sec uet2j2k uet2jd uet2kwt" .
   " uni_rand versin wm wminv wp wpinv ymdhms2j2k ymdhms2jd ym" .
   "dhms_get zag zeta zig zigzag" .
   "\n" .
   "   Kw 2-ary Functions: agmean agmean__1 agmeaninva agmeani" .
   "nvg ahmean almean amean aqmean atan2 atan2d atan2h atan2t " .
   "atan2u ballot ballots base_out_print base_outf_print benfo" .
   "rd_cdf benford_pdf bess_jn bess_yn bessIn bessIn_ps bessJn" .
   " bessJn_ps bessJv bessKn bessYn bessYn_ps bessYv beta beta" .
   "_rand binomial binomial_rand binomialx birthday birthdayin" .
   "v birthdayx bits_get bits_set bitshiftl bitshiftr bitwisea" .
   "nd bitwiseor bitwisexor bkn blackbodyf blackbodyl carlsonR" .
   "C cauchy_cdf cauchy_pdf cauchy_quantile cd ceil2 chisqr_cd" .
   "f chisqr_pdf cir2ell cn cn__1 comb combination combx contr" .
   "aharmonic cs d1diamond_d2 d1lt_d2 d1spiral_d2 d1ur_d2 d2di" .
   "amond_d1 d2hypot_d1 d2lt_d1 d2spiral_d1 d2ur_d1 days_in_mo" .
   "nth dc ddist dist dlog1 dn dn__1 ds ell2cir ellipsearea el" .
   "lipsecir ellipsecir__1 ellipseecc ellipseflatness ellipsem" .
   " ellipsen elliptic1ia elliptic1ik elliptic1im elliptic1im_" .
   "_1 elliptic2ia elliptic2ik elliptic2im elliptic2im__1 elli" .
   "ptic3a elliptic3k elliptic3m elliptic3m__1 ellipticEi elli" .
   "pticF ellipticP entringer eulerian exp_cdf exp_pdf exp_qua" .
   "ntile expintegraln factor factorialt floor2 fmod fmod fmod" .
   "s fmodu fmody fmul gamma_cdf gamma_pdf gcd gcda geo_cdf ge" .
   "o_pdf geo_quantile ghmean glmean gmean gompertz_rand gqmea" .
   "n has_primitiveroot_f heronianmean hlmean hmean hnm hqmean" .
   " hypot int_cdf int_pdf int_quantile ints_rand iseq isge is" .
   "gt isle islt ismult ismultl isneq ispractical_f isprimitiv" .
   "eroot issignsame issquarefree_f isss jacobiphi jewish_mont" .
   "hbegin jewish_monthlength ks_b_cdf ks_cdf ks_quantile lbet" .
   "a lcam lcams lcantim lcm lcombx ligamma ligammainv lmean l" .
   "ogistic_cdf logistic_pdf logistic_quantile logx lpermx lqm" .
   "ean max2 maxabs maxabs2 maxi mb_cdf mb_pdf mean min2 minab" .
   "s minabs2 mini mobius_f modf mods modulo n2perm_print nbd_" .
   "rand nc nd nevillethetac nevillethetad nevillethetan nevil" .
   "lethetas ns nthroot__1 pareto_rand perm permutation permx " .
   "pochhammer poi_cdf poi_pdf poi_quantile polya_rand polycnu" .
   "m polynum pow powi prime0_f qmean rand_init_array ratio re" .
   "petendlen rligamma rms round2 rtomsd ruigamma sc sd shc_sh" .
   "ftpoles2steps sigma sigma0_f sigma1_f sn sn__1 spread2stde" .
   "v stdev2spread stirling1 stirling2 stts_copy stts_downdate" .
   " stts_newx stts_scale stts_shift stts_update stts_update2 " .
   "t_cdf t_cdf__1 t_pdf t_quantile t_quantile__1 tetracnum te" .
   "tranum theta1 theta2 theta3 theta4 Tn topyh totient_f trap" .
   "_rand tri_cdf tri_pdf tri_quantile uigamma uigamma__1 uiga" .
   "mmainv Un uni_cdf uni_pdf uni_quantile variance zeta_cdf z" .
   "eta_pdf zipf_rand znorder znorder__1" .
   "\n" .
   "   Kw 3-ary Functions: agcmean aghmean atothenmodp atothen" .
   "modx base_out_fix_print beta_cdf beta_pdf beta_quantile be" .
   "tainc betainc__1 binomial_cdf binomial_pdf bits_assign bkb" .
   "n cantorll cantorul cantorxx carlsonRD carlsonRF chebeval " .
   "clip2 clip2x corr_update cossin_ev divi dlog dlogx ellipso" .
   "id_surface ellipsoid_volume elliptic3ia elliptic3ik ellipt" .
   "ic3im elliptic3im__1 ellipticPi epdf2cdf f11 f_cdf f_quant" .
   "ile f_quantile__1 fibo3 fit_ls fit_ls0 fit_minmax fit_minm" .
   "ax0 fit_poly fitx_minmax fmod2 gompertz_cdf gompertz_pdf g" .
   "ompertz_quantile hms2day horner hypot3 ifzero isalmostequa" .
   "l isbetween isbetweenx isfloorsame iswithin jewishymd2jd k" .
   "evy_print lv_ellpj maxabsoffset maxmin maxwell_boltzmann_c" .
   "df maxwell_boltzmann_pdf maxwell_juttner_pdf minabsoffset " .
   "n2comb_print n2perm nbd_cdf nbd_pdf pareto_cdf pareto_pdf " .
   "pareto_quantile pendulum pmean polya_cdf polya_pdf remquou" .
   " roundy sigma_f sigmoid3 sigmoid3d stts_updatex taninv3 tr" .
   "ap_cdf trap_pdf trap_quantile ymd2dow ymd2doy ymd2j2k ymd2" .
   "j2k__1 ymd2jd zipf_cdf zipf_pdf zipf_quantile" .
   "\n" .
...
sub kw_desc() {
   ...
   "PHA(|_(ERR|MASS|REC(_ERR)?)|ENERGY|Hz|MASS(_ERR)?|WAVELENG" .
   "TH) AMP(ERE)? AMU(_ERR)? ANGLE APERY ARC(DEG(REE)?|MIN(UTE" .
   ")?|SEC(OND)?) AREA? ASTRONOMICALUNIT ATM(OSPHERE(_ERR)?)? " .
   "ATOMICMASSUNIT(_ERR)? ATTO AU AU_ERR AVOGADRO(|_(ERR|REC)|" .
   "CONST(_ERR)?) BAN BAR(N|REL)? BAS(EBALL(MASS|RADIUS)|KETBA" .
   "LL(MASS|RADIUS)) BEKENSTEIN(ENTROPY|INFORMATION) BHENTROPY" .
   "_AREA BHMASS(2(_(AREA|DENSITY|ENTROPY)|POWER)|3_LIFETIME|_" .
   "RADIUS|TEMP) BHRADIUS2DENSITY BIT BLUE(ENERGY|Hz|WAVE(LENG" .
   "TH|NUMBER)) BOHRRADIUS(_ERR)? BOLTZMANN(|_(ERR|REC)|CONST(" .
   "_ERR)?) BTU(_(IT|TH))? CAL(_(IT|TH)|ORIE)? CANDELA CAPACIT" .
   "ANCE CAR(AT|BATTERY(CHARGE|ENERGY|VOLTAGE)?) CBATTERY(CHAR" .
   "GE|ENERGY|VOLTAGE)? CENTI CHARGE CONDUCTANCE COULOMB(CONST" .
   "(_ERR)?)? CUP CURRENT DALTON(_ERR)? DAY DBATTERY(CHARGE|EN" .
   "ERGY|VOLTAGE)? DBL(EPS|MA(N|X(LN)?)|SIG) DEC[AI] DEG[CFR] " .
   "DENSITY DEUTERON(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) D" .
   "IME(MAS|RADIU|THICKNES)S DISTANCE DIT DOWNQUARK(_MASS|ENER" .
   "GY|Hz|MASS(_ERR)?|WAVELENGTH) dvCs(_ERR|ENERGY|Hz(_REC)?|W" .
   "AVE(LENGTH|NUMBER)) E EARTH(AGE|GRAVITY[AB]|SOLARDAY) EHF(" .
   "ENERGY|Hz|WAVE(LENGTH|NUMBER)) EINSTEIN(_ERR)? ELE(CTR(IC(" .
   "_ERR|CONST(_ERR)?)?|ON(_MASS|CHARGE(_(ERR|REC))?|ENERGY|Hz" .
   "|MASS(_ERR|A(_ERR)?)?|VOLT|WAVELENGTH))|MENTARYCHARGE(_ERR" .
   ")?|VATIONM(AX|IN)) ENERGY EPSILON0(_ERR)? ERG EULER EUV(EN" .
   "ERGY|Hz|WAVE(LENGTH|NUMBER)) EXA EXBI FARAD(|AY(_ERR|CONST" .
   "(_ERR)?)?) FEET FEIGENBAUM FEMTO FINESTRUCTURE(|_(ERR|REC(" .
   "_ERR)?)|CONST(_ERR)?) FIR(ENERGY|Hz|WAVE(LENGTH|NUMBER)) F" .
   "LICK FLOZ FLT(EPS|MA[NX]|SIG) FOE FOOT FORCE FREQUENCY FT " .
   "G G_ERR GAL(ACTICCENTER|LON) GAMMA(ENERGY|Hz|MIN|WAVE(LENG" .
   "TH|NUMBER)) GAS(_ERR|CONST(_ERR)?)? GIANTIMPACT GIBI GIGA " .
   "GOLFBALL(MASS|RADIUS) GRA(D|IN|M|VIT(ATION(_ERR|CONST(_ERR" .
   ")?|IERS|NASA)?|Y(_ERR)?)) GRE(EN(ENERGY|Hz|WAVE(LENGTH|NUM" .
   "BER))|GORIANYEAR) GYEAR h h_ERR h_REC HAND HART(LEY)? HBAR" .
   "(_ERR)? HECT(ARE|O) HELION(_MASS|ENERGY|Hz|MASS(_ERR)?|WAV" .
   "ELENGTH) HENRY HERTZ HFENERGY HFHz HFWAVE(LENGTH|NUMBER) H" .
   "I HI_ERR HIENERGY HIHz HIWAVE(LENGTH|NUMBER) HORSE(POWER)?" .
   " HOUR HP HPMETRIC HUBBLE(_ERR|CONST(_ERR)?|RADIUS)? HXENER" .
   "GY HXHz HXWAVE(LENGTH|NUMBER) HYDROGEN(LINE(_ERR)?|RADIUS(" .
   "_ERR)?) INCH INDUCTANCE INHG INTMAX J2K(DAY)? JC JCENTURY " .
   "JD JDAY JDSEC_AT_0(GREGORIAN|J2K|KWT|UET) JEWISH_FIRST_MON" .
   "TH JM JMILLENNIUM JOSEPHSON(_ERR)? JOULE JULIAN(CENTURY|DA" .
   "Y|MILLENNIUM|YEAR) JY JYEAR K_AT_0TEMP[CFR] kB kB_(ERR|REC" .
   ") KCD(_ERR)? KELVIN KG KGENERGY KGF kgfm_PER_lbfin KGHz KG" .
   "WAVE(LENGTH|NUMBER) KIBI KILO(GRAM)? KPGBOUNDARY KWT LB LB" .
   "F lbfin(rpm_PER_Hp)? LC_(CIRCLE_(RADIUS|[XY])|E(LLIPTIC_EP" .
   "S|PS)|GD_(COUNT|D(AY|OW)|HOUR|JD|M(IN|ONTH)|NUM|SEC|YEAR)|" .
   "HALAQIM(_PER_HOUR)?|KNUTH_(ARRAY_COUNT|KK_COUNT|LL|MAX|QUA" .
   "LITY_COUNT|TT)|MA(GIC_INT(_NOT)?|X_FACTORS)|PARABOLA_(COEF" .
   "F_[ABC]|R(EAL_ROOTS|OOT_[AB])|X_AXIS|Y_EXTREMA)|S(HC_S(HIF" .
   "TSHIFT|TEPSHIFT)|TTS(_(COUNT|M(A(GIC|X(_KEY)?)|EAN|IN|SQ)|" .
   "NUM)|C_(CO(UNT|VAR)|MAGIC|XX|YY)))|YEAR_PER_METONIC) LENGT" .
   "H LFENERGY LFHz LFWAVE(LENGTH|NUMBER) LIFEAGE LIGHT(|_(ERR" .
   "|REC)|CONST(_ERR)?|YEAR) LIT(ER|RE) LNT(EN|WO) LUMEN LUX M" .
   "ACH MAGNETIC(_ERR|FLUX|INDUCTION)? MARATHON MASS MEBI MEGA" .
   " MET(ER|RE) MFENERGY MFHz MFWAVE(LENGTH|NUMBER) MICRO(|WAV" .
   "E(ENERGY|Hz|WAVE(LENGTH|NUMBER))) MIL(E|KYWAY(AGE|DAY|MASS" .
   "|RADIUS)|LI) MINUTE MIR(ENERGY|Hz|WAVE(LENGTH|NUMBER)) MM " .
   "MMHG MOL(ARMASS(|_ERR|CONST(_ERR)?|X(_ERR)?)|E) MONTHS_IN_" .
   "YEAR MOONMONTH MPH MPSS? MU0(_ERR)? MUON(_MASS|ENERGY|Hz|M" .
   "ASS(_ERR)?|WAVELENGTH) NANO NAT NEUTRON(_MASS|ENERGY|Hz|MA" .
   "SS(_ERR)?|WAVELENGTH) NEWTON NICKEL(MAS|RADIU|THICKNES)S N" .
   "INEVOLT(BATTERY(CHARGE|ENERGY|VOLTAGE)?|CHARGE|ENERGY|VOLT" .
   "AGE)? NIR(ENERGY|Hz|WAVE(LENGTH|NUMBER)) Nm_PER_lbfin NPBO" .
   "UNDARY NUV(ENERGY|Hz|WAVE(LENGTH|NUMBER)) OHM ORANGE(ENERG" .
   "Y|Hz|WAVE(LENGTH|NUMBER)) OUNCE OZ PA PARSEC PEBI PENNY(MA" .
   "S|RADIU|THICKNES)S PETA PHI PHONEBATTERY(CHARGE|ENERGY|VOL" .
   "TAGE)? PI PICO PIN(GPONGBALL(MASS|RADIUS)|T) PLANCK(|_(ERR" .
   "|REC)|BAR(_ERR)?|C(HARGE|ONST(_ERR)?)|ENERGY|LENGTH|MASS|T" .
   "(EMP|IME)) POINT POUND POWER PPB PPM PPQ PPT PRESSURE PRO(" .
   "TON(_MASS|ENERGY|Hz|MASS(_ERR)?|RADIUS(_ERR)?|WAVELENGTH)|" .
   "XIMACENTAURI) PSI PTRBOUNDARY QUART(ER(MAS|RADIU|THICKNES)" .
   "S)? RAD(IAN)? RED(ENERGY|Hz|WAVE(LENGTH|NUMBER)) RESISTANC" .
   "E RPH RPM RPS RYDBERG(|_ERR|CONST(_ERR)?|ENERGY|Hz|WAVE(LE" .
   "NGTH|NUMBER)) SECOND SHANNON SHF(ENERGY|Hz|WAVE(LENGTH|NUM" .
   "BER)) SI16M(AX|IN) SI32M(AX|IN) SIEMENS SOCCERBALL(MASS|RA" .
   "DIUS) SOFTBALL(MASS|RADIUS) SOL(ARCONSTANT|ID_ANGLE) SPE(C" .
   "IFICHEAT|ED) SPHERESURFACE SQDEG SQRTTWO SQUAREDEGREE STAN" .
   "DARD(ATMOSPHERE|GRAVITY) STE(FAN(_ERR|CONST(_ERR)?)?|RADIA" .
   "N) SXENERGY SXHz SXWAVE(LENGTH|NUMBER) SXX(ENERGY|Hz|WAVE(" .
   "LENGTH|NUMBER)) TAU(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH" .
   ")? TBLSP TEBI TEMPERATURE TENNISBALL(MASS|RADIUS) TERA TES" .
   "LA THF(ENERGY|Hz|WAVE(LENGTH|NUMBER)) TIME TON(NE)? TORR T" .
   "RITON(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) TRJBOUNDARY " .
   "TSP TT_AT_0(TAI|UT1) TURN UAMU(_ERR)? UET UHF(ENERGY|Hz|WA" .
   "VE(LENGTH|NUMBER)) UI16MAX UI32MAX UNI(TGM|VERSE(AGE|MASS|" .
   "RADIUS)) UPQUARK(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) U" .
   "VA(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UVB(ENERGY|Hz|WAVE(LENGT" .
   "H|NUMBER)) UVC(ENERGY|Hz|WAVE(LENGTH|NUMBER)) VHF(ENERGY|H" .
   "z|WAVE(LENGTH|NUMBER)) VIOLET(ENERGY|Hz|WAVE(LENGTH|NUMBER" .
   ")) VISCOSITY VOL(T(AGE)?|UME) VONKLITZING(_ERR)? WATT WEBE" .
   "R WEEK YARD YELLOW(ENERGY|GREEN(ENERGY|Hz|WAVE(LENGTH|NUMB" .
   "ER))|Hz|WAVE(LENGTH|NUMBER)) YOBI YOCTO YOTTA ZEBI ZEPTO Z" .
   "ETTA" .
   "\n" .
   "   Kw 0-ary Functions: corr_new euler__1 gau_rand jd2ymdhm" .
   ...
   "lmean1 amean1 aqmean1 b2m bankers bellx? benford_rand bern" .
   "oulli[dn]? bess(I[01]|J[01]|K[01]|Y(0|1(__1)?)) bharea_to_" .
   "mass bhdensity_to_mass bhentropy_to_mass bhlifetime_to_mas" .
   "s bhmass_to_(area|density|entropy|lifetime|power|radius|te" .
   "mp) bhpower_to_mass bhradius_to_mass bhtemp_to_mass bit(s_" .
   "(count|ls1b(pos)?|ms1b(pos)?)|wisenot) blackbody(f_pdf|l_p" .
   "df|mode|power) cantor carmichael catalan cauchy_rand cbrt " .
   "ceil chisqr_rand circle_get clip clock(hour|min|s(ec|tdev|" .
   "um)) cnv_dbl2si16 contfra(_print|c(_print|d_print)) corr(_" .
   "(delete|handle[xy])|corr|s(lope|tderr)|y0) cos(|__1|d(inv)" .
   "?|h(inv)?|in(tegral|v)|m1(__1)?|t(inv)?) cot([dht]?(inv)?)" .
   "? csc([dht]?(inv)?)? ctz cu cube(root)? date_(easter|pesac" .
   "h|rosh_hashanah) day2(dhms(inv)?|hour) defined deg2(dms|ra" .
   "d|sec|tur) digamma(__1|inv)? dms2(deg|rad) doomsday ecc2fl" .
   "at Ein elliptic(1([ak]|m(__[12])?)|2([ak]|m(__1)?)|[EK]) e" .
   "rf(|__([12]|[34])|c(inv|x(inv)?)?|inv) eta euler(phi|x) ex" .
   "p(_(_[12]|rand)|integral[1i]|m1)? fac(|inv|tor(_print|ial(" .
   "double|inv)?)) fibo(x(inv)?)? flat2ecc floor frac fubini f" .
   "usc g2jewish gamma_rand gau_(cdf|pdf|quantile) gd gdinv ge" .
   "o_rand ghmean1(inv)? glmean1 gmean1 gqmean1 has_primitiver" .
   "oot haversin heaviside heronianmean1 hlmean1 hmean1 hn hn_" .
   "_1 hour2day hqmean1 hypot1(inv)? id int_rand iround is(eve" .
   "n|int|jewish8short|jewish9short|jewishleap|leapyear|magic|" .
   "neg|negint|odd|pos|posint|practical|prime|squarefree|zero)" .
   " j2k2(dow|jd|kwt|uet|ymdhms) jacobicir jd2(64_print|dow|j2" .
   "k|kwt|uet|ymdhms) jewish(2(g|jdx?)|_(months_in_year|yearle" .
   "ngth)) k2a k2m k2temp[cfr] ks_a_cdf kwt2(j(2k|d)|uet) l10 " .
   "lg lgamma(__[12]|inv)? lix(inv)? lmean1 ln ln1p ln__[12] l" .
   "ns log(10|2|i(ntegral|stic_rand))? lqmean1 lucasx? m2a m2b" .
   " m2k mertens minkowski mobius n2primish neg nom normal_(cd" .
   "f(__1)?|pdf|quantile(__1)?) num2char_print par(abola_(get|" .
   "roots)|titionq?) pcf pfg pfl poi_rand pow(10|2) prim(e([01" .
   "]|countx?|n(ext|th(__1)?)|prev)|itiveroot) qmean1 rad2(d(e" .
   "g|ms2?)|sec|tur) rand(_init|l) reci reimann round rto(125|" .
   "[iz]) sba search_(check|search) sec(|2(d(eg|hms)|rad|tur)|" .
   "[dht]?(inv)?) shc_s(hft2steps|teps2shft(inv)?) sig(m(a[01]" .
   "|oid(inv)?)|n) sin(|__1|c(__1|c|inv)?|d(inv)?|h(inv)?|in(t" .
   "egral|v)|t(inv)?) smooth sq sqinv sqrt(__[123]|x)? square(" .
   "root)? stair stts(_(delete|reset)|count|m(a(gic|x)|ean|in|" .
   "sq)|s(pread|tdev(mean)?|um)|var) supercatalan tan([dht]?(i" .
   "nv)?)? temp(c(2(k|tempf))?|f(2(k|tempc))?|r(2k)?) tgamma(_" .
   "_([123]|stirling)|double|inv)? topyh1 totient tri(_rand|in" .
   "v|p)? trunc tur2(deg|rad|sec) uet2(j(2k|d)|kwt) uni_rand v" .
   "ersin wm(inv)? wp(inv)? ymdhms(2j(2k|d)|_get) zag zeta zig" .
   "(zag)?" .
   "\n" .
   "   Kw 2-ary Functions: agmean(__1|inv[ag])? ahmean almean " .
   "amean aqmean atan2([dh]|[tu])? ballots? base_out(_print|f_" .
   "print) benford_(cdf|pdf) bess(_(jn|yn)|In(_ps)?|J(n(_ps)?|" .
   "v)|Kn|Y(n(_ps)?|v)) beta(_rand)? binomial(_rand|x)? birthd" .
   "ay(inv|x)? bit(s(_(get|set)|hift[lr])|wise(and|or|xor)) bk" .
   "n blackbody[fl] carlsonRC cauchy_(cdf|pdf|quantile) cd cei" .
   "l2 chisqr_(cdf|pdf) cir2ell cn cn__1 comb(ination|x)? cont" .
   "raharmonic cs d1diamond_d2 d1lt_d2 d1spiral_d2 d1ur_d2 d2d" .
   "iamond_d1 d2hypot_d1 d2lt_d1 d2spiral_d1 d2ur_d1 days_in_m" .
   "onth dc ddist dist dlog1 dn dn__1 ds ell(2cir|ip(se(area|c" .
   "ir(__1)?|ecc|flatness|[mn])|tic(1i([ak]|m(__1)?)|2i([ak]|m" .
   "(__1)?)|3([ak]|m(__1)?)|Ei|[FP]))) entringer eulerian exp(" .
   "_(cdf|pdf|quantile)|integraln) factor(ialt)? floor2 fmod([" .
   "suy]?)? fmul gamma_(cdf|pdf) gcda? geo_(cdf|pdf|quantile) " .
   "ghmean glmean gmean gompertz_rand gqmean has_primitiveroot" .
   "_f heronianmean hlmean hmean hnm hqmean hypot int(_(cdf|pd" .
   "f|quantile)|s_rand) is(eq|ge|gt|le|lt|mult|multl|neq|pract" .
   "ical_f|primitiveroot|signsame|squarefree_f|ss) jacobiphi j" .
   "ewish_month(begin|length) ks_(b_cdf|cdf|quantile) lbeta lc" .
   "a(ms?|ntim) lcm lcombx ligamma(inv)? lmean log(istic_(cdf|" .
   "pdf|quantile)|x) lpermx lqmean max(2|abs2?|i) mb_(cdf|pdf)" .
   " mean min(2|abs2?|i) mobius_f mod([fs]|ulo) n2perm_print n" .
   "bd_rand nc nd nevilletheta([cd]|[ns]) ns nthroot__1 pareto" .
   "_rand perm(utation|x)? pochhammer poi_(cdf|pdf|quantile) p" .
   "oly(a_rand|cnum|num) powi? prime0_f qmean rand_init_array " .
   "ratio repetendlen rligamma rms round2 rtomsd ruigamma sc s" .
   "d shc_shftpoles2steps sigma(0_f|1_f)? sn sn__1 spread2stde" .
   "v stdev2spread stirling[12] stts_(copy|downdate|newx|s(cal" .
   "e|hift)|update2?) t_cdf(__1)? t_pdf t_quantile(__1)? tetra" .
   "(cnum|num) theta([12]|[34]) Tn topyh totient_f trap_rand t" .
   "ri_(cdf|pdf|quantile) uigamma(__1|inv)? Un uni_(cdf|pdf|qu" .
   "antile) variance zeta_(cdf|pdf) zipf_rand znorder(__1)?" .
   "\n" .
   "   Kw 3-ary Functions: agcmean aghmean atothenmod[px] base" .
   "_out_fix_print beta(_(cdf|pdf|quantile)|inc(__1)?) binomia" .
   "l_(cdf|pdf) bits_assign bkbn cantor(ll|ul|xx) carlsonR[DF]" .
   " chebeval clip2x? corr_update cossin_ev divi dlogx? ellip(" .
   "soid_(surface|volume)|tic(3i([ak]|m(__1)?)|Pi)) epdf2cdf f" .
   "11 f_cdf f_quantile(__1)? fibo3 fit(_(ls0?|minmax0?|poly)|" .
   "x_minmax) fmod2 gompertz_(cdf|pdf|quantile) hms2day horner" .
   " hypot3 ifzero is(almostequal|between|betweenx|floorsame|w" .
   "ithin) jewishymd2jd kevy_print lv_ellpj max(absoffset|min|" .
   "well_(boltzmann_(cdf|pdf)|juttner_pdf)) minabsoffset n2com" .
   "b_print n2perm nbd_(cdf|pdf) pareto_(cdf|pdf|quantile) pen" .
   "dulum pmean polya_(cdf|pdf) remquou roundy sigm(a_f|oid3d?" .
   ") stts_updatex taninv3 trap_(cdf|pdf|quantile) ymd2(do[wy]" .
   "|j(2k(__1)?|d)) zipf_(cdf|pdf|quantile)" .
   "\n" .
   "   Kw 4-ary Functions: carlsonRJ f21 great_circle_distance" .
   " n2comb sphere_d" .
   "\n" .
