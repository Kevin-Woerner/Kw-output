...
@EXPORT_OK = ( qw(
   ...
   AU_ERR AVOGADRO AVOGADROCONST AVOGADROCONST_ERR AVOGADRO_ERR
   AVOGADRO_REC BAN BAR BARN BARREL BASEBALLMASS BASEBALLRADIUS
   BASKETBALLMASS BASKETBALLRADIUS BEKENSTEINENTROPY
   BEKENSTEININFORMATION BHENTROPY_AREA BHMASS3_LIFETIME
   BHMASSTEMP BHMASS_RADIUS BHRADIUS2DENSITY BIT BLUEENERGY
   BLUEHz BLUEWAVELENGTH BLUEWAVENUMBER BOHRRADIUS BOHRRADIUS_ERR
   BOLTZMANN BOLTZMANNCONST BOLTZMANNCONST_ERR BOLTZMANN_ERR
   BOLTZMANN_REC BTU BTU_IT BTU_TH CAL CALORIE CAL_IT CAL_TH
   CANDELA CAPACITANCE CARAT CARBATTERY CARBATTERYCHARGE
   CARBATTERYENERGY CARBATTERYVOLTAGE CBATTERY CBATTERYCHARGE
   CBATTERYENERGY CBATTERYVOLTAGE CENTI CHARGE CONDUCTANCE
   COULOMB COULOMBCONST COULOMBCONST_ERR CUP CURRENT DALTON
   DALTON_ERR DAY DBATTERY DBATTERYCHARGE DBATTERYENERGY
   DBATTERYVOLTAGE DBLEPS DBLMAN DBLMAX DBLMAXLN DBLSIG DECA DECI
   DEGC DEGF DEGR DENSITY DEUTERONMASS DEUTERONMASS_ERR
   DEUTERON_MASS DIMEMASS DIMERADIUS DIMETHICKNESS DISTANCE DIT
   DOWNQUARKENERGY DOWNQUARKHz DOWNQUARKMASS DOWNQUARKMASS_ERR
   DOWNQUARKWAVELENGTH DOWNQUARK_MASS E EARTHAGE EARTHGRAVITYA
   EARTHGRAVITYB EARTHSOLARDAY EHFENERGY EHFHz EHFWAVELENGTH
   EHFWAVENUMBER EINSTEIN EINSTEIN_ERR ELECTRIC ELECTRICCONST
   ELECTRICCONST_ERR ELECTRIC_ERR ELECTRONCHARGE
   ELECTRONCHARGE_ERR ELECTRONCHARGE_REC ELECTRONENERGY
   ELECTRONHz ELECTRONMASS ELECTRONMASSA ELECTRONMASSA_ERR
   ELECTRONMASS_ERR ELECTRONVOLT ELECTRONWAVELENGTH ELECTRON_MASS
   ELEMENTARYCHARGE ELEMENTARYCHARGE_ERR ELEVATIONMAX
   ELEVATIONMIN ENERGY EPSILON0 EPSILON0_ERR ERG EULER EUVENERGY
   EUVHz EUVWAVELENGTH EUVWAVENUMBER EXA EXBI Ein FARAD FARADAY
   FARADAYCONST FARADAYCONST_ERR FARADAY_ERR FEIGENBAUM FEMTO
   ...
   GALACTICCENTER GALLON GAMMAENERGY GAMMAHz GAMMAWAVELENGTH
   GAMMAWAVENUMBER GAS GASCONST GASCONST_ERR GAS_ERR GIANTIMPACT
   GIBI GIGA GOLFBALLMASS GOLFBALLRADIUS GRAD GRAIN GRAM
   GRAVITATION GRAVITATIONCONST GRAVITATIONCONST_ERR
   GRAVITATIONIERS GRAVITATIONNASA GRAVITATION_ERR GRAVITY
   GRAVITY_ERR GREENENERGY GREENHz GREENWAVELENGTH
   GREENWAVENUMBER GREGORIANYEAR GYEAR G_ERR HALAQIM
   HALAQIM_PER_HOUR HART HARTLEY HBAR HBAR_ERR HECTARE HECTO
   HELIONMASS HELIONMASS_ERR HELION_MASS HENRY HERTZ HFENERGY
   HFHz HFWAVELENGTH HFWAVENUMBER HI HIENERGY HIHz HIWAVELENGTH
   HIWAVENUMBER HI_ERR HORSEPOWER HOUR HP HPMETRIC HUBBLE
   HUBBLECONST HUBBLECONST_ERR HUBBLE_ERR HXENERGY HXHz
   ...
   LFWAVENUMBER LIFEAGE LIGHT LIGHTCONST LIGHTCONST_ERR LIGHTYEAR
   LIGHT_ERR LIGHT_REC LITER LITRE LNTEN LNTWO LUMEN LUX MACH
   MAGNETIC MAGNETICFLUX MAGNETICINDUCTION MAGNETIC_ERR MARATHON
   MASS MEBI MEGA METER METRE MFENERGY MFHz MFWAVELENGTH
   ...
   MIRHz MIRWAVELENGTH MIRWAVENUMBER MM MMHG MOLARMASS
   MOLARMASSCONST MOLARMASSCONST_ERR MOLARMASSX MOLARMASSX_ERR
   ...
   PLANCKCHARGE PLANCKCONST PLANCKCONST_ERR PLANCKENERGY
   PLANCKLENGTH PLANCKMASS PLANCKTEMP PLANCKTIME PLANCK_ERR
   PLANCK_REC POINT POUND POWER PPB PPM PPQ PPT PRESSURE
   PROTONENERGY PROTONHz PROTONMASS PROTONMASS_ERR PROTONRADIUS
   PROTONRADIUS_ERR PROTONWAVELENGTH PROTON_MASS PROXIMACENTAURI
   PSI PTRBOUNDARY QUART QUARTERMASS QUARTERRADIUS
   QUARTERTHICKNESS RAD RADIAN REDENERGY REDHz REDWAVELENGTH
   REDWAVENUMBER RESISTANCE RPM RPS RYDBERG RYDBERGCONST
   RYDBERGCONST_ERR RYDBERGENERGY RYDBERGHz RYDBERGWAVELENGTH
   RYDBERGWAVENUMBER RYDBERG_ERR SECOND SHANNON SHFENERGY SHFHz
   SHFWAVELENGTH SHFWAVENUMBER SI16MAX SI16MIN SI32MAX SI32MIN
   SIEMENS SOCCERBALLMASS SOCCERBALLRADIUS SOFTBALLMASS
   SOFTBALLRADIUS SOLARCONSTANT SOLID_ANGLE SPECIFICHEAT SPEED
   SPHERESURFACE SQDEG SQRTTWO SQUAREDEGREE STANDARDATMOSPHERE
   STANDARDGRAVITY STEFAN STEFANCONST STEFANCONST_ERR STEFAN_ERR
   STERADIAN SXENERGY SXHz SXWAVELENGTH SXWAVENUMBER SXXENERGY
   SXXHz SXXWAVELENGTH SXXWAVENUMBER TAU TAUENERGY TAUHz TAUMASS
   TAUMASS_ERR TAUWAVELENGTH TAU_MASS TBLSP TEBI TEMPERATURE
   TENNISBALLMASS TENNISBALLRADIUS TERA TESLA THFENERGY THFHz
   THFWAVELENGTH THFWAVENUMBER TIME TON TONNE TORR TRITONMASS
   TRITONMASS_ERR TRITON_MASS TRJBOUNDARY TSP TT_AT_0TAI
   TT_AT_0UT1 TURN Tn UAMU UAMU_ERR UET UHFENERGY UHFHz
   UHFWAVELENGTH UHFWAVENUMBER UI16MAX UI32MAX UNITGM UNIVERSEAGE
   UNIVERSEMASS UNIVERSERADIUS UPQUARKENERGY UPQUARKHz
   UPQUARKMASS UPQUARKMASS_ERR UPQUARKWAVELENGTH UPQUARK_MASS
   UVAENERGY UVAHz UVAWAVELENGTH UVAWAVENUMBER UVBENERGY UVBHz
   UVBWAVELENGTH UVBWAVENUMBER UVCENERGY UVCHz UVCWAVELENGTH
   UVCWAVENUMBER Un VHFENERGY VHFHz VHFWAVELENGTH VHFWAVENUMBER
   VIOLETENERGY VIOLETHz VIOLETWAVELENGTH VIOLETWAVENUMBER
   VISCOSITY VOLT VOLTAGE VOLUME VONKLITZING VONKLITZING_ERR WATT
   WEBER WEEK YARD YELLOWENERGY YELLOWGREENENERGY YELLOWGREENHz
   ...
   beta_quantile beta_rand betainc betainc__1 binomial
   binomial_cdf binomial_pdf binomial_rand binomialx birthday
   birthdayinv birthdayx bits_assign bits_count bits_get
   ...
   cxalpha_mass cxalpha_rec cxalpha_rec_err cxalphamass
   cxalphamass_err cxamp cxampere cxamu cxamu_err cxangle cxapery
   cxarcdeg cxarcdegree cxarcmin cxarcminute cxarcsec cxarcsecond
   cxare cxarea cxastronomicalunit cxatm cxatmosphere
   cxatmosphere_err cxatomicmassunit cxatomicmassunit_err cxatto
   cxau cxau_err cxavogadro cxavogadro_err cxavogadro_rec
   cxavogadroconst cxavogadroconst_err cxban cxbar cxbarn
   ...
   cxdegf cxdegr cxdensity cxdeuteron_mass cxdeuteronmass
   ...
   cxfaradayconst_err cxfeigenbaum cxfemto cxfinestructure
   ...
   cxhubble_err cxhubbleconst cxhubbleconst_err cxhxenergy cxhxhz
   ...
   cxkilogram cxkpgboundary cxkwt cxlb cxlbf cxlc_circle_radius
   cxlc_circle_x cxlc_circle_y cxlc_eps cxlc_gd_count cxlc_gd_day
   cxlc_gd_dow cxlc_gd_hour cxlc_gd_jd cxlc_gd_min cxlc_gd_month
   cxlc_gd_num cxlc_gd_sec cxlc_gd_year cxlc_knuth_array_count
   ...
   cxlight cxlight_err cxlight_rec cxlightconst cxlightconst_err
   cxlightyear cxliter cxlitre cxlnten cxlntwo cxlumen cxlux
   cxmach cxmagnetic cxmagnetic_err cxmagneticflux
   cxmagneticinduction cxmarathon cxmass cxmebi cxmega cxmeter
   cxmetre cxmfenergy cxmfhz cxmfwavelength cxmfwavenumber
   cxmicro cxmicrowaveenergy cxmicrowavehz cxmicrowavewavelength
   cxmicrowavewavenumber cxmile cxmilkywayage cxmilkywayday
   cxmilkywaymass cxmilkywayradius cxmilli cxminute cxmirenergy
   cxmirhz cxmirwavelength cxmirwavenumber cxmm cxmmhg
   cxmolarmass cxmolarmass_err cxmolarmassconst
   cxmolarmassconst_err cxmolarmassx cxmolarmassx_err cxmole
   cxmonths_in_year cxmoonmonth cxmph cxmps cxmpss cxmu0
   cxmu0_err cxmuon_mass cxmuonenergy cxmuonhz cxmuonmass
   cxmuonmass_err cxmuonwavelength cxnano cxnat cxneutron_mass
   cxneutronenergy cxneutronhz cxneutronmass cxneutronmass_err
   ...
   cxplanckcharge cxplanckconst cxplanckconst_err cxplanckenergy
   cxplancklength cxplanckmass cxplancktemp cxplancktime cxpoint
   cxpound cxpower cxppb cxppm cxppq cxppt cxpressure
   cxproton_mass cxprotonenergy cxprotonhz cxprotonmass
   cxprotonmass_err cxprotonradius cxprotonradius_err
   cxprotonwavelength cxproximacentauri cxpsi cxptrboundary
   cxquart cxquartermass cxquarterradius cxquarterthickness cxrad
   cxradian cxredenergy cxredhz cxredwavelength cxredwavenumber
   cxresistance cxrpm cxrps cxrydberg cxrydberg_err
   cxrydbergconst cxrydbergconst_err cxrydbergenergy cxrydberghz
   ...
   cxstefanconst cxstefanconst_err cxsteradian cxsxenergy cxsxhz
   cxsxwavelength cxsxwavenumber cxsxxenergy cxsxxhz
   cxsxxwavelength cxsxxwavenumber cxtau cxtau_mass cxtauenergy
   cxtauhz cxtaumass cxtaumass_err cxtauwavelength cxtblsp cxtebi
   cxtemperature cxtennisballmass cxtennisballradius cxtera
   cxtesla cxthfenergy cxthfhz cxthfwavelength cxthfwavenumber
   cxtime cxton cxtonne cxtorr cxtriton_mass cxtritonmass
   cxtritonmass_err cxtrjboundary cxtsp cxtt_at_0tai cxtt_at_0ut1
   cxturn cxuamu cxuamu_err cxuet cxuhfenergy cxuhfhz
   cxuhfwavelength cxuhfwavenumber cxui16max cxui32max cxunitgm
   cxuniverseage cxuniversemass cxuniverseradius cxupquark_mass
   cxupquarkenergy cxupquarkhz cxupquarkmass cxupquarkmass_err
   cxupquarkwavelength cxuvaenergy cxuvahz cxuvawavelength
   cxuvawavenumber cxuvbenergy cxuvbhz cxuvbwavelength
   cxuvbwavenumber cxuvcenergy cxuvchz cxuvcwavelength
   cxuvcwavenumber cxvhfenergy cxvhfhz cxvhfwavelength
   cxvhfwavenumber cxvioletenergy cxviolethz cxvioletwavelength
   ...
   kevy_print ks_a_cdf ks_b_cdf ks_cdf ks_quantile kwt2j2k kwt2jd
   kwt2uet l10 lbeta lcam lcams lcantim lcm lcombx lg lgamma
   lgamma__1 lgamma__2 lgammainv ligamma ligammainv lix lixinv
   lmean lmean1 ln ln1p ln__1 ln__2 lns log10 log2 logintegral
   logistic_cdf logistic_pdf logistic_quantile logistic_rand logx
   lpermx lqmean lqmean1 lucas lucasx lv_ellpj m2a m2b m2k
   magicnot magicset max2 maxabs maxabs2 maxabsoffset maxi maxmin
   ...
   modulo n2comb n2comb_print n2perm n2perm_print nbd_cdf nbd_pdf
   nbd_rand nc nd neg nevillethetac nevillethetad nevillethetan
   nevillethetas nom normal_cdf normal_cdf__1 normal_pdf
   normal_quantile normal_quantile__1 normal_rand ns nthroot__1
   num2char_print parabola_get parabola_realroots parabola_roots
   parabola_solve parabola_xaxis parabola_yextrema pareto_cdf
   pareto_pdf pareto_quantile pareto_rand partition partitionq
   pcf pendulum perm permutation permx pfg pfl pmean pochhammer
   poi_cdf poi_pdf poi_quantile poi_rand polya_cdf polya_pdf
   polya_rand polycnum polynum pow pow10 pow2 powi prime0
   prime0_f prime1 primecount primecountx primenext primenth
   primenth__1 primeprev primitiveroot qmean qmean1 rad2deg
...
sub BOLTZMANN_ERR() { 0; }
sub BOLTZMANNCONST() { 1.380649E-23 * JOULE / KELVIN; }
sub BOLTZMANNCONST_ERR() { 0; }
sub ELECTRONCHARGE() { 1.602176634E-19 * COULOMB; }
sub ELECTRONCHARGE_ERR() { 0; }
sub LIGHT() { 2.99792458E+8 * METER / SECOND; }
sub LIGHT_ERR() { 0; }
sub LIGHTCONST() { 2.99792458E+8 * METER / SECOND; }
sub LIGHTCONST_ERR() { 0; }
sub AVOGADRO() { 6.02214076E+23 / MOLE; }
sub AVOGADRO_ERR() { 0; }
sub AVOGADROCONST() { 6.02214076E+23 / MOLE; }
sub AVOGADROCONST_ERR() { 0; }
sub PLANCK() { 6.62607015E-34 * JOULE * SECOND; }
sub PLANCK_ERR() { 0; }
sub PLANCKCONST() { 6.62607015E-34 * JOULE * SECOND; }
sub PLANCKCONST_ERR() { 0; }
...
sub ELECTRICCONST() { 1.0 / (LIGHT * LIGHT * MU0); }
...
sub MOLARMASSCONST() { 0.99999999965 * GRAM / MOLE; }
...
sub STEFAN_ERR() { 0; }
sub STEFANCONST() { (TAU * TAU * LIGHT * BOLTZMANN) *
      ((BOLTZMANN / (LIGHT * HBAR)) * (BOLTZMANN / (LIGHT *
      HBAR)) * (BOLTZMANN / (LIGHT * HBAR))) / 240.0; }
sub STEFANCONST_ERR() { 0; }
...
sub HUBBLE_ERR() { 6E-3; }
sub HUBBLECONST() { 67.66E-3 * METER / (SECOND * PARSEC); }
sub HUBBLECONST_ERR() { 6E-3; }
...
sub kw_description() {
   ...
   "REC AVOGADROCONST AVOGADROCONST_ERR BAN BAR BARN BARREL BA" .
   "SEBALLMASS BASEBALLRADIUS BASKETBALLMASS BASKETBALLRADIUS " .
   "BEKENSTEINENTROPY BEKENSTEININFORMATION BHENTROPY_AREA BHM" .
   "ASS3_LIFETIME BHMASS_RADIUS BHMASSTEMP BHRADIUS2DENSITY BI" .
   "T BLUEENERGY BLUEHz BLUEWAVELENGTH BLUEWAVENUMBER BOHRRADI" .
   "US BOHRRADIUS_ERR BOLTZMANN BOLTZMANN_ERR BOLTZMANN_REC BO" .
   "LTZMANNCONST BOLTZMANNCONST_ERR BTU BTU_IT BTU_TH CAL CAL_" .
   "IT CAL_TH CALORIE CANDELA CAPACITANCE CARAT CARBATTERY CAR" .
   "BATTERYCHARGE CARBATTERYENERGY CARBATTERYVOLTAGE CBATTERY " .
   "CBATTERYCHARGE CBATTERYENERGY CBATTERYVOLTAGE CENTI CHARGE" .
   " CONDUCTANCE COULOMB COULOMBCONST COULOMBCONST_ERR CUP CUR" .
   "RENT DALTON DALTON_ERR DAY DBATTERY DBATTERYCHARGE DBATTER" .
   "YENERGY DBATTERYVOLTAGE DBLEPS DBLMAN DBLMAX DBLMAXLN DBLS" .
   "IG DECA DECI DEGC DEGF DEGR DENSITY DEUTERON_MASS DEUTERON" .
   "MASS DEUTERONMASS_ERR DIMEMASS DIMERADIUS DIMETHICKNESS DI" .
   "STANCE DIT DOWNQUARK_MASS DOWNQUARKENERGY DOWNQUARKHz DOWN" .
   "QUARKMASS DOWNQUARKMASS_ERR DOWNQUARKWAVELENGTH dvCs_ERR d" .
   "vCsENERGY dvCsHz dvCsHz_REC dvCsWAVELENGTH dvCsWAVENUMBER " .
   "E EARTHAGE EARTHGRAVITYA EARTHGRAVITYB EARTHSOLARDAY EHFEN" .
   "ERGY EHFHz EHFWAVELENGTH EHFWAVENUMBER EINSTEIN EINSTEIN_E" .
   "RR ELECTRIC ELECTRIC_ERR ELECTRICCONST ELECTRICCONST_ERR E" .
   "LECTRON_MASS ELECTRONCHARGE ELECTRONCHARGE_ERR ELECTRONCHA" .
   "RGE_REC ELECTRONENERGY ELECTRONHz ELECTRONMASS ELECTRONMAS" .
   "S_ERR ELECTRONMASSA ELECTRONMASSA_ERR ELECTRONVOLT ELECTRO" .
   "NWAVELENGTH ELEMENTARYCHARGE ELEMENTARYCHARGE_ERR ELEVATIO" .
   "NMAX ELEVATIONMIN ENERGY EPSILON0 EPSILON0_ERR ERG EULER E" .
   "UVENERGY EUVHz EUVWAVELENGTH EUVWAVENUMBER EXA EXBI FARAD " .
   "FARADAY FARADAY_ERR FARADAYCONST FARADAYCONST_ERR FEIGENBA" .
   "UM FEMTO FINESTRUCTURE FINESTRUCTURE_ERR FINESTRUCTURE_REC" .
   " FINESTRUCTURE_REC_ERR FINESTRUCTURECONST FINESTRUCTURECON" .
   "ST_ERR FIRENERGY FIRHz FIRWAVELENGTH FIRWAVENUMBER FLICK F" .
   "LOZ FLTEPS FLTMAN FLTMAX FLTSIG FOE FOOT FORCE FREQUENCY F" .
   "T G G_ERR GALACTICCENTER GALLON GAMMAENERGY GAMMAHz GAMMAW" .
   "AVELENGTH GAMMAWAVENUMBER GAS GAS_ERR GASCONST GASCONST_ER" .
   "R GIANTIMPACT GIBI GIGA GOLFBALLMASS GOLFBALLRADIUS GRAD G" .
   "RAIN GRAM GRAVITATION GRAVITATION_ERR GRAVITATIONCONST GRA" .
   "VITATIONCONST_ERR GRAVITATIONIERS GRAVITATIONNASA GRAVITY " .
   "GRAVITY_ERR GREENENERGY GREENHz GREENWAVELENGTH GREENWAVEN" .
   "UMBER GREGORIANYEAR GYEAR h h_ERR h_REC HALAQIM HALAQIM_PE" .
   "R_HOUR HART HARTLEY HBAR HBAR_ERR HECTARE HECTO HELION_MAS" .
   "S HELIONMASS HELIONMASS_ERR HENRY HERTZ HFENERGY HFHz HFWA" .
   "VELENGTH HFWAVENUMBER HI HI_ERR HIENERGY HIHz HIWAVELENGTH" .
   " HIWAVENUMBER HORSEPOWER HOUR HP HPMETRIC HUBBLE HUBBLE_ER" .
   "R HUBBLECONST HUBBLECONST_ERR HXENERGY HXHz HXWAVELENGTH H" .
   "XWAVENUMBER HYDROGENLINE HYDROGENLINE_ERR HYDROGENRADIUS H" .
   "YDROGENRADIUS_ERR INCH INDUCTANCE INHG INTMAX J2K J2KDAY J" .
   "C JCENTURY JD JDAY JDSEC_AT_0GREGORIAN JDSEC_AT_0J2K JDSEC" .
   "_AT_0KWT JDSEC_AT_0UET JEWISH_FIRST_MONTH JM JMILLENNIUM J" .
   "OSEPHSON JOSEPHSON_ERR JOULE JULIANCENTURY JULIANDAY JULIA" .
   "NMILLENNIUM JULIANYEAR JY JYEAR K_AT_0TEMPC K_AT_0TEMPF K_" .
   "AT_0TEMPR kB kB_ERR kB_REC KCD KCD_ERR KELVIN KG KGENERGY " .
   "KGF KGHz KGWAVELENGTH KGWAVENUMBER KIBI KILO KILOGRAM KPGB" .
   "OUNDARY KWT LB LBF LC_CIRCLE_RADIUS LC_CIRCLE_X LC_CIRCLE_" .
   "Y LC_EPS LC_GD_COUNT LC_GD_DAY LC_GD_DOW LC_GD_HOUR LC_GD_" .
   "JD LC_GD_MIN LC_GD_MONTH LC_GD_NUM LC_GD_SEC LC_GD_YEAR LC" .
   "_KNUTH_ARRAY_COUNT LC_KNUTH_KK_COUNT LC_KNUTH_LL LC_KNUTH_" .
   "MAX LC_KNUTH_QUALITY_COUNT LC_KNUTH_TT LC_MAGIC_INT LC_MAG" .
   "IC_INT_NOT LC_MAX_FACTORS LC_PARABOLA_COEFF_A LC_PARABOLA_" .
   "COEFF_B LC_PARABOLA_COEFF_C LC_PARABOLA_REAL_ROOTS LC_PARA" .
   "BOLA_ROOT_A LC_PARABOLA_ROOT_B LC_PARABOLA_X_AXIS LC_PARAB" .
   "OLA_Y_EXTREMA LC_STTS_COUNT LC_STTS_MAGIC LC_STTS_MAX LC_S" .
   "TTS_MAX_KEY LC_STTS_MEAN LC_STTS_MIN LC_STTS_MSQ LC_STTS_N" .
   "UM LC_STTSC_COUNT LC_STTSC_COVAR LC_STTSC_MAGIC LC_STTSC_X" .
   "X LC_STTSC_YY LENGTH LFENERGY LFHz LFWAVELENGTH LFWAVENUMB" .
   "ER LIFEAGE LIGHT LIGHT_ERR LIGHT_REC LIGHTCONST LIGHTCONST" .
   "_ERR LIGHTYEAR LITER LITRE LNTEN LNTWO LUMEN LUX MACH MAGN" .
   "ETIC MAGNETIC_ERR MAGNETICFLUX MAGNETICINDUCTION MARATHON " .
   "MASS MEBI MEGA METER METRE MFENERGY MFHz MFWAVELENGTH MFWA" .
   "VENUMBER MICRO MICROWAVEENERGY MICROWAVEHz MICROWAVEWAVELE" .
   "NGTH MICROWAVEWAVENUMBER MILE MILKYWAYAGE MILKYWAYDAY MILK" .
   "YWAYMASS MILKYWAYRADIUS MILLI MINUTE MIRENERGY MIRHz MIRWA" .
   "VELENGTH MIRWAVENUMBER MM MMHG MOLARMASS MOLARMASS_ERR MOL" .
   "ARMASSCONST MOLARMASSCONST_ERR MOLARMASSX MOLARMASSX_ERR M" .
   "OLE MONTHS_IN_YEAR MOONMONTH MPH MPS MPSS MU0 MU0_ERR MUON" .
   "_MASS MUONENERGY MUONHz MUONMASS MUONMASS_ERR MUONWAVELENG" .
   "TH NANO NAT NEUTRON_MASS NEUTRONENERGY NEUTRONHz NEUTRONMA" .
   "SS NEUTRONMASS_ERR NEUTRONWAVELENGTH NEWTON NICKELMASS NIC" .
   "KELRADIUS NICKELTHICKNESS NINEVOLT NINEVOLTBATTERY NINEVOL" .
   "TBATTERYCHARGE NINEVOLTBATTERYENERGY NINEVOLTBATTERYVOLTAG" .
   "E NINEVOLTCHARGE NINEVOLTENERGY NINEVOLTVOLTAGE NIRENERGY " .
   "NIRHz NIRWAVELENGTH NIRWAVENUMBER NPBOUNDARY NUVENERGY NUV" .
   "Hz NUVWAVELENGTH NUVWAVENUMBER OHM ORANGEENERGY ORANGEHz O" .
   "RANGEWAVELENGTH ORANGEWAVENUMBER OUNCE PA PARSEC PEBI PENN" .
   "YMASS PENNYRADIUS PENNYTHICKNESS PETA PHI PHONEBATTERY PHO" .
   "NEBATTERYCHARGE PHONEBATTERYENERGY PHONEBATTERYVOLTAGE PI " .
   "PICO PINGPONGBALLMASS PINGPONGBALLRADIUS PINT PLANCK PLANC" .
   "K_ERR PLANCK_REC PLANCKBAR PLANCKBAR_ERR PLANCKCHARGE PLAN" .
   "CKCONST PLANCKCONST_ERR PLANCKENERGY PLANCKLENGTH PLANCKMA" .
   "SS PLANCKTEMP PLANCKTIME POINT POUND POWER PPB PPM PPQ PPT" .
   " PRESSURE PROTON_MASS PROTONENERGY PROTONHz PROTONMASS PRO" .
   "TONMASS_ERR PROTONRADIUS PROTONRADIUS_ERR PROTONWAVELENGTH" .
   " PROXIMACENTAURI PSI PTRBOUNDARY QUART QUARTERMASS QUARTER" .
   "RADIUS QUARTERTHICKNESS RAD RADIAN REDENERGY REDHz REDWAVE" .
   "LENGTH REDWAVENUMBER RESISTANCE RPM RPS RYDBERG RYDBERG_ER" .
   "R RYDBERGCONST RYDBERGCONST_ERR RYDBERGENERGY RYDBERGHz RY" .
   "DBERGWAVELENGTH RYDBERGWAVENUMBER SECOND SHANNON SHFENERGY" .
   " SHFHz SHFWAVELENGTH SHFWAVENUMBER SI16MAX SI16MIN SI32MAX" .
   " SI32MIN SIEMENS SOCCERBALLMASS SOCCERBALLRADIUS SOFTBALLM" .
   "ASS SOFTBALLRADIUS SOLARCONSTANT SOLID_ANGLE SPECIFICHEAT " .
   "SPEED SPHERESURFACE SQDEG SQRTTWO SQUAREDEGREE STANDARDATM" .
   "OSPHERE STANDARDGRAVITY STEFAN STEFAN_ERR STEFANCONST STEF" .
   "ANCONST_ERR STERADIAN SXENERGY SXHz SXWAVELENGTH SXWAVENUM" .
   "BER SXXENERGY SXXHz SXXWAVELENGTH SXXWAVENUMBER TAU TAU_MA" .
   "SS TAUENERGY TAUHz TAUMASS TAUMASS_ERR TAUWAVELENGTH TBLSP" .
   " TEBI TEMPERATURE TENNISBALLMASS TENNISBALLRADIUS TERA TES" .
   "LA THFENERGY THFHz THFWAVELENGTH THFWAVENUMBER TIME TON TO" .
   "NNE TORR TRITON_MASS TRITONMASS TRITONMASS_ERR TRJBOUNDARY" .
   " TSP TT_AT_0TAI TT_AT_0UT1 TURN UAMU UAMU_ERR UET UHFENERG" .
   "Y UHFHz UHFWAVELENGTH UHFWAVENUMBER UI16MAX UI32MAX UNITGM" .
   " UNIVERSEAGE UNIVERSEMASS UNIVERSERADIUS UPQUARK_MASS UPQU" .
   "ARKENERGY UPQUARKHz UPQUARKMASS UPQUARKMASS_ERR UPQUARKWAV" .
   "ELENGTH UVAENERGY UVAHz UVAWAVELENGTH UVAWAVENUMBER UVBENE" .
   "RGY UVBHz UVBWAVELENGTH UVBWAVENUMBER UVCENERGY UVCHz UVCW" .
   "AVELENGTH UVCWAVENUMBER VHFENERGY VHFHz VHFWAVELENGTH VHFW" .
   "AVENUMBER VIOLETENERGY VIOLETHz VIOLETWAVELENGTH VIOLETWAV" .
   "ENUMBER VISCOSITY VOLT VOLTAGE VOLUME VONKLITZING VONKLITZ" .
   "ING_ERR WATT WEBER WEEK YARD YELLOWENERGY YELLOWGREENENERG" .
   "Y YELLOWGREENHz YELLOWGREENWAVELENGTH YELLOWGREENWAVENUMBE" .
   "R YELLOWHz YELLOWWAVELENGTH YELLOWWAVENUMBER YOBI YOCTO YO" .
   "TTA ZEBI ZEPTO ZETTA" .
   "\n" .
   ...
   "bessJ1 bessK0 bessK1 bessY0 bessY1 bessY1__1 bits_count bi" .
   "ts_ls1b bits_ls1bpos bits_ms1b bits_ms1bpos bitwisenot bla" .
   "ckbodyf_pdf blackbodyl_pdf blackbodymode blackbodypower ca" .
   "ntor carmichael catalan cauchy_rand cbrt ceil chisqr_rand " .
   "circle_get clip clockhour clockmin clocksec clockstdev clo" .
   "cksum cnv_dbl2si16 contfra_print contfrac_print contfracd_" .
   "print corr_delete corr_handlex corr_handley corrcorr corrs" .
   "lope corrstderr corry0 cos cos__1 cosd cosdinv cosh coshin" .
   "v cosintegral cosinv cosm1 cosm1__1 cost costinv cot cotd " .
   "cotdinv coth cothinv cotinv cott cottinv csc cscd cscdinv " .
   "csch cschinv cscinv csct csctinv ctz cu cube cuberoot date" .
   "_easter date_pesach date_rosh_hashanah day2dhms day2dhmsin" .
   "v day2hour defined deg2dms deg2rad deg2sec deg2tur digamma" .
   " digamma__1 digammainv dms2deg dms2rad doomsday ecc2flat E" .
   "in elliptic1a elliptic1k elliptic1m elliptic1m__1 elliptic" .
   "1m__2 elliptic2a elliptic2k elliptic2m elliptic2m__1 ellip" .
   "ticE ellipticK erf erf__1 erf__2 erf__3 erf__4 erfc erfcin" .
   "v erfcx erfcxinv erfinv eta eulerphi eulerx exp exp__1 exp" .
   "__2 exp_rand expintegral1 expintegrali expm1 fac facinv fa" .
   "ctor_print factorial factorialdouble factorialinv fibo fib" .
   "ox fiboxinv flat2ecc floor frac fubini fusc g2jewish gamma" .
   "_rand gau_cdf gau_pdf gau_quantile gd gdinv geo_rand ghmea" .
   "n1 ghmean1inv glmean1 gmean1 gqmean1 has_primitiveroot hav" .
   "ersin heaviside heronianmean1 hlmean1 hmean1 hn hn__1 hour" .
   "2day hqmean1 hypot1 hypot1inv id int_rand iround iseven is" .
   "int isjewish8short isjewish9short isjewishleap isleapyear " .
   "ismagic isneg isnegint isodd ispos isposint ispractical is" .
   "prime issquarefree iszero j2k2dow j2k2jd j2k2kwt j2k2uet j" .
   "2k2ymdhms jacobicir jd264_print jd2dow jd2j2k jd2kwt jd2ue" .
   "t jd2ymdhms jewish2g jewish2jd jewish2jdx jewish_months_in" .
   "_year jewish_yearlength k2a k2m k2tempc k2tempf k2tempr ks" .
   "_a_cdf kwt2j2k kwt2jd kwt2uet l10 lg lgamma lgamma__1 lgam" .
   "ma__2 lgammainv lix lixinv lmean1 ln ln1p ln__1 ln__2 lns " .
   "log log10 log2 logintegral logistic_rand lqmean1 lucas luc" .
   "asx m2a m2b m2k mertens minkowski mobius neg nom normal_cd" .
   "f normal_cdf__1 normal_pdf normal_quantile normal_quantile" .
   "__1 num2char_print parabola_get parabola_roots partition p" .
   "artitionq pcf pfg pfl poi_rand pow10 pow2 prime0 prime1 pr" .
   "imecount primecountx primenext primenth primenth__1 primep" .
   "rev primitiveroot qmean1 rad2deg rad2dms rad2dms2 rad2sec " .
   "rad2tur rand_init randl reci reimann round rto125 rtoi rto" .
   "z sba search_check search_search sec sec2deg sec2dhms sec2" .
   "rad sec2tur secd secdinv sech sechinv secinv sect sectinv " .
   "shc_shft2steps shc_steps2shft shc_steps2shftinv sigma0 sig" .
   "ma1 sigmoid sigmoidinv sign sin sin__1 sinc sinc__1 sincc " .
   "sincinv sind sindinv sinh sinhinv sinintegral sininv sint " .
   "sintinv smooth sq sqinv sqrt sqrt__1 sqrt__2 sqrt__3 sqrtx" .
   " square squareroot stair stts_delete stts_reset sttscount " .
   "sttsmagic sttsmax sttsmean sttsmin sttsmsq sttsspread stts" .
   "stdev sttsstdevmean sttssum sttsvar supercatalan tan tand " .
   "tandinv tanh tanhinv taninv tant tantinv tempc tempc2k tem" .
   "pc2tempf tempf tempf2k tempf2tempc tempr tempr2k tgamma tg" .
   "amma__1 tgamma__2 tgamma__3 tgamma__stirling tgammadouble " .
   "tgammainv topyh1 totient tri tri_rand triinv trip trunc tu" .
   "r2deg tur2rad tur2sec uet2j2k uet2jd uet2kwt uni_rand vers" .
   "in wm wminv wp wpinv ymdhms2j2k ymdhms2jd ymdhms_get zag z" .
   "eta zig zigzag" .
   "\n" .
...
sub kw_desc() {
   ...
   " ATTO AU AU_ERR AVOGADRO(|_(ERR|REC)|CONST(_ERR)?) BAN BAR" .
   "(N|REL)? BAS(EBALL(MASS|RADIUS)|KETBALL(MASS|RADIUS)) BEKE" .
   "NSTEIN(ENTROPY|INFORMATION) BHENTROPY_AREA BHMASS(3_LIFETI" .
   "ME|_RADIUS|TEMP) BHRADIUS2DENSITY BIT BLUE(ENERGY|Hz|WAVE(" .
   "LENGTH|NUMBER)) BOHRRADIUS(_ERR)? BOLTZMANN(|_(ERR|REC)|CO" .
   "NST(_ERR)?) BTU(_(IT|TH))? CAL(_(IT|TH)|ORIE)? CANDELA CAP" .
   "ACITANCE CAR(AT|BATTERY(CHARGE|ENERGY|VOLTAGE)?) CBATTERY(" .
   "CHARGE|ENERGY|VOLTAGE)? CENTI CHARGE CONDUCTANCE COULOMB(C" .
   "ONST(_ERR)?)? CUP CURRENT DALTON(_ERR)? DAY DBATTERY(CHARG" .
   "E|ENERGY|VOLTAGE)? DBL(EPS|MA(N|X(LN)?)|SIG) DEC[AI] DEG[C" .
   "FR] DENSITY DEUTERON(_MASS|MASS(_ERR)?) DIME(MAS|RADIU|THI" .
   "CKNES)S DISTANCE DIT DOWNQUARK(_MASS|ENERGY|Hz|MASS(_ERR)?" .
   "|WAVELENGTH) dvCs(_ERR|ENERGY|Hz(_REC)?|WAVE(LENGTH|NUMBER" .
   ")) E EARTH(AGE|GRAVITY[AB]|SOLARDAY) EHF(ENERGY|Hz|WAVE(LE" .
   "NGTH|NUMBER)) EINSTEIN(_ERR)? ELE(CTR(IC(_ERR|CONST(_ERR)?" .
   ")?|ON(_MASS|CHARGE(_(ERR|REC))?|ENERGY|Hz|MASS(_ERR|A(_ERR" .
   ")?)?|VOLT|WAVELENGTH))|MENTARYCHARGE(_ERR)?|VATIONM(AX|IN)" .
   ") ENERGY EPSILON0(_ERR)? ERG EULER EUV(ENERGY|Hz|WAVE(LENG" .
   "TH|NUMBER)) EXA EXBI FARAD(|AY(_ERR|CONST(_ERR)?)?) FEIGEN" .
   "BAUM FEMTO FINESTRUCTURE(|_(ERR|REC(_ERR)?)|CONST(_ERR)?) " .
   "FIR(ENERGY|Hz|WAVE(LENGTH|NUMBER)) FLICK FLOZ FLT(EPS|MA[N" .
   "X]|SIG) FOE FOOT FORCE FREQUENCY FT G G_ERR GAL(ACTICCENTE" .
   "R|LON) GAMMA(ENERGY|Hz|WAVE(LENGTH|NUMBER)) GAS(_ERR|CONST" .
   "(_ERR)?)? GIANTIMPACT GIBI GIGA GOLFBALL(MASS|RADIUS) GRA(" .
   "D|IN|M|VIT(ATION(_ERR|CONST(_ERR)?|IERS|NASA)?|Y(_ERR)?)) " .
   "GRE(EN(ENERGY|Hz|WAVE(LENGTH|NUMBER))|GORIANYEAR) GYEAR h " .
   "h_ERR h_REC HALAQIM(_PER_HOUR)? HART(LEY)? HBAR(_ERR)? HEC" .
   "T(ARE|O) HELION(_MASS|MASS(_ERR)?) HENRY HERTZ HFENERGY HF" .
   "Hz HFWAVE(LENGTH|NUMBER) HI HI_ERR HIENERGY HIHz HIWAVE(LE" .
   "NGTH|NUMBER) HORSEPOWER HOUR HP HPMETRIC HUBBLE(_ERR|CONST" .
   "(_ERR)?)? HXENERGY HXHz HXWAVE(LENGTH|NUMBER) HYDROGEN(LIN" .
   "E(_ERR)?|RADIUS(_ERR)?) INCH INDUCTANCE INHG INTMAX J2K(DA" .
   "Y)? JC JCENTURY JD JDAY JDSEC_AT_0(GREGORIAN|J2K|KWT|UET) " .
   "JEWISH_FIRST_MONTH JM JMILLENNIUM JOSEPHSON(_ERR)? JOULE J" .
   "ULIAN(CENTURY|DAY|MILLENNIUM|YEAR) JY JYEAR K_AT_0TEMP[CFR" .
   "] kB kB_(ERR|REC) KCD(_ERR)? KELVIN KG KGENERGY KGF KGHz K" .
   "GWAVE(LENGTH|NUMBER) KIBI KILO(GRAM)? KPGBOUNDARY KWT LB L" .
   "BF LC_(CIRCLE_(RADIUS|[XY])|EPS|GD_(COUNT|D(AY|OW)|HOUR|JD" .
   "|M(IN|ONTH)|NUM|SEC|YEAR)|KNUTH_(ARRAY_COUNT|KK_COUNT|LL|M" .
   "AX|QUALITY_COUNT|TT)|MA(GIC_INT(_NOT)?|X_FACTORS)|PARABOLA" .
   "_(COEFF_[ABC]|R(EAL_ROOTS|OOT_[AB])|X_AXIS|Y_EXTREMA)|STTS" .
   "(_(COUNT|M(A(GIC|X(_KEY)?)|EAN|IN|SQ)|NUM)|C_(CO(UNT|VAR)|" .
   "MAGIC|XX|YY))) LENGTH LFENERGY LFHz LFWAVE(LENGTH|NUMBER) " .
   "LIFEAGE LIGHT(|_(ERR|REC)|CONST(_ERR)?|YEAR) LIT(ER|RE) LN" .
   "T(EN|WO) LUMEN LUX MACH MAGNETIC(_ERR|FLUX|INDUCTION)? MAR" .
   "ATHON MASS MEBI MEGA MET(ER|RE) MFENERGY MFHz MFWAVE(LENGT" .
   "H|NUMBER) MICRO(|WAVE(ENERGY|Hz|WAVE(LENGTH|NUMBER))) MIL(" .
   "E|KYWAY(AGE|DAY|MASS|RADIUS)|LI) MINUTE MIR(ENERGY|Hz|WAVE" .
   "(LENGTH|NUMBER)) MM MMHG MOL(ARMASS(|_ERR|CONST(_ERR)?|X(_" .
   "ERR)?)|E) MONTHS_IN_YEAR MOONMONTH MPH MPSS? MU0(_ERR)? MU" .
   "ON(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) NANO NAT NEUTRO" .
   "N(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) NEWTON NICKEL(MA" .
   "S|RADIU|THICKNES)S NINEVOLT(BATTERY(CHARGE|ENERGY|VOLTAGE)" .
   "?|CHARGE|ENERGY|VOLTAGE)? NIR(ENERGY|Hz|WAVE(LENGTH|NUMBER" .
   ")) NPBOUNDARY NUV(ENERGY|Hz|WAVE(LENGTH|NUMBER)) OHM ORANG" .
   "E(ENERGY|Hz|WAVE(LENGTH|NUMBER)) OUNCE PA PARSEC PEBI PENN" .
   "Y(MAS|RADIU|THICKNES)S PETA PHI PHONEBATTERY(CHARGE|ENERGY" .
   "|VOLTAGE)? PI PICO PIN(GPONGBALL(MASS|RADIUS)|T) PLANCK(|_" .
   "(ERR|REC)|BAR(_ERR)?|C(HARGE|ONST(_ERR)?)|ENERGY|LENGTH|MA" .
   "SS|T(EMP|IME)) POINT POUND POWER PPB PPM PPQ PPT PRESSURE " .
   "PRO(TON(_MASS|ENERGY|Hz|MASS(_ERR)?|RADIUS(_ERR)?|WAVELENG" .
   "TH)|XIMACENTAURI) PSI PTRBOUNDARY QUART(ER(MAS|RADIU|THICK" .
   "NES)S)? RAD(IAN)? RED(ENERGY|Hz|WAVE(LENGTH|NUMBER)) RESIS" .
   "TANCE RPM RPS RYDBERG(|_ERR|CONST(_ERR)?|ENERGY|Hz|WAVE(LE" .
   ...
   "TURN UAMU(_ERR)? UET UHF(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UI" .
   "16MAX UI32MAX UNI(TGM|VERSE(AGE|MASS|RADIUS)) UPQUARK(_MAS" .
   "S|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) UVA(ENERGY|Hz|WAVE(LEN" .
   "GTH|NUMBER)) UVB(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UVC(ENERGY" .
   "|Hz|WAVE(LENGTH|NUMBER)) VHF(ENERGY|Hz|WAVE(LENGTH|NUMBER)" .
   ") VIOLET(ENERGY|Hz|WAVE(LENGTH|NUMBER)) VISCOSITY VOL(T(AG" .
   "E)?|UME) VONKLITZING(_ERR)? WATT WEBER WEEK YARD YELLOW(EN" .
   "ERGY|GREEN(ENERGY|Hz|WAVE(LENGTH|NUMBER))|Hz|WAVE(LENGTH|N" .
   "UMBER)) YOBI YOCTO YOTTA ZEBI ZEPTO ZETTA" .
   "\n" .
   "   Kw 0-ary Functions: corr_new euler__1 gau_rand jd2ymdhm" .
   ...
   "oulli[dn]? bess(I[01]|J[01]|K[01]|Y(0|1(__1)?)) bit(s_(cou" .
   "nt|ls1b(pos)?|ms1b(pos)?)|wisenot) blackbody(f_pdf|l_pdf|m" .
   "ode|power) cantor carmichael catalan cauchy_rand cbrt ceil" .
   " chisqr_rand circle_get clip clock(hour|min|s(ec|tdev|um))" .
   " cnv_dbl2si16 contfra(_print|c(_print|d_print)) corr(_(del" .
   "ete|handle[xy])|corr|s(lope|tderr)|y0) cos(|__1|d(inv)?|h(" .
   "inv)?|in(tegral|v)|m1(__1)?|t(inv)?) cot([dht]?(inv)?)? cs" .
   "c([dht]?(inv)?)? ctz cu cube(root)? date_(easter|pesach|ro" .
   "sh_hashanah) day2(dhms(inv)?|hour) defined deg2(dms|rad|se" .
   "c|tur) digamma(__1|inv)? dms2(deg|rad) doomsday ecc2flat E" .
   "in elliptic(1([ak]|m(__[12])?)|2([ak]|m(__1)?)|[EK]) erf(|" .
   "__([12]|[34])|c(inv|x(inv)?)?|inv) eta euler(phi|x) exp(_(" .
   "_[12]|rand)|integral[1i]|m1)? fac(|inv|tor(_print|ial(doub" .
   "le|inv)?)) fibo(x(inv)?)? flat2ecc floor frac fubini fusc " .
   "g2jewish gamma_rand gau_(cdf|pdf|quantile) gd gdinv geo_ra" .
   "nd ghmean1(inv)? glmean1 gmean1 gqmean1 has_primitiveroot " .
   "haversin heaviside heronianmean1 hlmean1 hmean1 hn hn__1 h" .
   "our2day hqmean1 hypot1(inv)? id int_rand iround is(even|in" .
   "t|jewish8short|jewish9short|jewishleap|leapyear|magic|neg|" .
   "negint|odd|pos|posint|practical|prime|squarefree|zero) j2k" .
   "2(dow|jd|kwt|uet|ymdhms) jacobicir jd2(64_print|dow|j2k|kw" .
   "t|uet|ymdhms) jewish(2(g|jdx?)|_(months_in_year|yearlength" .
   ")) k2a k2m k2temp[cfr] ks_a_cdf kwt2(j(2k|d)|uet) l10 lg l" .
   "gamma(__[12]|inv)? lix(inv)? lmean1 ln ln1p ln__[12] lns l" .
   "og(10|2|i(ntegral|stic_rand))? lqmean1 lucasx? m2a m2b m2k" .
   " mertens minkowski mobius neg nom normal_(cdf(__1)?|pdf|qu" .
   "antile(__1)?) num2char_print par(abola_(get|roots)|titionq" .
   "?) pcf pfg pfl poi_rand pow(10|2) prim(e([01]|countx?|n(ex" .
   "t|th(__1)?)|prev)|itiveroot) qmean1 rad2(d(eg|ms2?)|sec|tu" .
   "r) rand(_init|l) reci reimann round rto(125|[iz]) sba sear" .
   "ch_(check|search) sec(|2(d(eg|hms)|rad|tur)|[dht]?(inv)?) " .
   "shc_s(hft2steps|teps2shft(inv)?) sig(m(a[01]|oid(inv)?)|n)" .
   " sin(|__1|c(__1|c|inv)?|d(inv)?|h(inv)?|in(tegral|v)|t(inv" .
   ")?) smooth sq sqinv sqrt(__[123]|x)? square(root)? stair s" .
   "tts(_(delete|reset)|count|m(a(gic|x)|ean|in|sq)|s(pread|td" .
   "ev(mean)?|um)|var) supercatalan tan([dht]?(inv)?)? temp(c(" .
   "2(k|tempf))?|f(2(k|tempc))?|r(2k)?) tgamma(__([123]|stirli" .
   "ng)|double|inv)? topyh1 totient tri(_rand|inv|p)? trunc tu" .
