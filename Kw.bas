...
Public Function sincinv(ByVal yy As Double) As Double
   ...
   ElseIf (yy < 1.0) Then
      aa = yy - min_yy
      bb = 1.0 - yy
      start_xx = (aa * Sqr(5.0 * bb) + bb * (min_xx - Sqr(6 * _
            aa))) / (1.0 - min_yy)
      nrvx_xx = start_xx
      For nrvx_ii = 0 To 20
         nrvx_xp = nrvx_xx
...
Public Function jewish2jdx(ByVal hebyear As Long) As Double
   ...
   hour_el = (5 + (12 * months_el) + 793 * floor(months_el / _
         HALAQIM_PER_HOUR) + floor(halaqims_el / _
         HALAQIM_PER_HOUR))
...
Public Function nevillethetad(ByVal mm As Double, ByVal zz As _
   ...
   Do While (True)
      ...
      nn = nn + 1
   Loop
   nevillethetad = (((1 + 2 * sum_curr) * Sqr(Kw.TAU / km) / _
         2.0))
End Function
Public Function nevillethetan(ByVal mm As Double, ByVal zz As _
   ...
   Loop
   nevillethetan _
         = (((1 + 2 * sum_curr) * Sqr(Kw.TAU / (km * Sqr(1.0 _
               - mm))) / 2.0))
End Function
Public Function nevillethetas(ByVal mm As Double, ByVal zz As _
   ...
   Loop
   nevillethetas _
         = ((sum_curr * Sqr(Kw.TAU * Sqr(qq / (mm * (1 - _
               mm))) / km)))
End Function
