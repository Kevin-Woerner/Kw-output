...
'IMPORT "Kw"
'IMPORT "Kwplanets"
Public Function kwsun_obliquity_rad(ByVal jtwok As Double) As Double
   Dim tmill As Double
...
End Function
Public Function kwsun_eccentricity(ByVal jtwok As Double) As Double
   kwsun_eccentricity = ((-1.2025E-9) * jtwok + Kwplanets.EARTH_ECCENTRICITY)
   Exit Function
End Function
Public Function kwsun_perihelion_rad(ByVal jtwok As Double) As Double
   Dim pdeg As Double
   pdeg = (8.850749897E-6) * jtwok + 282.93768193
   kwsun_perihelion_rad = Kw.deg2rad(Kw.fmodu(pdeg, Kw.tur2deg(1.0)))
End Function
Public Function kwsun_mean_anomaly_rad(ByVal jtwok As Double) As Double
   Dim madeg As Double
...
End Function
Private Function lf_x_earth_position(ByVal jtwok As Double) As Double
   ...
   lv_x_sun_ra_rad = Kw.fmodu(Atan2(earth_yy_au, earth_xx_au), _
            Kw.tur2rad(1.0))
   lv_x_sun_dec_rad = Atan2(earth_zz_au, Kw.hypot(earth_xx_au, earth_yy_au))
   lf_x_earth_position = 0.0
End Function
Public Function kwsunx_init(ByVal jtwok As Double, ByVal tz_hr As Double, _
         ByVal lon_deg As Double, ByVal lat_deg As Double) As Double
...
End Function
Public Function kwsun_eccentric_anomaly_rad(ByVal ma_deg As Double, ByVal _
...
End Function
Private Function lf_sinalt(ByVal jtwok As Double, ByVal geo_longitude_deg _
         As Double, ByVal cos_geo_latitude As Double, ByVal _
         sin_geo_latitude As Double) As Double
   ' local-use Vb6 lv_sun_ra_rad
   ' local-use Vb6 lv_sun_dec_rad
...
End Function
Private Function lf_parabola_solve(ByVal delta_x As Double, ByVal ym As _
         Double, ByVal yz As Double, ByVal yp As Double) As Double
...
Private Function lf_sun_event(ByVal jtwok As Double, ByVal _
         ...
         want_sunrise As Long) As Double
...
End Function
Public Function kwsun_sin_altitude_sun(ByVal jtwok As Double, ByVal _
         time_zone_in_hours As Double, ByVal geo_lon_deg As Double, ByVal _
         geo_lat_deg As Double) As Double
...
End Function
Public Function kwsun_rise_day(ByVal jtwok As Double, ByVal tz_in_hours _
         As Double, ByVal lon_deg As Double, ByVal lat_deg As Double) As _
         Double
   kwsun_rise_day = lf_sun_event(jtwok, tz_in_hours, lon_deg, lat_deg, - _
            Kwsun.SUNBELOW_RAD, 1)
End Function
Public Function kwsun_set_day(ByVal jtwok As Double, ByVal tz_in_hours As _
...
Public Function kwsun_moon(ByVal jtwok As Double) As Double
   ...
   lv_moon_ra_rad = Kw.fmodu(2.0 * Atan2(yy, xx + rho), Kw.tur2rad(1.0))
...
End Function
Private Function lf_ra_sunmoon_diff_rad(ByVal jtwok As Double, ByVal frad _
         As Double) As Double
