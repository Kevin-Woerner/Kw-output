...
@EXPORT = ();
@EXPORT_OK = ( qw(
   AIRMASS AIR_MASS AcMASS AcZ Ac_BOIL Ac_Cp Ac_DENSITY Ac_En
   Ac_MASS Ac_MELT AgMASS AgZ Ag_BOIL Ag_Cp Ag_DENSITY Ag_En
   Ag_MASS Ag_MELT AlMASS AlZ Al_BOIL Al_Cp Al_DENSITY Al_En
   Al_MASS Al_MELT AmMASS AmZ Am_BOIL Am_Cp Am_DENSITY Am_En
   Am_MASS Am_MELT ArMASS ArZ Ar_BOIL Ar_Cp Ar_DENSITY Ar_En
   Ar_MASS Ar_MELT AsMASS AsZ As_BOIL As_Cp As_DENSITY As_En
   As_MASS As_MELT AtMASS AtZ At_BOIL At_Cp At_DENSITY At_En
   At_MASS At_MELT AuMASS AuZ Au_BOIL Au_Cp Au_DENSITY Au_En
   Au_MASS Au_MELT BMASS BUTANEJPKG BUTANEJPKGTOTAL BUTANEJPMOLE
   ...
   COALMASS COAL_MASS CZ C_BOIL C_Cp C_DENSITY C_En C_MASS
   C_MEAN_MASS C_MELT CaMASS CaZ Ca_BOIL Ca_Cp Ca_DENSITY Ca_En
   Ca_MASS Ca_MELT CdMASS CdZ Cd_BOIL Cd_Cp Cd_DENSITY Cd_En
   Cd_MASS Cd_MELT CeMASS CeZ Ce_BOIL Ce_Cp Ce_DENSITY Ce_En
   Ce_MASS Ce_MELT CfMASS CfZ Cf_BOIL Cf_Cp Cf_DENSITY Cf_En
   Cf_MASS Cf_MELT ClMASS ClZ Cl_BOIL Cl_Cp Cl_DENSITY Cl_En
   Cl_MASS Cl_MELT CmMASS CmZ Cm_BOIL Cm_Cp Cm_DENSITY Cm_En
   Cm_MASS Cm_MELT CnMASS CnZ Cn_BOIL Cn_Cp Cn_DENSITY Cn_En
   Cn_MASS Cn_MELT CoMASS CoZ Co_BOIL Co_Cp Co_DENSITY Co_En
   Co_MASS Co_MELT CrMASS CrZ Cr_BOIL Cr_Cp Cr_DENSITY Cr_En
   Cr_MASS Cr_MELT CsMASS CsZ Cs_BOIL Cs_Cp Cs_DENSITY Cs_En
   Cs_MASS Cs_MELT CuMASS CuZ Cu_BOIL Cu_Cp Cu_DENSITY Cu_En
   Cu_MASS Cu_MELT DIESELDENSITY DIESELJPKG DIESELJPKGTOTAL
   DIESELJPMOLE DIESELMASS DIESEL_MASS DbMASS DbZ Db_BOIL Db_Cp
   Db_DENSITY Db_En Db_MASS Db_MELT DsMASS DsZ Ds_BOIL Ds_Cp
   Ds_DENSITY Ds_En Ds_MASS Ds_MELT DyMASS DyZ Dy_BOIL Dy_Cp
   Dy_DENSITY Dy_En Dy_MASS Dy_MELT ETHANEJPKG ETHANEJPKGTOTAL
   ETHANEJPMOLE ETHANEMASS ETHANE_MASS ETHANOLDENSITY ETHANOLJPKG
   ...
   PARAFFINJPMOLE PARAFFINMASS PARAFFIN_MASS PENTANEJPKG
   PENTANEJPKGTOTAL PENTANEJPMOLE PENTANEMASS PENTANE_MASS PMASS
   PROPANEJPKG PROPANEJPKGTOTAL PROPANEJPMOLE PROPANEMASS
   PROPANE_MASS PZ P_BOIL P_Cp P_DENSITY P_En P_MASS P_MELT
   ...
   RaMASS RaZ Ra_BOIL Ra_Cp Ra_DENSITY Ra_En Ra_MASS Ra_MELT
   RbMASS RbZ Rb_BOIL Rb_Cp Rb_DENSITY Rb_En Rb_MASS Rb_MELT
   ReMASS ReZ Re_BOIL Re_Cp Re_DENSITY Re_En Re_MASS Re_MELT
   RfMASS RfZ Rf_BOIL Rf_Cp Rf_DENSITY Rf_En Rf_MASS Rf_MELT
   RgMASS RgZ Rg_BOIL Rg_Cp Rg_DENSITY Rg_En Rg_MASS Rg_MELT
   RhMASS RhZ Rh_BOIL Rh_Cp Rh_DENSITY Rh_En Rh_MASS Rh_MELT
   RnMASS RnZ Rn_BOIL Rn_Cp Rn_DENSITY Rn_En Rn_MASS Rn_MELT
   RuMASS RuZ Ru_BOIL Ru_Cp Ru_DENSITY Ru_En Ru_MASS Ru_MELT
   SMASS STEAM_Cp SUCROSEJPKG SUCROSEJPKGTOTAL SUCROSEJPMOLE
   SUCROSEMASS SUCROSE_MASS SUGARDENSITY SUGARJPKG SUGARJPKGTOTAL
   SUGARJPMOLE SUGARMASS SUGAR_MASS SZ S_BOIL S_Cp S_DENSITY S_En
   S_MASS S_MELT SbMASS SbZ Sb_BOIL Sb_Cp Sb_DENSITY Sb_En
   Sb_MASS Sb_MELT ScMASS ScZ Sc_BOIL Sc_Cp Sc_DENSITY Sc_En
   Sc_MASS Sc_MELT SeMASS SeZ Se_BOIL Se_Cp Se_DENSITY Se_En
   Se_MASS Se_MELT SgMASS SgZ Sg_BOIL Sg_Cp Sg_DENSITY Sg_En
   Sg_MASS Sg_MELT SiMASS SiZ Si_BOIL Si_Cp Si_DENSITY Si_En
   Si_MASS Si_MELT SmMASS SmZ Sm_BOIL Sm_Cp Sm_DENSITY Sm_En
   Sm_MASS Sm_MELT SnMASS SnZ Sn_BOIL Sn_Cp Sn_DENSITY Sn_En
   Sn_MASS Sn_MELT SrMASS SrZ Sr_BOIL Sr_Cp Sr_DENSITY Sr_En
   Sr_MASS Sr_MELT TNTJPKG TaMASS TaZ Ta_BOIL Ta_Cp Ta_DENSITY
   Ta_En Ta_MASS Ta_MELT TbMASS TbZ Tb_BOIL Tb_Cp Tb_DENSITY
   Tb_En Tb_MASS Tb_MELT TcMASS TcZ Tc_BOIL Tc_Cp Tc_DENSITY
   Tc_En Tc_MASS Tc_MELT TeMASS TeZ Te_BOIL Te_Cp Te_DENSITY
   Te_En Te_MASS Te_MELT ThMASS ThZ Th_BOIL Th_Cp Th_DENSITY
   Th_En Th_MASS Th_MELT TiMASS TiZ Ti_BOIL Ti_Cp Ti_DENSITY
   Ti_En Ti_MASS Ti_MELT TlMASS TlZ Tl_BOIL Tl_Cp Tl_DENSITY
   Tl_En Tl_MASS Tl_MELT TmMASS TmZ Tm_BOIL Tm_Cp Tm_DENSITY
   Tm_En Tm_MASS Tm_MELT TsMASS TsZ Ts_BOIL Ts_Cp Ts_DENSITY
   Ts_En Ts_MASS Ts_MELT UMASS UZ U_BOIL U_Cp U_DENSITY U_En
   U_MASS U_MELT VMASS VSMOW_H1_RATIO VSMOW_H2_RATIO
   VSMOW_H3_RATIO VSMOW_H_MASS VSMOW_MASS VSMOW_O16_RATIO
   VSMOW_O17_RATIO VSMOW_O18_RATIO VSMOW_O_MASS VZ V_BOIL V_Cp
   V_DENSITY V_En V_MASS V_MELT WATERMASS WATER_Cp WATER_FUSION
   WATER_MASS WATER_VAPORIZATION WMASS WZ W_BOIL W_Cp W_DENSITY
   W_En W_MASS W_MELT XeMASS XeZ Xe_BOIL Xe_Cp Xe_DENSITY Xe_En
   Xe_MASS Xe_MELT YMASS YZ Y_BOIL Y_Cp Y_DENSITY Y_En Y_MASS
   Y_MELT YbMASS YbZ Yb_BOIL Yb_Cp Yb_DENSITY Yb_En Yb_MASS
   Yb_MELT ZnMASS ZnZ Zn_BOIL Zn_Cp Zn_DENSITY Zn_En Zn_MASS
   Zn_MELT ZrMASS ZrZ Zr_BOIL Zr_Cp Zr_DENSITY Zr_En Zr_MASS
   Zr_MELT cxac_boil cxac_cp cxac_density cxac_en cxac_mass
   cxac_melt cxacmass cxacz cxag_boil cxag_cp cxag_density
   cxag_en cxag_mass cxag_melt cxagmass cxagz cxair_mass
   cxairmass cxal_boil cxal_cp cxal_density cxal_en cxal_mass
   cxal_melt cxalmass cxalz cxam_boil cxam_cp cxam_density
   cxam_en cxam_mass cxam_melt cxammass cxamz cxar_boil cxar_cp
   cxar_density cxar_en cxar_mass cxar_melt cxarmass cxarz
   cxas_boil cxas_cp cxas_density cxas_en cxas_mass cxas_melt
   cxasmass cxasz cxat_boil cxat_cp cxat_density cxat_en
   cxat_mass cxat_melt cxatmass cxatz cxau_boil cxau_cp
   cxau_density cxau_en cxau_mass cxau_melt cxaumass cxauz
   cxb_boil cxb_cp cxb_density cxb_en cxb_mass cxb_melt cxba_boil
   cxba_cp cxba_density cxba_en cxba_mass cxba_melt cxbamass
   cxbaz cxbe_boil cxbe_cp cxbe_density cxbe_en cxbe_mass
   cxbe_melt cxbemass cxbez cxbh_boil cxbh_cp cxbh_density
   cxbh_en cxbh_mass cxbh_melt cxbhmass cxbhz cxbi_boil cxbi_cp
   cxbi_density cxbi_en cxbi_mass cxbi_melt cxbimass cxbiz
   cxbk_boil cxbk_cp cxbk_density cxbk_en cxbk_mass cxbk_melt
   cxbkmass cxbkz cxbmass cxbr_boil cxbr_cp cxbr_density cxbr_en
   cxbr_mass cxbr_melt cxbrmass cxbrz cxbutane_mass cxbutanejpkg
   ...
   cxc_cp cxc_density cxc_en cxc_mass cxc_mean_mass cxc_melt
   ...
   cxpdmass cxpdz cxpentane_mass cxpentanejpkg cxpentanejpkgtotal
   cxpentanejpmole cxpentanemass cxpm_boil cxpm_cp cxpm_density
   cxpm_en cxpm_mass cxpm_melt cxpmass cxpmmass cxpmz cxpo_boil
   cxpo_cp cxpo_density cxpo_en cxpo_mass cxpo_melt cxpomass
   cxpoz cxpr_boil cxpr_cp cxpr_density cxpr_en cxpr_mass
   cxpr_melt cxprmass cxpropane_mass cxpropanejpkg
   cxpropanejpkgtotal cxpropanejpmole cxpropanemass cxprz
   cxpt_boil cxpt_cp cxpt_density cxpt_en cxpt_mass cxpt_melt
   cxptmass cxptz cxpu_boil cxpu_cp cxpu_density cxpu_en
   cxpu_mass cxpu_melt cxpumass cxpuz cxpz cxra_boil cxra_cp
   cxra_density cxra_en cxra_mass cxra_melt cxramass cxraz
   cxrb_boil cxrb_cp cxrb_density cxrb_en cxrb_mass cxrb_melt
   cxrbmass cxrbz cxre_boil cxre_cp cxre_density cxre_en
   cxre_mass cxre_melt cxremass cxrez cxrf_boil cxrf_cp
   cxrf_density cxrf_en cxrf_mass cxrf_melt cxrfmass cxrfz
   cxrg_boil cxrg_cp cxrg_density cxrg_en cxrg_mass cxrg_melt
   cxrgmass cxrgz cxrh_boil cxrh_cp cxrh_density cxrh_en
   cxrh_mass cxrh_melt cxrhmass cxrhz cxrn_boil cxrn_cp
   cxrn_density cxrn_en cxrn_mass cxrn_melt cxrnmass cxrnz
   cxru_boil cxru_cp cxru_density cxru_en cxru_mass cxru_melt
   cxrumass cxruz cxs_boil cxs_cp cxs_density cxs_en cxs_mass
   cxs_melt cxsb_boil cxsb_cp cxsb_density cxsb_en cxsb_mass
   cxsb_melt cxsbmass cxsbz cxsc_boil cxsc_cp cxsc_density
   cxsc_en cxsc_mass cxsc_melt cxscmass cxscz cxse_boil cxse_cp
   cxse_density cxse_en cxse_mass cxse_melt cxsemass cxsez
   cxsg_boil cxsg_cp cxsg_density cxsg_en cxsg_mass cxsg_melt
   cxsgmass cxsgz cxsi_boil cxsi_cp cxsi_density cxsi_en
   cxsi_mass cxsi_melt cxsimass cxsiz cxsm_boil cxsm_cp
   cxsm_density cxsm_en cxsm_mass cxsm_melt cxsmass cxsmmass
   cxsmz cxsn_boil cxsn_cp cxsn_density cxsn_en cxsn_mass
   cxsn_melt cxsnmass cxsnz cxsr_boil cxsr_cp cxsr_density
   cxsr_en cxsr_mass cxsr_melt cxsrmass cxsrz cxsteam_cp
   cxsucrose_mass cxsucrosejpkg cxsucrosejpkgtotal
   cxsucrosejpmole cxsucrosemass cxsugar_mass cxsugardensity
   cxsugarjpkg cxsugarjpkgtotal cxsugarjpmole cxsugarmass cxsz
   cxta_boil cxta_cp cxta_density cxta_en cxta_mass cxta_melt
   cxtamass cxtaz cxtb_boil cxtb_cp cxtb_density cxtb_en
   ...
   cxtemass cxtez cxth_boil cxth_cp cxth_density cxth_en
   cxth_mass cxth_melt cxthmass cxthz cxti_boil cxti_cp
   cxti_density cxti_en cxti_mass cxti_melt cxtimass cxtiz
   cxtl_boil cxtl_cp cxtl_density cxtl_en cxtl_mass cxtl_melt
   cxtlmass cxtlz cxtm_boil cxtm_cp cxtm_density cxtm_en
   cxtm_mass cxtm_melt cxtmmass cxtmz cxtntjpkg cxts_boil cxts_cp
   cxts_density cxts_en cxts_mass cxts_melt cxtsmass cxtsz
   cxu_boil cxu_cp cxu_density cxu_en cxu_mass cxu_melt cxumass
   cxuz cxv_boil cxv_cp cxv_density cxv_en cxv_mass cxv_melt
   cxvmass cxvsmow_h1_ratio cxvsmow_h2_ratio cxvsmow_h3_ratio
   cxvsmow_h_mass cxvsmow_mass cxvsmow_o16_ratio
   cxvsmow_o17_ratio cxvsmow_o18_ratio cxvsmow_o_mass cxvz
   cxw_boil cxw_cp cxw_density cxw_en cxw_mass cxw_melt
   cxwater_cp cxwater_fusion cxwater_mass cxwater_vaporization
   cxwatermass cxwmass cxwz cxxe_boil cxxe_cp cxxe_density
   cxxe_en cxxe_mass cxxe_melt cxxemass cxxez cxy_boil cxy_cp
   cxy_density cxy_en cxy_mass cxy_melt cxyb_boil cxyb_cp
   cxyb_density cxyb_en cxyb_mass cxyb_melt cxybmass cxybz
   cxymass cxyz cxzn_boil cxzn_cp cxzn_density cxzn_en cxzn_mass
   cxzn_melt cxznmass cxznz cxzr_boil cxzr_cp cxzr_density
   cxzr_en cxzr_mass cxzr_melt cxzrmass cxzrz
)); # End of EXPORT_OK
...
sub HYDROGENMASS() { 2 * HMASS + 0 * CMASS + 0 * NMASS + 0 *
      OMASS; }
sub HYDROGENJPMOLE() { 2.86E+5 * Kw::JOULE / Kw::MOLE; }
...
sub SUGARJPKGTOTAL() { SUGARJPMOLE / (SUGAR_MASS + (22 / 4.0
      + 12 - 11 / 2.0) * 2.0 * O_MASS); }
sub SUCROSE_MASS() { 22 * H_MASS + 12 * C_MASS + 0 * N_MASS +
      11 * O_MASS; }
sub SUCROSEMASS() { 22 * HMASS + 12 * CMASS + 0 * NMASS + 11
      * OMASS; }
sub SUCROSEJPMOLE() { 5.6467E+6 * Kw::JOULE / Kw::MOLE; }
sub SUCROSEJPKG() { SUCROSEJPMOLE / SUCROSE_MASS; }
sub SUCROSEJPKGTOTAL() { SUCROSEJPMOLE / (SUCROSE_MASS + (22
...
sub COALJPKGTOTAL() { COALJPMOLE / (COAL_MASS + (0 / 4.0 + 1
      - 0 / 2.0) * 2.0 * O_MASS); }
...
sub FATJPKGTOTAL() { FATJPMOLE / (FAT_MASS + (100 / 4.0 + 60
      - 6 / 2.0) * 2.0 * O_MASS); }
...
sub DIESELJPKGTOTAL() { DIESELJPMOLE / (DIESEL_MASS + (26 /
...
sub kwelements_description() {
   ...
   "_MASS Ag_MELT AgMASS AgZ AIR_MASS AIRMASS Al_BOIL Al_Cp Al" .
   "_DENSITY Al_En Al_MASS Al_MELT AlMASS AlZ Am_BOIL Am_Cp Am" .
   "_DENSITY Am_En Am_MASS Am_MELT AmMASS AmZ Ar_BOIL Ar_Cp Ar" .
   "_DENSITY Ar_En Ar_MASS Ar_MELT ArMASS ArZ As_BOIL As_Cp As" .
   "_DENSITY As_En As_MASS As_MELT AsMASS AsZ At_BOIL At_Cp At" .
   "_DENSITY At_En At_MASS At_MELT AtMASS AtZ Au_BOIL Au_Cp Au" .
   "_DENSITY Au_En Au_MASS Au_MELT AuMASS AuZ B_BOIL B_Cp B_DE" .
   "NSITY B_En B_MASS B_MELT Ba_BOIL Ba_Cp Ba_DENSITY Ba_En Ba" .
   "_MASS Ba_MELT BaMASS BaZ Be_BOIL Be_Cp Be_DENSITY Be_En Be" .
   "_MASS Be_MELT BeMASS BeZ Bh_BOIL Bh_Cp Bh_DENSITY Bh_En Bh" .
   "_MASS Bh_MELT BhMASS BhZ Bi_BOIL Bi_Cp Bi_DENSITY Bi_En Bi" .
   "_MASS Bi_MELT BiMASS BiZ Bk_BOIL Bk_Cp Bk_DENSITY Bk_En Bk" .
   "_MASS Bk_MELT BkMASS BkZ BMASS Br_BOIL Br_Cp Br_DENSITY Br" .
   "_En Br_MASS Br_MELT BrMASS BrZ BUTANE_MASS BUTANEJPKG BUTA" .
   "NEJPKGTOTAL BUTANEJPMOLE BUTANEMASS BZ C12_MASS C12_RATIO " .
   "C12H22O11_MASS C12H22O11MASS C12MASS C13_MASS C13_RATIO C1" .
   "3MASS C14_MASS C14_RATIO C14MASS C2H60_MASS C2H60MASS C2H6" .
   "_MASS C2H6MASS C3H8_MASS C3H8MASS C4H10_MASS C4H10MASS C_B" .
   "OIL C_Cp C_DENSITY C_En C_MASS C_MEAN_MASS C_MELT Ca_BOIL " .
   "Ca_Cp Ca_DENSITY Ca_En Ca_MASS Ca_MELT CaMASS CaZ Cd_BOIL " .
   "Cd_Cp Cd_DENSITY Cd_En Cd_MASS Cd_MELT CdMASS CdZ Ce_BOIL " .
   "Ce_Cp Ce_DENSITY Ce_En Ce_MASS Ce_MELT CeMASS CeZ Cf_BOIL " .
   "Cf_Cp Cf_DENSITY Cf_En Cf_MASS Cf_MELT CfMASS CfZ CH3CH2OH" .
   "_MASS CH3CH2OHMASS CH4_MASS CH4MASS Cl_BOIL Cl_Cp Cl_DENSI" .
   "TY Cl_En Cl_MASS Cl_MELT ClMASS ClZ Cm_BOIL Cm_Cp Cm_DENSI" .
   "TY Cm_En Cm_MASS Cm_MELT CMASS CmMASS CmZ Cn_BOIL Cn_Cp Cn" .
   "_DENSITY Cn_En Cn_MASS Cn_MELT CnMASS CnZ Co_BOIL Co_Cp Co" .
   "_DENSITY Co_En Co_MASS Co_MELT COAL_MASS COALJPKG COALJPKG" .
   "TOTAL COALJPMOLE COALMASS CoMASS CoZ Cr_BOIL Cr_Cp Cr_DENS" .
   "ITY Cr_En Cr_MASS Cr_MELT CrMASS CrZ Cs_BOIL Cs_Cp Cs_DENS" .
   "ITY Cs_En Cs_MASS Cs_MELT CsMASS CsZ Cu_BOIL Cu_Cp Cu_DENS" .
   "ITY Cu_En Cu_MASS Cu_MELT CuMASS CuZ CZ Db_BOIL Db_Cp Db_D" .
   "ENSITY Db_En Db_MASS Db_MELT DbMASS DbZ DIESEL_MASS DIESEL" .
   "DENSITY DIESELJPKG DIESELJPKGTOTAL DIESELJPMOLE DIESELMASS" .
   " Ds_BOIL Ds_Cp Ds_DENSITY Ds_En Ds_MASS Ds_MELT DsMASS DsZ" .
   " Dy_BOIL Dy_Cp Dy_DENSITY Dy_En Dy_MASS Dy_MELT DyMASS DyZ" .
   " Er_BOIL Er_Cp Er_DENSITY Er_En Er_MASS Er_MELT ErMASS ErZ" .
   " Es_BOIL Es_Cp Es_DENSITY Es_En Es_MASS Es_MELT EsMASS EsZ" .
   " ETHANE_MASS ETHANEJPKG ETHANEJPKGTOTAL ETHANEJPMOLE ETHAN" .
   "EMASS ETHANOL_MASS ETHANOLDENSITY ETHANOLJPKG ETHANOLJPKGT" .
   "OTAL ETHANOLJPMOLE ETHANOLMASS Eu_BOIL Eu_Cp Eu_DENSITY Eu" .
   "_En Eu_MASS Eu_MELT EuMASS EuZ F_BOIL F_Cp F_DENSITY F_En " .
   "F_MASS F_MELT FAT_MASS FATDENSITY FATJPKG FATJPKGTOTAL FAT" .
   "JPMOLE FATMASS Fe_BOIL Fe_Cp Fe_DENSITY Fe_En Fe_MASS Fe_M" .
   "ELT FeMASS FeZ Fl_BOIL Fl_Cp Fl_DENSITY Fl_En Fl_MASS Fl_M" .
   "ELT FlMASS FlZ Fm_BOIL Fm_Cp Fm_DENSITY Fm_En Fm_MASS Fm_M" .
   "ELT FMASS FmMASS FmZ Fr_BOIL Fr_Cp Fr_DENSITY Fr_En Fr_MAS" .
   "S Fr_MELT FrMASS FrZ FZ Ga_BOIL Ga_Cp Ga_DENSITY Ga_En Ga_" .
   "MASS Ga_MELT GaMASS GASOLINE_MASS GASOLINEDENSITY GASOLINE" .
   "JPKG GASOLINEJPKGTOTAL GASOLINEJPMOLE GASOLINEMASS GaZ Gd_" .
   "BOIL Gd_Cp Gd_DENSITY Gd_En Gd_MASS Gd_MELT GdMASS GdZ Ge_" .
   "BOIL Ge_Cp Ge_DENSITY Ge_En Ge_MASS Ge_MELT GeMASS GeZ H1_" .
   "MASS H1MASS H2_MASS H2MASS H3_MASS H3MASS H_BOIL H_Cp H_DE" .
   "NSITY H_En H_MASS H_MELT He3_MASS He3MASS He4_MASS He4MASS" .
   " He_BOIL He_Cp He_DENSITY He_En He_MASS He_MELT HeMASS HeZ" .
   " Hf_BOIL Hf_Cp Hf_DENSITY Hf_En Hf_MASS Hf_MELT HfMASS HfZ" .
   " Hg_BOIL Hg_Cp Hg_DENSITY Hg_En Hg_MASS Hg_MELT HgMASS HgZ" .
   " HMASS Ho_BOIL Ho_Cp Ho_DENSITY Ho_En Ho_MASS Ho_MELT HoMA" .
   "SS HoZ Hs_BOIL Hs_Cp Hs_DENSITY Hs_En Hs_MASS Hs_MELT HsMA" .
   "SS HsZ HYDROGEN_MASS HYDROGENJPKG HYDROGENJPKGTOTAL HYDROG" .
   "ENJPMOLE HYDROGENMASS HZ I_BOIL I_Cp I_DENSITY I_En I_MASS" .
   " I_MELT ICE_Cp IMASS In_BOIL In_Cp In_DENSITY In_En In_MAS" .
   "S In_MELT InMASS InZ Ir_BOIL Ir_Cp Ir_DENSITY Ir_En Ir_MAS" .
   "S Ir_MELT IrMASS IrZ IZ K_BOIL K_Cp K_DENSITY K_En K_MASS " .
   "K_MELT KMASS Kr_BOIL Kr_Cp Kr_DENSITY Kr_En Kr_MASS Kr_MEL" .
   "T KrMASS KrZ KZ La_BOIL La_Cp La_DENSITY La_En La_MASS La_" .
   "MELT LaMASS LaZ Li_BOIL Li_Cp Li_DENSITY Li_En Li_MASS Li_" .
   "MELT LiMASS LiZ Lr_BOIL Lr_Cp Lr_DENSITY Lr_En Lr_MASS Lr_" .
   "MELT LrMASS LrZ Lu_BOIL Lu_Cp Lu_DENSITY Lu_En Lu_MASS Lu_" .
   "MELT LuMASS LuZ Lv_BOIL Lv_Cp Lv_DENSITY Lv_En Lv_MASS Lv_" .
   "MELT LvMASS LvZ Mc_BOIL Mc_Cp Mc_DENSITY Mc_En Mc_MASS Mc_" .
   "MELT McMASS McZ Md_BOIL Md_Cp Md_DENSITY Md_En Md_MASS Md_" .
   "MELT MdMASS MdZ METHANE_MASS METHANEJPKG METHANEJPKGTOTAL " .
   "METHANEJPMOLE METHANEMASS Mg_BOIL Mg_Cp Mg_DENSITY Mg_En M" .
   "g_MASS Mg_MELT MgMASS MgZ Mn_BOIL Mn_Cp Mn_DENSITY Mn_En M" .
   "n_MASS Mn_MELT MnMASS MnZ Mo_BOIL Mo_Cp Mo_DENSITY Mo_En M" .
   "o_MASS Mo_MELT MoMASS MoZ Mt_BOIL Mt_Cp Mt_DENSITY Mt_En M" .
   "t_MASS Mt_MELT MtMASS MtZ N_BOIL N_Cp N_DENSITY N_En N_MAS" .
   "S N_MELT Na_BOIL Na_Cp Na_DENSITY Na_En Na_MASS Na_MELT Na" .
   "MASS NaZ Nb_BOIL Nb_Cp Nb_DENSITY Nb_En Nb_MASS Nb_MELT Nb" .
   "MASS NbZ Nd_BOIL Nd_Cp Nd_DENSITY Nd_En Nd_MASS Nd_MELT Nd" .
   "MASS NdZ Ne_BOIL Ne_Cp Ne_DENSITY Ne_En Ne_MASS Ne_MELT Ne" .
   "MASS NeZ Nh_BOIL Nh_Cp Nh_DENSITY Nh_En Nh_MASS Nh_MELT Nh" .
   "MASS NhZ Ni_BOIL Ni_Cp Ni_DENSITY Ni_En Ni_MASS Ni_MELT Ni" .
   "MASS NiZ NMASS No_BOIL No_Cp No_DENSITY No_En No_MASS No_M" .
   "ELT NoMASS NoZ Np_BOIL Np_Cp Np_DENSITY Np_En Np_MASS Np_M" .
   "ELT NpMASS NpZ NZ O16_MASS O16MASS O17_MASS O17MASS O18_MA" .
   "SS O18MASS O_BOIL O_Cp O_DENSITY O_En O_MASS O_MELT Og_BOI" .
   "L Og_Cp Og_DENSITY Og_En Og_MASS Og_MELT OgMASS OgZ OMASS " .
   "Os_BOIL Os_Cp Os_DENSITY Os_En Os_MASS Os_MELT OsMASS OsZ " .
   "OZ P_BOIL P_Cp P_DENSITY P_En P_MASS P_MELT Pa_BOIL Pa_Cp " .
   "Pa_DENSITY Pa_En Pa_MASS Pa_MELT PaMASS PARAFFIN_MASS PARA" .
   "FFINDENSITY PARAFFINJPKG PARAFFINJPKGTOTAL PARAFFINJPMOLE " .
   "PARAFFINMASS PaZ Pb_BOIL Pb_Cp Pb_DENSITY Pb_En Pb_MASS Pb" .
   "_MELT PbMASS PbZ Pd_BOIL Pd_Cp Pd_DENSITY Pd_En Pd_MASS Pd" .
   "_MELT PdMASS PdZ PENTANE_MASS PENTANEJPKG PENTANEJPKGTOTAL" .
   " PENTANEJPMOLE PENTANEMASS Pm_BOIL Pm_Cp Pm_DENSITY Pm_En " .
   "Pm_MASS Pm_MELT PMASS PmMASS PmZ Po_BOIL Po_Cp Po_DENSITY " .
   "Po_En Po_MASS Po_MELT PoMASS PoZ Pr_BOIL Pr_Cp Pr_DENSITY " .
   "Pr_En Pr_MASS Pr_MELT PrMASS PROPANE_MASS PROPANEJPKG PROP" .
   "ANEJPKGTOTAL PROPANEJPMOLE PROPANEMASS PrZ Pt_BOIL Pt_Cp P" .
   "t_DENSITY Pt_En Pt_MASS Pt_MELT PtMASS PtZ Pu_BOIL Pu_Cp P" .
   "u_DENSITY Pu_En Pu_MASS Pu_MELT PuMASS PuZ PZ Ra_BOIL Ra_C" .
   "p Ra_DENSITY Ra_En Ra_MASS Ra_MELT RaMASS RaZ Rb_BOIL Rb_C" .
   "p Rb_DENSITY Rb_En Rb_MASS Rb_MELT RbMASS RbZ Re_BOIL Re_C" .
   "p Re_DENSITY Re_En Re_MASS Re_MELT ReMASS ReZ Rf_BOIL Rf_C" .
   "p Rf_DENSITY Rf_En Rf_MASS Rf_MELT RfMASS RfZ Rg_BOIL Rg_C" .
   "p Rg_DENSITY Rg_En Rg_MASS Rg_MELT RgMASS RgZ Rh_BOIL Rh_C" .
   "p Rh_DENSITY Rh_En Rh_MASS Rh_MELT RhMASS RhZ Rn_BOIL Rn_C" .
   "p Rn_DENSITY Rn_En Rn_MASS Rn_MELT RnMASS RnZ Ru_BOIL Ru_C" .
   "p Ru_DENSITY Ru_En Ru_MASS Ru_MELT RuMASS RuZ S_BOIL S_Cp " .
   "S_DENSITY S_En S_MASS S_MELT Sb_BOIL Sb_Cp Sb_DENSITY Sb_E" .
   "n Sb_MASS Sb_MELT SbMASS SbZ Sc_BOIL Sc_Cp Sc_DENSITY Sc_E" .
   "n Sc_MASS Sc_MELT ScMASS ScZ Se_BOIL Se_Cp Se_DENSITY Se_E" .
   "n Se_MASS Se_MELT SeMASS SeZ Sg_BOIL Sg_Cp Sg_DENSITY Sg_E" .
   "n Sg_MASS Sg_MELT SgMASS SgZ Si_BOIL Si_Cp Si_DENSITY Si_E" .
   "n Si_MASS Si_MELT SiMASS SiZ Sm_BOIL Sm_Cp Sm_DENSITY Sm_E" .
   "n Sm_MASS Sm_MELT SMASS SmMASS SmZ Sn_BOIL Sn_Cp Sn_DENSIT" .
   "Y Sn_En Sn_MASS Sn_MELT SnMASS SnZ Sr_BOIL Sr_Cp Sr_DENSIT" .
   "Y Sr_En Sr_MASS Sr_MELT SrMASS SrZ STEAM_Cp SUCROSE_MASS S" .
   "UCROSEJPKG SUCROSEJPKGTOTAL SUCROSEJPMOLE SUCROSEMASS SUGA" .
   "R_MASS SUGARDENSITY SUGARJPKG SUGARJPKGTOTAL SUGARJPMOLE S" .
   "UGARMASS SZ Ta_BOIL Ta_Cp Ta_DENSITY Ta_En Ta_MASS Ta_MELT" .
   " TaMASS TaZ Tb_BOIL Tb_Cp Tb_DENSITY Tb_En Tb_MASS Tb_MELT" .
   " TbMASS TbZ Tc_BOIL Tc_Cp Tc_DENSITY Tc_En Tc_MASS Tc_MELT" .
   " TcMASS TcZ Te_BOIL Te_Cp Te_DENSITY Te_En Te_MASS Te_MELT" .
   " TeMASS TeZ Th_BOIL Th_Cp Th_DENSITY Th_En Th_MASS Th_MELT" .
   " ThMASS ThZ Ti_BOIL Ti_Cp Ti_DENSITY Ti_En Ti_MASS Ti_MELT" .
   " TiMASS TiZ Tl_BOIL Tl_Cp Tl_DENSITY Tl_En Tl_MASS Tl_MELT" .
   " TlMASS TlZ Tm_BOIL Tm_Cp Tm_DENSITY Tm_En Tm_MASS Tm_MELT" .
   " TmMASS TmZ TNTJPKG Ts_BOIL Ts_Cp Ts_DENSITY Ts_En Ts_MASS" .
   " Ts_MELT TsMASS TsZ U_BOIL U_Cp U_DENSITY U_En U_MASS U_ME" .
   "LT UMASS UZ V_BOIL V_Cp V_DENSITY V_En V_MASS V_MELT VMASS" .
   " VSMOW_H1_RATIO VSMOW_H2_RATIO VSMOW_H3_RATIO VSMOW_H_MASS" .
   " VSMOW_MASS VSMOW_O16_RATIO VSMOW_O17_RATIO VSMOW_O18_RATI" .
   "O VSMOW_O_MASS VZ W_BOIL W_Cp W_DENSITY W_En W_MASS W_MELT" .
   " WATER_Cp WATER_FUSION WATER_MASS WATER_VAPORIZATION WATER" .
   "MASS WMASS WZ Xe_BOIL Xe_Cp Xe_DENSITY Xe_En Xe_MASS Xe_ME" .
   "LT XeMASS XeZ Y_BOIL Y_Cp Y_DENSITY Y_En Y_MASS Y_MELT Yb_" .
   "BOIL Yb_Cp Yb_DENSITY Yb_En Yb_MASS Yb_MELT YbMASS YbZ YMA" .
   "SS YZ Zn_BOIL Zn_Cp Zn_DENSITY Zn_En Zn_MASS Zn_MELT ZnMAS" .
   "S ZnZ Zr_BOIL Zr_Cp Zr_DENSITY Zr_En Zr_MASS Zr_MELT ZrMAS" .
   "S ZrZ" .
   "\n";
}
sub kwelements_desc() {
   ...
   " AIR(_MASS|MASS) Al_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) AlMASS" .
   " AlZ Am_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) AmMASS AmZ Ar_(BOI" .
   "L|Cp|DENSITY|En|M(ASS|ELT)) ArMASS ArZ As_(BOIL|Cp|DENSITY" .
   "|En|M(ASS|ELT)) AsMASS AsZ At_(BOIL|Cp|DENSITY|En|M(ASS|EL" .
   "T)) AtMASS AtZ Au_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) AuMASS A" .
   "uZ B_BOIL B_Cp B_DENSITY B_En B_M(ASS|ELT) Ba_(BOIL|Cp|DEN" .
   "SITY|En|M(ASS|ELT)) BaMASS BaZ Be_(BOIL|Cp|DENSITY|En|M(AS" .
   "S|ELT)) BeMASS BeZ Bh_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) BhMA" .
   "SS BhZ Bi_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) BiMASS BiZ Bk_(B" .
   "OIL|Cp|DENSITY|En|M(ASS|ELT)) BkMASS BkZ BMASS Br_(BOIL|Cp" .
   "|DENSITY|En|M(ASS|ELT)) BrMASS BrZ BUTANE(_MASS|JP(KG(TOTA" .
   "L)?|MOLE)|MASS) BZ C12(_(MASS|RATIO)|H22O11(_MASS|MASS)|MA" .
   "SS) C13(_(MASS|RATIO)|MASS) C14(_(MASS|RATIO)|MASS) C2H6(0" .
   "(_MASS|MASS)|_MASS|MASS) C3H8(_MASS|MASS) C4H10(_MASS|MASS" .
   ") C_BOIL C_Cp C_DENSITY C_En C_M(ASS|E(AN_MASS|LT)) Ca_(BO" .
   "IL|Cp|DENSITY|En|M(ASS|ELT)) CaMASS CaZ Cd_(BOIL|Cp|DENSIT" .
   "Y|En|M(ASS|ELT)) CdMASS CdZ Ce_(BOIL|Cp|DENSITY|En|M(ASS|E" .
   "LT)) CeMASS CeZ Cf_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) CfMASS " .
   "CfZ CH3CH2OH(_MASS|MASS) CH4(_MASS|MASS) Cl_(BOIL|Cp|DENSI" .
   "TY|En|M(ASS|ELT)) ClMASS ClZ Cm_(BOIL|Cp|DENSITY|En|M(ASS|" .
   "ELT)) CMASS CmMASS CmZ Cn_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) " .
   "CnMASS CnZ Co_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) COAL(_MASS|J" .
   "P(KG(TOTAL)?|MOLE)|MASS) CoMASS CoZ Cr_(BOIL|Cp|DENSITY|En" .
   "|M(ASS|ELT)) CrMASS CrZ Cs_(BOIL|Cp|DENSITY|En|M(ASS|ELT))" .
   " CsMASS CsZ Cu_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) CuMASS CuZ " .
   "CZ Db_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) DbMASS DbZ DIESEL(_M" .
   "ASS|DENSITY|JP(KG(TOTAL)?|MOLE)|MASS) Ds_(BOIL|Cp|DENSITY|" .
   "En|M(ASS|ELT)) DsMASS DsZ Dy_(BOIL|Cp|DENSITY|En|M(ASS|ELT" .
   ")) DyMASS DyZ Er_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) ErMASS Er" .
   "Z Es_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) EsMASS EsZ ETHAN(E(_M" .
   "ASS|JP(KG(TOTAL)?|MOLE)|MASS)|OL(_MASS|DENSITY|JP(KG(TOTAL" .
   ")?|MOLE)|MASS)) Eu_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) EuMASS " .
   "EuZ F_BOIL F_Cp F_DENSITY F_En F_M(ASS|ELT) FAT(_MASS|DENS" .
   "ITY|JP(KG(TOTAL)?|MOLE)|MASS) Fe_(BOIL|Cp|DENSITY|En|M(ASS" .
   "|ELT)) FeMASS FeZ Fl_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) FlMAS" .
   "S FlZ Fm_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) FMASS FmMASS FmZ " .
   "Fr_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) FrMASS FrZ FZ Ga_(BOIL|" .
   "Cp|DENSITY|En|M(ASS|ELT)) GaMASS GASOLINE(_MASS|DENSITY|JP" .
   "(KG(TOTAL)?|MOLE)|MASS) GaZ Gd_(BOIL|Cp|DENSITY|En|M(ASS|E" .
   "LT)) GdMASS GdZ Ge_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) GeMASS " .
   "GeZ H1_MASS H1MASS H2_MASS H2MASS H3_MASS H3MASS H_BOIL H_" .
   "Cp H_DENSITY H_En H_M(ASS|ELT) He3(_MASS|MASS) He4(_MASS|M" .
   "ASS) He_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) HeMASS HeZ Hf_(BOI" .
   "L|Cp|DENSITY|En|M(ASS|ELT)) HfMASS HfZ Hg_(BOIL|Cp|DENSITY" .
   "|En|M(ASS|ELT)) HgMASS HgZ HMASS Ho_(BOIL|Cp|DENSITY|En|M(" .
   "ASS|ELT)) HoMASS HoZ Hs_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) Hs" .
   "MASS HsZ HYDROGEN(_MASS|JP(KG(TOTAL)?|MOLE)|MASS) HZ I_BOI" .
   "L I_Cp I_DENSITY I_En I_M(ASS|ELT) ICE_Cp IMASS In_(BOIL|C" .
   "p|DENSITY|En|M(ASS|ELT)) InMASS InZ Ir_(BOIL|Cp|DENSITY|En" .
   "|M(ASS|ELT)) IrMASS IrZ IZ K_BOIL K_Cp K_DENSITY K_En K_M(" .
   "ASS|ELT) KMASS Kr_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) KrMASS K" .
   "rZ KZ La_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) LaMASS LaZ Li_(BO" .
   "IL|Cp|DENSITY|En|M(ASS|ELT)) LiMASS LiZ Lr_(BOIL|Cp|DENSIT" .
   "Y|En|M(ASS|ELT)) LrMASS LrZ Lu_(BOIL|Cp|DENSITY|En|M(ASS|E" .
   "LT)) LuMASS LuZ Lv_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) LvMASS " .
   "LvZ Mc_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) McMASS McZ Md_(BOIL" .
   "|Cp|DENSITY|En|M(ASS|ELT)) MdMASS MdZ METHANE(_MASS|JP(KG(" .
   "TOTAL)?|MOLE)|MASS) Mg_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) MgM" .
   "ASS MgZ Mn_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) MnMASS MnZ Mo_(" .
   "BOIL|Cp|DENSITY|En|M(ASS|ELT)) MoMASS MoZ Mt_(BOIL|Cp|DENS" .
   "ITY|En|M(ASS|ELT)) MtMASS MtZ N_BOIL N_Cp N_DENSITY N_En N" .
   "_M(ASS|ELT) Na_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) NaMASS NaZ " .
   "Nb_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) NbMASS NbZ Nd_(BOIL|Cp|" .
   "DENSITY|En|M(ASS|ELT)) NdMASS NdZ Ne_(BOIL|Cp|DENSITY|En|M" .
   "(ASS|ELT)) NeMASS NeZ Nh_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) N" .
   "hMASS NhZ Ni_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) NiMASS NiZ NM" .
   "ASS No_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) NoMASS NoZ Np_(BOIL" .
   "|Cp|DENSITY|En|M(ASS|ELT)) NpMASS NpZ NZ O16(_MASS|MASS) O" .
   "17(_MASS|MASS) O18(_MASS|MASS) O_BOIL O_Cp O_DENSITY O_En " .
   "O_M(ASS|ELT) Og_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) OgMASS OgZ" .
   " OMASS Os_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) OsMASS OsZ OZ P_" .
   "BOIL P_Cp P_DENSITY P_En P_M(ASS|ELT) Pa_(BOIL|Cp|DENSITY|" .
   "En|M(ASS|ELT)) PaMASS PARAFFIN(_MASS|DENSITY|JP(KG(TOTAL)?" .
   "|MOLE)|MASS) PaZ Pb_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) PbMASS" .
   " PbZ Pd_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) PdMASS PdZ PENTANE" .
   "(_MASS|JP(KG(TOTAL)?|MOLE)|MASS) Pm_(BOIL|Cp|DENSITY|En|M(" .
   "ASS|ELT)) PMASS PmMASS PmZ Po_(BOIL|Cp|DENSITY|En|M(ASS|EL" .
   "T)) PoMASS PoZ Pr_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) PrMASS P" .
   "ROPANE(_MASS|JP(KG(TOTAL)?|MOLE)|MASS) PrZ Pt_(BOIL|Cp|DEN" .
   "SITY|En|M(ASS|ELT)) PtMASS PtZ Pu_(BOIL|Cp|DENSITY|En|M(AS" .
   "S|ELT)) PuMASS PuZ PZ Ra_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) R" .
   "aMASS RaZ Rb_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) RbMASS RbZ Re" .
   "_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) ReMASS ReZ Rf_(BOIL|Cp|DE" .
   "NSITY|En|M(ASS|ELT)) RfMASS RfZ Rg_(BOIL|Cp|DENSITY|En|M(A" .
   "SS|ELT)) RgMASS RgZ Rh_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) RhM" .
   "ASS RhZ Rn_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) RnMASS RnZ Ru_(" .
   "BOIL|Cp|DENSITY|En|M(ASS|ELT)) RuMASS RuZ S_BOIL S_Cp S_DE" .
   "NSITY S_En S_M(ASS|ELT) Sb_(BOIL|Cp|DENSITY|En|M(ASS|ELT))" .
   " SbMASS SbZ Sc_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) ScMASS ScZ " .
   "Se_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) SeMASS SeZ Sg_(BOIL|Cp|" .
   "DENSITY|En|M(ASS|ELT)) SgMASS SgZ Si_(BOIL|Cp|DENSITY|En|M" .
   "(ASS|ELT)) SiMASS SiZ Sm_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) S" .
   "MASS SmMASS SmZ Sn_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) SnMASS " .
   "SnZ Sr_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) SrMASS SrZ STEAM_Cp" .
   " SUCROSE(_MASS|JP(KG(TOTAL)?|MOLE)|MASS) SUGAR(_MASS|DENSI" .
   "TY|JP(KG(TOTAL)?|MOLE)|MASS) SZ Ta_(BOIL|Cp|DENSITY|En|M(A" .
   "SS|ELT)) TaMASS TaZ Tb_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) TbM" .
   "ASS TbZ Tc_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) TcMASS TcZ Te_(" .
   "BOIL|Cp|DENSITY|En|M(ASS|ELT)) TeMASS TeZ Th_(BOIL|Cp|DENS" .
   "ITY|En|M(ASS|ELT)) ThMASS ThZ Ti_(BOIL|Cp|DENSITY|En|M(ASS" .
   "|ELT)) TiMASS TiZ Tl_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) TlMAS" .
   "S TlZ Tm_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) TmMASS TmZ TNTJPK" .
   "G Ts_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) TsMASS TsZ U_BOIL U_C" .
   "p U_DENSITY U_En U_M(ASS|ELT) UMASS UZ V_BOIL V_Cp V_DENSI" .
   "TY V_En V_M(ASS|ELT) VMASS VSMOW_(H(1_RATIO|2_RATIO|3_RATI" .
   "O|_MASS)|MASS|O(1[678]_RATIO|_MASS)) VZ W_BOIL W_Cp W_DENS" .
   "ITY W_En W_M(ASS|ELT) WATER(_(Cp|FUSION|MASS|VAPORIZATION)" .
   "|MASS) WMASS WZ Xe_(BOIL|Cp|DENSITY|En|M(ASS|ELT)) XeMASS " .
   "XeZ Y_BOIL Y_Cp Y_DENSITY Y_En Y_M(ASS|ELT) Yb_(BOIL|Cp|DE" .
   "NSITY|En|M(ASS|ELT)) YbMASS YbZ YMASS YZ Zn_(BOIL|Cp|DENSI" .
   "TY|En|M(ASS|ELT)) ZnMASS ZnZ Zr_(BOIL|Cp|DENSITY|En|M(ASS|" .
   "ELT)) ZrMASS ZrZ" .
   "\n";
}
