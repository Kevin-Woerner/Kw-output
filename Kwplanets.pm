...
@EXPORT_OK = ( qw(
   ...
   CERESSURFACE CERESVOLUME CERESYEAR CERES_A CERES_B CERES_C
   ...
   EARTHSURFACE EARTHTHETA_0 EARTHTROPICALYEAR EARTHVOLUME
   EARTHYEAR EARTH_A EARTH_B EARTH_C ERISASCENDING
   ...
   ERISSURFACE ERISVOLUME ERISYEAR ERIS_A ERIS_B ERIS_C
   HAUMEAASCENDING HAUMEAASCENDING_DT HAUMEADAY HAUMEADENSITY
   HAUMEAECCENTRICITY HAUMEAECCENTRICITY_DT HAUMEAESCAPE
   HAUMEAFLATNESS HAUMEAGM HAUMEAGRAVITY HAUMEAINCLINATION
   HAUMEAINCLINATION_DT HAUMEALONGITUDE HAUMEALONGITUDE_DT
   HAUMEAMASS HAUMEAOBLATENESS HAUMEAORBIT HAUMEAORBIT_DT
   HAUMEAPERIAPSIS HAUMEAPERIAPSIS_DT HAUMEARADIUS HAUMEASURFACE
   ...
   JUPITERSURFACE JUPITERVOLUME JUPITERYEAR JUPITER_A JUPITER_B
   JUPITER_C MAKEMAKEASCENDING MAKEMAKEASCENDING_DT MAKEMAKEDAY
   ...
   MAKEMAKEVOLUME MAKEMAKEYEAR MAKEMAKE_A MAKEMAKE_B MAKEMAKE_C
   MARSASCENDING MARSASCENDING_DT MARSDAY MARSDENSITY
   MARSECCENTRICITY MARSECCENTRICITY_DT MARSESCAPE MARSFLATNESS
   MARSGM MARSGRAVITY MARSINCLINATION MARSINCLINATION_DT
   MARSLONGITUDE MARSLONGITUDE_DT MARSMASS MARSOBLATENESS
   MARSORBIT MARSORBIT_DT MARSPERIAPSIS MARSPERIAPSIS_DT
   MARSRADIUS MARSSURFACE MARSVOLUME MARSYEAR MARS_A MARS_B
   MARS_C MERCURYASCENDING MERCURYASCENDING_DT MERCURYDAY
   MERCURYDENSITY MERCURYECCENTRICITY MERCURYECCENTRICITY_DT
   MERCURYESCAPE MERCURYFLATNESS MERCURYGM MERCURYGRAVITY
   MERCURYINCLINATION MERCURYINCLINATION_DT MERCURYLONGITUDE
   MERCURYLONGITUDE_DT MERCURYMASS MERCURYOBLATENESS MERCURYORBIT
   MERCURYORBIT_DT MERCURYPERIAPSIS MERCURYPERIAPSIS_DT
   MERCURYRADIUS MERCURYSURFACE MERCURYVOLUME MERCURYYEAR
   ...
   MOONSURFACE MOONVOLUME MOONYEAR MOON_A MOON_B MOON_C
   ...
   NEPTUNESURFACE NEPTUNEVOLUME NEPTUNEYEAR NEPTUNE_A NEPTUNE_B
   NEPTUNE_C PLUTOASCENDING PLUTOASCENDING_DT PLUTODAY
   PLUTODENSITY PLUTOECCENTRICITY PLUTOECCENTRICITY_DT
   PLUTOESCAPE PLUTOFLATNESS PLUTOGM PLUTOGRAVITY
   PLUTOINCLINATION PLUTOINCLINATION_DT PLUTOLONGITUDE
   PLUTOLONGITUDE_DT PLUTOMASS PLUTOOBLATENESS PLUTOORBIT
   PLUTOORBIT_DT PLUTOPERIAPSIS PLUTOPERIAPSIS_DT PLUTORADIUS
   PLUTOSURFACE PLUTOVOLUME PLUTOYEAR PLUTO_A PLUTO_B PLUTO_C
   SATURNASCENDING SATURNASCENDING_DT SATURNDAY SATURNDENSITY
   SATURNECCENTRICITY SATURNECCENTRICITY_DT SATURNESCAPE
   SATURNFLATNESS SATURNGM SATURNGRAVITY SATURNINCLINATION
   SATURNINCLINATION_DT SATURNLONGITUDE SATURNLONGITUDE_DT
   SATURNMASS SATURNOBLATENESS SATURNORBIT SATURNORBIT_DT
   SATURNPERIAPSIS SATURNPERIAPSIS_DT SATURNRADIUS SATURNSURFACE
   ...
   URANUSRADIUS URANUSSURFACE URANUSVOLUME URANUSYEAR URANUS_A
   URANUS_B URANUS_C VENUSASCENDING VENUSASCENDING_DT VENUSDAY
   VENUSDENSITY VENUSECCENTRICITY VENUSECCENTRICITY_DT
   VENUSESCAPE VENUSFLATNESS VENUSGM VENUSGRAVITY
   VENUSINCLINATION VENUSINCLINATION_DT VENUSLONGITUDE
   VENUSLONGITUDE_DT VENUSMASS VENUSOBLATENESS VENUSORBIT
   VENUSORBIT_DT VENUSPERIAPSIS VENUSPERIAPSIS_DT VENUSRADIUS
   VENUSSURFACE VENUSVOLUME VENUSYEAR VENUS_A VENUS_B VENUS_C
   cxanomalisticyear cxceres_a cxceres_b cxceres_c
   cxceresascending cxceresascending_dt cxceresday cxceresdensity
   cxcereseccentricity cxcereseccentricity_dt cxceresescape
   cxceresflatness cxceresgm cxceresgravity cxceresinclination
   cxceresinclination_dt cxcereslongitude cxcereslongitude_dt
   cxceresmass cxceresoblateness cxceresorbit cxceresorbit_dt
   cxceresperiapsis cxceresperiapsis_dt cxceresradius
   cxceressurface cxceresvolume cxceresyear cxearth_a cxearth_b
   ...
   cxerissurface cxerisvolume cxerisyear cxhaumea_a cxhaumea_b
   cxhaumea_c cxhaumeaascending cxhaumeaascending_dt cxhaumeaday
   cxhaumeadensity cxhaumeaeccentricity cxhaumeaeccentricity_dt
   cxhaumeaescape cxhaumeaflatness cxhaumeagm cxhaumeagravity
   ...
   cxhaumeaperiapsis_dt cxhaumearadius cxhaumeasurface
   cxhaumeavolume cxhaumeayear cxjupiter_a cxjupiter_b
   cxjupiter_c cxjupiterascending cxjupiterascending_dt
   cxjupiterday cxjupiterdensity cxjupitereccentricity
   ...
   cxjupiterperiapsis_dt cxjupiterradius cxjupitersurface
   cxjupitervolume cxjupiteryear cxlc_isa_density
   cxlc_isa_pressure cxlc_isa_temperature cxlc_isa_xdensity
   cxlc_isa_xheight cxlc_isa_xlapserate cxlc_isa_xpressure
   cxlc_isa_xtemperature cxlc_p1_ceres cxlc_p1_count
   cxlc_p1_earth cxlc_p1_eris cxlc_p1_err cxlc_p1_haumea
   cxlc_p1_jupiter cxlc_p1_makemake cxlc_p1_mars cxlc_p1_mercury
   cxlc_p1_neptune cxlc_p1_pluto cxlc_p1_prev_pl cxlc_p1_saturn
   cxlc_p1_sun cxlc_p1_uranus cxlc_p1_venus cxlc_p2_a cxlc_p2_asc
   cxlc_p2_asc_dt cxlc_p2_c cxlc_p2_count cxlc_p2_day cxlc_p2_ecc
   cxlc_p2_ecc_dt cxlc_p2_flatness cxlc_p2_gm cxlc_p2_inc
   cxlc_p2_inc_dt cxlc_p2_lon cxlc_p2_lon_dt cxlc_p2_orb
   cxlc_p2_orb_dt cxlc_p2_per cxlc_p2_per_dt cxlc_p2_year
   cxlc_prem_density cxlc_prem_mass cxlc_prem_xcoea
   cxlc_prem_xcoeb cxlc_prem_xcoec cxlc_prem_xheight
   cxlc_prem_xmassd cxmakemake_a cxmakemake_b cxmakemake_c
   ...
   cxmakemakevolume cxmakemakeyear cxmars_a cxmars_b cxmars_c
   cxmarsascending cxmarsascending_dt cxmarsday cxmarsdensity
   cxmarseccentricity cxmarseccentricity_dt cxmarsescape
   cxmarsflatness cxmarsgm cxmarsgravity cxmarsinclination
   cxmarsinclination_dt cxmarslongitude cxmarslongitude_dt
   cxmarsmass cxmarsoblateness cxmarsorbit cxmarsorbit_dt
   cxmarsperiapsis cxmarsperiapsis_dt cxmarsradius cxmarssurface
   cxmarsvolume cxmarsyear cxmercury_a cxmercury_b cxmercury_c
   cxmercuryascending cxmercuryascending_dt cxmercuryday
   cxmercurydensity cxmercuryeccentricity
   ...
   cxmercuryperiapsis_dt cxmercuryradius cxmercurysurface
   cxmercuryvolume cxmercuryyear cxmoon_a cxmoon_b cxmoon_c
   cxmoonday cxmoondensity cxmooneccentricity cxmoonescape
   cxmoonflatness cxmoongm cxmoongravity cxmooninclination
   cxmoonmass cxmoonoblateness cxmoonorbit cxmoonradius
   cxmoonsurface cxmoonvolume cxmoonyear cxneptune_a cxneptune_b
   ...
   cxneptunevolume cxneptuneyear cxpluto_a cxpluto_b cxpluto_c
   cxplutoascending cxplutoascending_dt cxplutoday cxplutodensity
   ...
   cxplutosurface cxplutovolume cxplutoyear cxsaturn_a cxsaturn_b
   cxsaturn_c cxsaturnascending cxsaturnascending_dt cxsaturnday
   ...
   cxsaturnvolume cxsaturnyear cxsiderealday cxsiderealyear
   cxstellarday cxsun_a cxsun_b cxsun_c cxsunascending
   cxsunascending_dt cxsunday cxsundensity cxsuneccentricity
   cxsuneccentricity_dt cxsunescape cxsunflatness cxsungm
   cxsungmiers cxsungmnasa cxsungravity cxsuninclination
   cxsuninclination_dt cxsunlongitude cxsunlongitude_dt cxsunmass
   cxsunoblateness cxsunorbit cxsunorbit_dt cxsunperiapsis
   cxsunperiapsis_dt cxsunradius cxsunsurface cxsunvolume
   cxsunyear cxtropicalyear cxuranus_a cxuranus_b cxuranus_c
   cxuranusascending cxuranusascending_dt cxuranusday
   cxuranusdensity cxuranuseccentricity cxuranuseccentricity_dt
   cxuranusescape cxuranusflatness cxuranusgm cxuranusgravity
   cxuranusinclination cxuranusinclination_dt cxuranuslongitude
   cxuranuslongitude_dt cxuranusmass cxuranusoblateness
   cxuranusorbit cxuranusorbit_dt cxuranusperiapsis
   cxuranusperiapsis_dt cxuranusradius cxuranussurface
   ...
   cxvenussurface cxvenusvolume cxvenusyear earth_distance
   earth_gravity earth_gravity_height earth_obliquity
   earth_radius earth_tropicalyear eccentric_anomaly isa_dens
   isa_pres isa_temp margot pl pl_a pl_aphelion pl_aradius
   pl_argument pl_ascending pl_b pl_c pl_day pl_density
   pl_eccentricanomaly pl_eccentricity pl_escape pl_flatness
   pl_gm pl_gravity pl_heliocentric pl_inclination pl_longitude
   pl_margot pl_mass pl_meananomaly pl_name pl_orbit pl_periapsis
   pl_perihelion pl_radius pl_sternlevison pl_surface pl_synodic
   pl_volume pl_year pla plaphelion plaradius plargument
   plascending plb plc plday pldensity pleccentricanomaly
   pleccentricity plescape plflatness plgeo plgm plgravity
   plhelio plinclination pllongitude plmargot plmass
   plmeananomaly plname plorbit plperiapsis plperihelion plradius
   plsettime plsternlevison plsurface plsynodic plvolume plyear
   prem_density prem_g prem_mass sternlevison vin_destination
   vin_distance water_boiling
)); # End of EXPORT_OK
...
sub LC_PREM_DENSITY() { 0; }
   ...
   sub lf_prem($$ ) {
      ...
      if (not Kw::ismagic($lv_prem_magic)) {
         $lv_prem_mtrx[0][LC_PREM_XHEIGHT] = 0;
         $lv_prem_mtrx[0][LC_PREM_XCOEA] = 0;
         $lv_prem_mtrx[0][LC_PREM_XCOEB] = 0;
         $lv_prem_mtrx[0][LC_PREM_XCOEC] = 0;
         $lv_prem_mtrx[1][LC_PREM_XHEIGHT] = 1.2215E6;
         $lv_prem_mtrx[1][LC_PREM_XCOEA] = 1.3088E4;
         $lv_prem_mtrx[1][LC_PREM_XCOEB] = 1.9110E-8;
         $lv_prem_mtrx[1][LC_PREM_XCOEC] = -2.1773E-10;
         $lv_prem_mtrx[2][LC_PREM_XHEIGHT] = 3.4800E6;
         $lv_prem_mtrx[2][LC_PREM_XCOEA] = 1.2346E4;
         $lv_prem_mtrx[2][LC_PREM_XCOEB] = 1.3976E-4;
         $lv_prem_mtrx[2][LC_PREM_XCOEC] = -2.4123E-10;
         $lv_prem_mtrx[3][LC_PREM_XHEIGHT] = 3.6300E6;
         $lv_prem_mtrx[3][LC_PREM_XCOEA] = 7.3067E3;
         $lv_prem_mtrx[3][LC_PREM_XCOEB] = -5.0007E-4;
         $lv_prem_mtrx[3][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[4][LC_PREM_XHEIGHT] = 5.7010E6;
         $lv_prem_mtrx[4][LC_PREM_XCOEA] = 6.7823E3;
         $lv_prem_mtrx[4][LC_PREM_XCOEB] = -2.4441E-4;
         $lv_prem_mtrx[4][LC_PREM_XCOEC] = -3.0922E-11;
         $lv_prem_mtrx[5][LC_PREM_XHEIGHT] = 5.7710E6;
         $lv_prem_mtrx[5][LC_PREM_XCOEA] = 5.3197E3;
         $lv_prem_mtrx[5][LC_PREM_XCOEB] = -2.3286E-4;
         $lv_prem_mtrx[5][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[6][LC_PREM_XHEIGHT] = 5.9710E6;
         $lv_prem_mtrx[6][LC_PREM_XCOEA] = 1.1249E4;
         $lv_prem_mtrx[6][LC_PREM_XCOEB] = -1.2603E-3;
         $lv_prem_mtrx[6][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[7][LC_PREM_XHEIGHT] = 6.1510E6;
         $lv_prem_mtrx[7][LC_PREM_XCOEA] = 7.1083E3;
         $lv_prem_mtrx[7][LC_PREM_XCOEB] = -5.9706E-4;
         $lv_prem_mtrx[7][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[8][LC_PREM_XHEIGHT] = 6.3466E6;
         $lv_prem_mtrx[8][LC_PREM_XCOEA] = 2.6910E3;
         $lv_prem_mtrx[8][LC_PREM_XCOEB] = 1.0869E-4;
         $lv_prem_mtrx[8][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[9][LC_PREM_XHEIGHT] = 6.3560E6;
         $lv_prem_mtrx[9][LC_PREM_XCOEA] = 2.9000E3;
         $lv_prem_mtrx[9][LC_PREM_XCOEB] = 0.0;
         $lv_prem_mtrx[9][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[10][LC_PREM_XHEIGHT] = 6.3680E6;
         $lv_prem_mtrx[10][LC_PREM_XCOEA] = 2.6000E3;
         $lv_prem_mtrx[10][LC_PREM_XCOEB] = 0.0;
         $lv_prem_mtrx[10][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[11][LC_PREM_XHEIGHT] = 6.3710E6;
         $lv_prem_mtrx[11][LC_PREM_XCOEA] = 1.0200E3;
         $lv_prem_mtrx[11][LC_PREM_XCOEB] = 0.0;
         $lv_prem_mtrx[11][LC_PREM_XCOEC] = 0.0;
         $lv_prem_mtrx[0][LC_PREM_XMASSD] = 0;
         $mass_i = 0;
         for ($ii = 1; $ii <= 11; $ii += 1) {
...
sub water_boiling($ ) {
   ...
   if ($pressure_pa <= 0) {
      ...
      $retvalu = 1.0 / (1.0 / 373.15 - log($pressure_pa /
            Kw::ATM) * Kw::GAS /
            Kwelements::WATER_VAPORIZATION_JPMOLE);
   }
   return ($retvalu);
}
...
sub kwplanets_description() {
   ...
   "RIAPSIS_DT CERESRADIUS CERESSURFACE CERESVOLUME CERESYEAR " .
   "EARTH_A EARTH_B EARTH_C EARTHANOMALISTICYEAR EARTHASCENDIN" .
   "G EARTHASCENDING_DT EARTHDAY EARTHDENSITY EARTHECCENTRICIT" .
   "Y EARTHECCENTRICITY_DT EARTHESCAPE EARTHFLATNESS EARTHGM E" .
   "ARTHGRAVITY EARTHINCLINATION EARTHINCLINATION_DT EARTHLONG" .
   "ITUDE EARTHLONGITUDE_DT EARTHMASS EARTHOBLATENESS EARTHORB" .
   "IT EARTHORBIT_DT EARTHPERIAPSIS EARTHPERIAPSIS_DT EARTHPRE" .
   "CESSION EARTHRADIUS EARTHSIDEREALDAY EARTHSIDEREALYEAR EAR" .
   "THSTELLARDAY EARTHSURFACE EARTHTHETA_0 EARTHTROPICALYEAR E" .
   "ARTHVOLUME EARTHYEAR ERIS_A ERIS_B ERIS_C ERISASCENDING ER" .
   "ISASCENDING_DT ERISDAY ERISDENSITY ERISECCENTRICITY ERISEC" .
   "CENTRICITY_DT ERISESCAPE ERISFLATNESS ERISGM ERISGRAVITY E" .
   "RISINCLINATION ERISINCLINATION_DT ERISLONGITUDE ERISLONGIT" .
   "UDE_DT ERISMASS ERISOBLATENESS ERISORBIT ERISORBIT_DT ERIS" .
   "PERIAPSIS ERISPERIAPSIS_DT ERISRADIUS ERISSURFACE ERISVOLU" .
   "ME ERISYEAR HAUMEA_A HAUMEA_B HAUMEA_C HAUMEAASCENDING HAU" .
   "MEAASCENDING_DT HAUMEADAY HAUMEADENSITY HAUMEAECCENTRICITY" .
   " HAUMEAECCENTRICITY_DT HAUMEAESCAPE HAUMEAFLATNESS HAUMEAG" .
   "M HAUMEAGRAVITY HAUMEAINCLINATION HAUMEAINCLINATION_DT HAU" .
   "MEALONGITUDE HAUMEALONGITUDE_DT HAUMEAMASS HAUMEAOBLATENES" .
   "S HAUMEAORBIT HAUMEAORBIT_DT HAUMEAPERIAPSIS HAUMEAPERIAPS" .
   "IS_DT HAUMEARADIUS HAUMEASURFACE HAUMEAVOLUME HAUMEAYEAR J" .
   "UPITER_A JUPITER_B JUPITER_C JUPITERASCENDING JUPITERASCEN" .
   "DING_DT JUPITERDAY JUPITERDENSITY JUPITERECCENTRICITY JUPI" .
   "TERECCENTRICITY_DT JUPITERESCAPE JUPITERFLATNESS JUPITERGM" .
   " JUPITERGRAVITY JUPITERINCLINATION JUPITERINCLINATION_DT J" .
   "UPITERLONGITUDE JUPITERLONGITUDE_DT JUPITERMASS JUPITEROBL" .
   "ATENESS JUPITERORBIT JUPITERORBIT_DT JUPITERPERIAPSIS JUPI" .
   "TERPERIAPSIS_DT JUPITERRADIUS JUPITERSURFACE JUPITERVOLUME" .
   " JUPITERYEAR LC_ISA_DENSITY LC_ISA_PRESSURE LC_ISA_TEMPERA" .
   "TURE LC_ISA_XDENSITY LC_ISA_XHEIGHT LC_ISA_XLAPSERATE LC_I" .
   "SA_XPRESSURE LC_ISA_XTEMPERATURE LC_P1_CERES LC_P1_COUNT L" .
   "C_P1_EARTH LC_P1_ERIS LC_P1_ERR LC_P1_HAUMEA LC_P1_JUPITER" .
   " LC_P1_MAKEMAKE LC_P1_MARS LC_P1_MERCURY LC_P1_NEPTUNE LC_" .
   "P1_PLUTO LC_P1_PREV_PL LC_P1_SATURN LC_P1_SUN LC_P1_URANUS" .
   " LC_P1_VENUS LC_P2_A LC_P2_ASC LC_P2_ASC_DT LC_P2_C LC_P2_" .
   "COUNT LC_P2_DAY LC_P2_ECC LC_P2_ECC_DT LC_P2_FLATNESS LC_P" .
   "2_GM LC_P2_INC LC_P2_INC_DT LC_P2_LON LC_P2_LON_DT LC_P2_O" .
   "RB LC_P2_ORB_DT LC_P2_PER LC_P2_PER_DT LC_P2_YEAR LC_PREM_" .
   "DENSITY LC_PREM_MASS LC_PREM_XCOEA LC_PREM_XCOEB LC_PREM_X" .
   "COEC LC_PREM_XHEIGHT LC_PREM_XMASSD MAKEMAKE_A MAKEMAKE_B " .
   "MAKEMAKE_C MAKEMAKEASCENDING MAKEMAKEASCENDING_DT MAKEMAKE" .
   "DAY MAKEMAKEDENSITY MAKEMAKEECCENTRICITY MAKEMAKEECCENTRIC" .
   "ITY_DT MAKEMAKEESCAPE MAKEMAKEFLATNESS MAKEMAKEGM MAKEMAKE" .
   "GRAVITY MAKEMAKEINCLINATION MAKEMAKEINCLINATION_DT MAKEMAK" .
   "ELONGITUDE MAKEMAKELONGITUDE_DT MAKEMAKEMASS MAKEMAKEOBLAT" .
   "ENESS MAKEMAKEORBIT MAKEMAKEORBIT_DT MAKEMAKEPERIAPSIS MAK" .
   "EMAKEPERIAPSIS_DT MAKEMAKERADIUS MAKEMAKESURFACE MAKEMAKEV" .
   "OLUME MAKEMAKEYEAR MARS_A MARS_B MARS_C MARSASCENDING MARS" .
   "ASCENDING_DT MARSDAY MARSDENSITY MARSECCENTRICITY MARSECCE" .
   "NTRICITY_DT MARSESCAPE MARSFLATNESS MARSGM MARSGRAVITY MAR" .
   "SINCLINATION MARSINCLINATION_DT MARSLONGITUDE MARSLONGITUD" .
   "E_DT MARSMASS MARSOBLATENESS MARSORBIT MARSORBIT_DT MARSPE" .
   "RIAPSIS MARSPERIAPSIS_DT MARSRADIUS MARSSURFACE MARSVOLUME" .
   " MARSYEAR MERCURY_A MERCURY_B MERCURY_C MERCURYASCENDING M" .
   "ERCURYASCENDING_DT MERCURYDAY MERCURYDENSITY MERCURYECCENT" .
   "RICITY MERCURYECCENTRICITY_DT MERCURYESCAPE MERCURYFLATNES" .
   "S MERCURYGM MERCURYGRAVITY MERCURYINCLINATION MERCURYINCLI" .
   "NATION_DT MERCURYLONGITUDE MERCURYLONGITUDE_DT MERCURYMASS" .
   " MERCURYOBLATENESS MERCURYORBIT MERCURYORBIT_DT MERCURYPER" .
   "IAPSIS MERCURYPERIAPSIS_DT MERCURYRADIUS MERCURYSURFACE ME" .
   "RCURYVOLUME MERCURYYEAR MOON_A MOON_B MOON_C MOONDAY MOOND" .
   "ENSITY MOONECCENTRICITY MOONESCAPE MOONFLATNESS MOONGM MOO" .
   "NGRAVITY MOONINCLINATION MOONMASS MOONOBLATENESS MOONORBIT" .
   " MOONRADIUS MOONSURFACE MOONVOLUME MOONYEAR NEPTUNE_A NEPT" .
   "UNE_B NEPTUNE_C NEPTUNEASCENDING NEPTUNEASCENDING_DT NEPTU" .
   "NEDAY NEPTUNEDENSITY NEPTUNEECCENTRICITY NEPTUNEECCENTRICI" .
   "TY_DT NEPTUNEESCAPE NEPTUNEFLATNESS NEPTUNEGM NEPTUNEGRAVI" .
   "TY NEPTUNEINCLINATION NEPTUNEINCLINATION_DT NEPTUNELONGITU" .
   "DE NEPTUNELONGITUDE_DT NEPTUNEMASS NEPTUNEOBLATENESS NEPTU" .
   "NEORBIT NEPTUNEORBIT_DT NEPTUNEPERIAPSIS NEPTUNEPERIAPSIS_" .
   "DT NEPTUNERADIUS NEPTUNESURFACE NEPTUNEVOLUME NEPTUNEYEAR " .
   "PLUTO_A PLUTO_B PLUTO_C PLUTOASCENDING PLUTOASCENDING_DT P" .
   "LUTODAY PLUTODENSITY PLUTOECCENTRICITY PLUTOECCENTRICITY_D" .
   "T PLUTOESCAPE PLUTOFLATNESS PLUTOGM PLUTOGRAVITY PLUTOINCL" .
   "INATION PLUTOINCLINATION_DT PLUTOLONGITUDE PLUTOLONGITUDE_" .
   "DT PLUTOMASS PLUTOOBLATENESS PLUTOORBIT PLUTOORBIT_DT PLUT" .
   "OPERIAPSIS PLUTOPERIAPSIS_DT PLUTORADIUS PLUTOSURFACE PLUT" .
   "OVOLUME PLUTOYEAR SATURN_A SATURN_B SATURN_C SATURNASCENDI" .
   "NG SATURNASCENDING_DT SATURNDAY SATURNDENSITY SATURNECCENT" .
   "RICITY SATURNECCENTRICITY_DT SATURNESCAPE SATURNFLATNESS S" .
   "ATURNGM SATURNGRAVITY SATURNINCLINATION SATURNINCLINATION_" .
   "DT SATURNLONGITUDE SATURNLONGITUDE_DT SATURNMASS SATURNOBL" .
   "ATENESS SATURNORBIT SATURNORBIT_DT SATURNPERIAPSIS SATURNP" .
   "ERIAPSIS_DT SATURNRADIUS SATURNSURFACE SATURNVOLUME SATURN" .
   "YEAR SIDEREALDAY SIDEREALYEAR STELLARDAY SUN_A SUN_B SUN_C" .
   " SUNASCENDING SUNASCENDING_DT SUNDAY SUNDENSITY SUNECCENTR" .
   "ICITY SUNECCENTRICITY_DT SUNESCAPE SUNFLATNESS SUNGM SUNGM" .
   "IERS SUNGMNASA SUNGRAVITY SUNINCLINATION SUNINCLINATION_DT" .
   " SUNLONGITUDE SUNLONGITUDE_DT SUNMASS SUNOBLATENESS SUNORB" .
   "IT SUNORBIT_DT SUNPERIAPSIS SUNPERIAPSIS_DT SUNRADIUS SUNS" .
   "URFACE SUNVOLUME SUNYEAR TROPICALYEAR URANUS_A URANUS_B UR" .
   "ANUS_C URANUSASCENDING URANUSASCENDING_DT URANUSDAY URANUS" .
   "DENSITY URANUSECCENTRICITY URANUSECCENTRICITY_DT URANUSESC" .
   "APE URANUSFLATNESS URANUSGM URANUSGRAVITY URANUSINCLINATIO" .
   "N URANUSINCLINATION_DT URANUSLONGITUDE URANUSLONGITUDE_DT " .
   "URANUSMASS URANUSOBLATENESS URANUSORBIT URANUSORBIT_DT URA" .
   "NUSPERIAPSIS URANUSPERIAPSIS_DT URANUSRADIUS URANUSSURFACE" .
   " URANUSVOLUME URANUSYEAR VENUS_A VENUS_B VENUS_C VENUSASCE" .
   "NDING VENUSASCENDING_DT VENUSDAY VENUSDENSITY VENUSECCENTR" .
   "ICITY VENUSECCENTRICITY_DT VENUSESCAPE VENUSFLATNESS VENUS" .
   "GM VENUSGRAVITY VENUSINCLINATION VENUSINCLINATION_DT VENUS" .
   "LONGITUDE VENUSLONGITUDE_DT VENUSMASS VENUSOBLATENESS VENU" .
   "SORBIT VENUSORBIT_DT VENUSPERIAPSIS VENUSPERIAPSIS_DT VENU" .
   "SRADIUS VENUSSURFACE VENUSVOLUME VENUSYEAR" .
   "\n" .
   ...
   "settime prem_density prem_g prem_mass water_boiling" .
   "\n" .
...
sub kwplanets_desc() {
   ...
   "TENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|Y" .
   "EAR) EARTH(_[ABC]|A(NOMALISTICYEAR|SCENDING(_DT)?)|D(AY|EN" .
   "SITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCL" .
   "INATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)" .
   "|P(ERIAPSIS(_DT)?|RECESSION)|RADIUS|S(IDEREAL(DAY|YEAR)|TE" .
   "LLARDAY|URFACE)|T(HETA_0|ROPICALYEAR)|VOLUME|YEAR) ERIS(_[" .
   "ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAP" .
   "E)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|" .
   "MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFAC" .
   "E|VOLUME|YEAR) HAUMEA(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|" .
   "E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATIO" .
   "N(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIA" .
   "PSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) JUPITER(_[ABC]|ASCE" .
   "NDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNE" .
   "SS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BL" .
   "ATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|" .
   "YEAR) LC_(ISA_(DENSITY|PRESSURE|TEMPERATURE|X(DENSITY|HEIG" .
   "HT|LAPSERATE|PRESSURE|TEMPERATURE))|P(1_(C(ERES|OUNT)|E(AR" .
   "TH|R(IS|R))|HAUMEA|JUPITER|M(A(KEMAKE|RS)|ERCURY)|NEPTUNE|" .
   "P(LUTO|REV_PL)|S(ATURN|UN)|URANUS|VENUS)|2_(A(SC(_DT)?)?|C" .
   "(OUNT)?|DAY|ECC(_DT)?|FLATNESS|GM|INC(_DT)?|LON(_DT)?|ORB(" .
   "_DT)?|PER(_DT)?|YEAR)|REM_(DENSITY|MASS|X(COE[ABC]|HEIGHT|" .
   "MASSD)))) MAKEMAKE(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(C" .
   "CENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_" .
   "DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSI" .
   "S(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) MARS(_[ABC]|ASCENDING(" .
   "_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M" .
   "|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENES" .
   "S|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) " .
   "MERCURY(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(" .
   "_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGIT" .
   "UDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RAD" .
   "IUS|SURFACE|VOLUME|YEAR) MOON(_[ABC]|D(AY|ENSITY)|E(CCENTR" .
   "ICITY|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION|MASS|O(BLATE" .
   "NESS|RBIT)|RADIUS|SURFACE|VOLUME|YEAR) NEPTUNE(_[ABC]|ASCE" .
   "NDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNE" .
   "SS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BL" .
   "ATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|" .
   "YEAR) PLUTO(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRIC" .
   "ITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LO" .
   "NGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?" .
   "|RADIUS|SURFACE|VOLUME|YEAR) SATURN(_[ABC]|ASCENDING(_DT)?" .
   "|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVI" .
   "TY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBI" .
   "T(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) SIDER" .
   "EAL(DAY|YEAR) STELLARDAY SUN(_[ABC]|ASCENDING(_DT)?|D(AY|E" .
   "NSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M(IERS|NASA)?" .
   "|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENES" .
   "S|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) " .
   "TROPICALYEAR URANUS(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(" .
   "CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(" .
   "_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPS" .
   "IS(_DT)?|RADIUS|SURFACE|VOLUME|YEAR) VENUS(_[ABC]|ASCENDIN" .
   "G(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G" .
   "(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATEN" .
   ...
   "lio plsettime prem_(density|g|mass) water_boiling" .
   "\n" .
   "   Kwplanets 2-ary Functions: earth_gravity_height eccentr" .
