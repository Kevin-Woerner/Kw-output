...
@EXPORT_OK = ( qw(
   ...
   cxlc_p2_per cxlc_p2_per_dt cxlc_p2_year cxmakemake_a
   cxmakemake_b cxmakemake_c cxmakemakeascending
   cxmakemakeascending_dt cxmakemakeday cxmakemakedensity
   cxmakemakeeccentricity cxmakemakeeccentricity_dt
   cxmakemakeescape cxmakemakeflatness cxmakemakegm
   cxmakemakegravity cxmakemakeinclination
...
sub kwplanets_description() {
   ...
   "EAR LC_ISA_DENSITY LC_ISA_PRESSURE LC_ISA_TEMPERATURE LC_I" .
   "SA_XDENSITY LC_ISA_XHEIGHT LC_ISA_XLAPSERATE LC_ISA_XPRESS" .
   "URE LC_ISA_XTEMPERATURE LC_P1_CERES LC_P1_COUNT LC_P1_EART" .
   "H LC_P1_ERIS LC_P1_ERR LC_P1_HAUMEA LC_P1_JUPITER LC_P1_MA" .
   "KEMAKE LC_P1_MARS LC_P1_MERCURY LC_P1_NEPTUNE LC_P1_PLUTO " .
   "LC_P1_PREV_PL LC_P1_SATURN LC_P1_SUN LC_P1_URANUS LC_P1_VE" .
   "NUS LC_P2_A LC_P2_ASC LC_P2_ASC_DT LC_P2_C LC_P2_COUNT LC_" .
   "P2_DAY LC_P2_ECC LC_P2_ECC_DT LC_P2_FLATNESS LC_P2_GM LC_P" .
   "2_INC LC_P2_INC_DT LC_P2_LON LC_P2_LON_DT LC_P2_ORB LC_P2_" .
   "ORB_DT LC_P2_PER LC_P2_PER_DT LC_P2_YEAR MAKEMAKE_A MAKEMA" .
   "KE_B MAKEMAKE_C MAKEMAKEASCENDING MAKEMAKEASCENDING_DT MAK" .
   "EMAKEDAY MAKEMAKEDENSITY MAKEMAKEECCENTRICITY MAKEMAKEECCE" .
   "NTRICITY_DT MAKEMAKEESCAPE MAKEMAKEFLATNESS MAKEMAKEGM MAK" .
   "EMAKEGRAVITY MAKEMAKEINCLINATION MAKEMAKEINCLINATION_DT MA" .
   "KEMAKELONGITUDE MAKEMAKELONGITUDE_DT MAKEMAKEMASS MAKEMAKE" .
   "OBLATENESS MAKEMAKEORBIT MAKEMAKEORBIT_DT MAKEMAKEPERIAPSI" .
   "S MAKEMAKEPERIAPSIS_DT MAKEMAKERADIUS MAKEMAKEVOLUME MAKEM" .
   "AKEYEAR MARS_A MARS_B MARS_C MARSASCENDING MARSASCENDING_D" .
   "T MARSDAY MARSDENSITY MARSECCENTRICITY MARSECCENTRICITY_DT" .
   " MARSESCAPE MARSFLATNESS MARSGM MARSGRAVITY MARSINCLINATIO" .
   "N MARSINCLINATION_DT MARSLONGITUDE MARSLONGITUDE_DT MARSMA" .
   "SS MARSOBLATENESS MARSORBIT MARSORBIT_DT MARSPERIAPSIS MAR" .
   "SPERIAPSIS_DT MARSRADIUS MARSVOLUME MARSYEAR MERCURY_A MER" .
   "CURY_B MERCURY_C MERCURYASCENDING MERCURYASCENDING_DT MERC" .
   "URYDAY MERCURYDENSITY MERCURYECCENTRICITY MERCURYECCENTRIC" .
   "ITY_DT MERCURYESCAPE MERCURYFLATNESS MERCURYGM MERCURYGRAV" .
   "ITY MERCURYINCLINATION MERCURYINCLINATION_DT MERCURYLONGIT" .
   "UDE MERCURYLONGITUDE_DT MERCURYMASS MERCURYOBLATENESS MERC" .
   "URYORBIT MERCURYORBIT_DT MERCURYPERIAPSIS MERCURYPERIAPSIS" .
   "_DT MERCURYRADIUS MERCURYVOLUME MERCURYYEAR MOON_A MOON_B " .
   "MOON_C MOONDAY MOONDENSITY MOONECCENTRICITY MOONESCAPE MOO" .
   "NFLATNESS MOONGM MOONGRAVITY MOONINCLINATION MOONMASS MOON" .
   "OBLATENESS MOONORBIT MOONRADIUS MOONVOLUME MOONYEAR NEPTUN" .
   "E_A NEPTUNE_B NEPTUNE_C NEPTUNEASCENDING NEPTUNEASCENDING_" .
   "DT NEPTUNEDAY NEPTUNEDENSITY NEPTUNEECCENTRICITY NEPTUNEEC" .
   "CENTRICITY_DT NEPTUNEESCAPE NEPTUNEFLATNESS NEPTUNEGM NEPT" .
   "UNEGRAVITY NEPTUNEINCLINATION NEPTUNEINCLINATION_DT NEPTUN" .
   "ELONGITUDE NEPTUNELONGITUDE_DT NEPTUNEMASS NEPTUNEOBLATENE" .
   "SS NEPTUNEORBIT NEPTUNEORBIT_DT NEPTUNEPERIAPSIS NEPTUNEPE" .
   "RIAPSIS_DT NEPTUNERADIUS NEPTUNEVOLUME NEPTUNEYEAR PLUTO_A" .
   " PLUTO_B PLUTO_C PLUTOASCENDING PLUTOASCENDING_DT PLUTODAY" .
   " PLUTODENSITY PLUTOECCENTRICITY PLUTOECCENTRICITY_DT PLUTO" .
   "ESCAPE PLUTOFLATNESS PLUTOGM PLUTOGRAVITY PLUTOINCLINATION" .
   " PLUTOINCLINATION_DT PLUTOLONGITUDE PLUTOLONGITUDE_DT PLUT" .
   "OMASS PLUTOOBLATENESS PLUTOORBIT PLUTOORBIT_DT PLUTOPERIAP" .
   "SIS PLUTOPERIAPSIS_DT PLUTORADIUS PLUTOVOLUME PLUTOYEAR SA" .
   "TURN_A SATURN_B SATURN_C SATURNASCENDING SATURNASCENDING_D" .
   "T SATURNDAY SATURNDENSITY SATURNECCENTRICITY SATURNECCENTR" .
   "ICITY_DT SATURNESCAPE SATURNFLATNESS SATURNGM SATURNGRAVIT" .
   "Y SATURNINCLINATION SATURNINCLINATION_DT SATURNLONGITUDE S" .
   "ATURNLONGITUDE_DT SATURNMASS SATURNOBLATENESS SATURNORBIT " .
   "SATURNORBIT_DT SATURNPERIAPSIS SATURNPERIAPSIS_DT SATURNRA" .
   "DIUS SATURNVOLUME SATURNYEAR SIDEREALDAY SIDEREALYEAR STEL" .
   "LARDAY SUN_A SUN_B SUN_C SUNASCENDING SUNASCENDING_DT SUND" .
   "AY SUNDENSITY SUNECCENTRICITY SUNECCENTRICITY_DT SUNESCAPE" .
   " SUNFLATNESS SUNGM SUNGMIERS SUNGMNASA SUNGRAVITY SUNINCLI" .
   "NATION SUNINCLINATION_DT SUNLONGITUDE SUNLONGITUDE_DT SUNM" .
   "ASS SUNOBLATENESS SUNORBIT SUNORBIT_DT SUNPERIAPSIS SUNPER" .
   "IAPSIS_DT SUNRADIUS SUNVOLUME SUNYEAR TROPICALYEAR URANUS_" .
   "A URANUS_B URANUS_C URANUSASCENDING URANUSASCENDING_DT URA" .
   "NUSDAY URANUSDENSITY URANUSECCENTRICITY URANUSECCENTRICITY" .
   "_DT URANUSESCAPE URANUSFLATNESS URANUSGM URANUSGRAVITY URA" .
   "NUSINCLINATION URANUSINCLINATION_DT URANUSLONGITUDE URANUS" .
   "LONGITUDE_DT URANUSMASS URANUSOBLATENESS URANUSORBIT URANU" .
   "SORBIT_DT URANUSPERIAPSIS URANUSPERIAPSIS_DT URANUSRADIUS " .
   "URANUSVOLUME URANUSYEAR VENUS_A VENUS_B VENUS_C VENUSASCEN" .
   "DING VENUSASCENDING_DT VENUSDAY VENUSDENSITY VENUSECCENTRI" .
   "CITY VENUSECCENTRICITY_DT VENUSESCAPE VENUSFLATNESS VENUSG" .
   "M VENUSGRAVITY VENUSINCLINATION VENUSINCLINATION_DT VENUSL" .
   "ONGITUDE VENUSLONGITUDE_DT VENUSMASS VENUSOBLATENESS VENUS" .
   "ORBIT VENUSORBIT_DT VENUSPERIAPSIS VENUSPERIAPSIS_DT VENUS" .
   "RADIUS VENUSVOLUME VENUSYEAR" .
   "\n" .
...
sub kwplanets_desc() {
   ...
   "DT)?|RADIUS|VOLUME|YEAR) LC_(ISA_(DENSITY|PRESSURE|TEMPERA" .
   "TURE|X(DENSITY|HEIGHT|LAPSERATE|PRESSURE|TEMPERATURE))|P(1" .
   "_(C(ERES|OUNT)|E(ARTH|R(IS|R))|HAUMEA|JUPITER|M(A(KEMAKE|R" .
   "S)|ERCURY)|NEPTUNE|P(LUTO|REV_PL)|S(ATURN|UN)|URANUS|VENUS" .
   ")|2_(A(SC(_DT)?)?|C(OUNT)?|DAY|ECC(_DT)?|FLATNESS|GM|INC(_" .
   "DT)?|LON(_DT)?|ORB(_DT)?|PER(_DT)?|YEAR))) MAKEMAKE(_[ABC]" .
   "|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|F" .
   "LATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS" .
   "|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEA" .
   "R) MARS(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(" .
   "_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGIT" .
   "UDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RAD" .
   "IUS|VOLUME|YEAR) MERCURY(_[ABC]|ASCENDING(_DT)?|D(AY|ENSIT" .
   "Y)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINA" .
   "TION(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PE" .
   "RIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) MOON(_[ABC]|D(AY|ENSITY)" .
   "|E(CCENTRICITY|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION|MAS" .
   "S|O(BLATENESS|RBIT)|RADIUS|VOLUME|YEAR) NEPTUNE(_[ABC]|ASC" .
   "ENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATN" .
   "ESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(B" .
   "LATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) P" .
   "LUTO(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT" .
   ")?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE" .
   "(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS" .
   "|VOLUME|YEAR) SATURN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E" .
   "(CCENTRICITY(_DT)?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION" .
   "(_DT)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAP" .
   "SIS(_DT)?|RADIUS|VOLUME|YEAR) SIDEREAL(DAY|YEAR) STELLARDA" .
   "Y SUN(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_D" .
   "T)?|SCAPE)|FLATNESS|G(M(IERS|NASA)?|RAVITY)|INCLINATION(_D" .
   "T)?|LONGITUDE(_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS" .
   "(_DT)?|RADIUS|VOLUME|YEAR) TROPICALYEAR URANUS(_[ABC]|ASCE" .
   "NDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)?|SCAPE)|FLATNE" .
   "SS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(_DT)?|MASS|O(BL" .
   "ATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|VOLUME|YEAR) VE" .
   "NUS(_[ABC]|ASCENDING(_DT)?|D(AY|ENSITY)|E(CCENTRICITY(_DT)" .
   "?|SCAPE)|FLATNESS|G(M|RAVITY)|INCLINATION(_DT)?|LONGITUDE(" .
   "_DT)?|MASS|O(BLATENESS|RBIT(_DT)?)|PERIAPSIS(_DT)?|RADIUS|" .
   "VOLUME|YEAR)" .
   "\n" .
