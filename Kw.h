...
#define Kw_DESCRIPTION \
   ...
   " HECTO HELION_MASS HELIONMASS HELIONMASS_ERR HENRY HERTZ HF"\
   "ENERGY HFHz HFWAVELENGTH HFWAVENUMBER HI HI_ERR HIENERGY HI"\
   "Hz HIWAVELENGTH HIWAVENUMBER HORSEPOWER HOUR HP HPMETRIC HU"\
   "BBLE HUBBLE_ERR HXENERGY HXHz HXWAVELENGTH HXWAVENUMBER HYD"\
   "ROGENLINE HYDROGENLINE_ERR HYDROGENRADIUS HYDROGENRADIUS_ER"\
   "R INCH INDUCTANCE INHG INTMAX J2K J2KDAY JC JCENTURY JD JDA"\
   "Y JDSEC_AT_0GREGORIAN JDSEC_AT_0J2K JDSEC_AT_0KWT JDSEC_AT_"\
   "0UET JEWISH_FIRST_MONTH JM JMILLENNIUM JOSEPHSON JOSEPHSON_"\
   "ERR JOULE JULIANCENTURY JULIANDAY JULIANMILLENNIUM JULIANYE"\
   "AR JY JYEAR K_AT_0TEMPC K_AT_0TEMPF K_AT_0TEMPR kB kB_ERR k"\
   "B_REC KCD KCD_ERR KELVIN KG KGENERGY KGF KGHz KGWAVELENGTH "\
   "KGWAVENUMBER KIBI KILO KILOGRAM KPGBOUNDARY KWT LB LBF LC_C"\
   "IRCLE_RADIUS LC_CIRCLE_X LC_CIRCLE_Y LC_EPS LC_GD_COUNT LC_"\
   "GD_DAY LC_GD_DOW LC_GD_HOUR LC_GD_JD LC_GD_MIN LC_GD_MONTH "\
   "LC_GD_NUM LC_GD_SEC LC_GD_YEAR LC_KNUTH_ARRAY_COUNT LC_KNUT"\
   "H_KK_COUNT LC_KNUTH_LL LC_KNUTH_MAX LC_KNUTH_QUALITY_COUNT "\
   "LC_KNUTH_TT LC_MAGIC_INT LC_MAGIC_INT_NOT LC_MAX_FACTORS LC"\
   "_PARABOLA_COEFF_A LC_PARABOLA_COEFF_B LC_PARABOLA_COEFF_C L"\
   "C_PARABOLA_REAL_ROOTS LC_PARABOLA_ROOT_A LC_PARABOLA_ROOT_B"\
   " LC_PARABOLA_X_AXIS LC_PARABOLA_Y_EXTREMA LC_STTS_COUNT LC_"\
   "STTS_MAGIC LC_STTS_MAX LC_STTS_MAX_KEY LC_STTS_MEAN LC_STTS"\
   "_MIN LC_STTS_MSQ LC_STTS_NUM LC_STTSC_COUNT LC_STTSC_COVAR "\
   "LC_STTSC_MAGIC LC_STTSC_XX LC_STTSC_YY LENGTH LFENERGY LFHz"\
   " LFWAVELENGTH LFWAVENUMBER LIFEAGE LIGHT LIGHT_ERR LIGHT_RE"\
   "C LIGHTYEAR LITER LITRE LNTEN LNTWO LUMEN LUX MACH MAGNETIC"\
   " MAGNETIC_ERR MAGNETICFLUX MAGNETICINDUCTION MARATHON MASS "\
   "MEBI MEGA METER METRE MFENERGY MFHz MFWAVELENGTH MFWAVENUMB"\
   "ER MICRO MICROWAVEENERGY MICROWAVEHz MICROWAVEWAVELENGTH MI"\
   "CROWAVEWAVENUMBER MILE MILKYWAYAGE MILKYWAYDAY MILKYWAYMASS"\
   " MILKYWAYRADIUS MILLI MINUTE MIRENERGY MIRHz MIRWAVELENGTH "\
   "MIRWAVENUMBER MM MMHG MOLARMASS MOLARMASS_ERR MOLARMASSX MO"\
   "LARMASSX_ERR MOLE MONTHS_IN_YEAR MOONMONTH MPH MPS MPSS MU0"\
   " MU0_ERR MUON_MASS MUONENERGY MUONHz MUONMASS MUONMASS_ERR "\
   "MUONWAVELENGTH NANO NAT NEUTRON_MASS NEUTRONENERGY NEUTRONH"\
   "z NEUTRONMASS NEUTRONMASS_ERR NEUTRONWAVELENGTH NEWTON NICK"\
   "ELMASS NICKELRADIUS NICKELTHICKNESS NINEVOLT NINEVOLTBATTER"\
   "Y NINEVOLTBATTERYCHARGE NINEVOLTBATTERYENERGY NINEVOLTBATTE"\
   "RYVOLTAGE NINEVOLTCHARGE NINEVOLTENERGY NINEVOLTVOLTAGE NIR"\
   "ENERGY NIRHz NIRWAVELENGTH NIRWAVENUMBER NPBOUNDARY NUVENER"\
   "GY NUVHz NUVWAVELENGTH NUVWAVENUMBER OHM ORANGEENERGY ORANG"\
   "EHz ORANGEWAVELENGTH ORANGEWAVENUMBER OUNCE PA PARSEC PEBI "\
   "PENNYMASS PENNYRADIUS PENNYTHICKNESS PETA PHI PHONEBATTERY "\
   "PHONEBATTERYCHARGE PHONEBATTERYENERGY PHONEBATTERYVOLTAGE P"\
   "I PICO PINGPONGBALLMASS PINGPONGBALLRADIUS PINT PLANCK PLAN"\
   "CK_ERR PLANCK_REC PLANCKBAR PLANCKBAR_ERR PLANCKCHARGE PLAN"\
   "CKENERGY PLANCKLENGTH PLANCKMASS PLANCKTEMP PLANCKTIME POIN"\
   "T POUND POWER PPB PPM PPQ PPT PRESSURE PROTON_MASS PROTONEN"\
   "ERGY PROTONHz PROTONMASS PROTONMASS_ERR PROTONRADIUS PROTON"\
   "RADIUS_ERR PROTONWAVELENGTH PROXIMACENTAURI PSI PTRBOUNDARY"\
   " QUART QUARTERMASS QUARTERRADIUS QUARTERTHICKNESS RAD RADIA"\
   "N REDENERGY REDHz REDWAVELENGTH REDWAVENUMBER RESISTANCE RP"\
   "M RPS RYDBERG RYDBERG_ERR RYDBERGENERGY RYDBERGHz RYDBERGWA"\
   "VELENGTH RYDBERGWAVENUMBER SECOND SHANNON SHFENERGY SHFHz S"\
   "HFWAVELENGTH SHFWAVENUMBER SI16MAX SI16MIN SI32MAX SI32MIN "\
   "SIEMENS SOCCERBALLMASS SOCCERBALLRADIUS SOFTBALLMASS SOFTBA"\
   "LLRADIUS SOLARCONSTANT SOLID_ANGLE SPECIFICHEAT SPEED SPHER"\
   "ESURFACE SQDEG SQRTTWO SQUAREDEGREE STANDARDATMOSPHERE STAN"\
   "DARDGRAVITY STEFAN STEFAN_ERR STERADIAN SXENERGY SXHz SXWAV"\
   "ELENGTH SXWAVENUMBER SXXENERGY SXXHz SXXWAVELENGTH SXXWAVEN"\
   "UMBER TAU TAU_MASS TAUENERGY TAUHz TAUMASS TAUMASS_ERR TAUW"\
   "AVELENGTH TBLSP TEBI TEMPERATURE TENNISBALLMASS TENNISBALLR"\
   "ADIUS TERA TESLA THFENERGY THFHz THFWAVELENGTH THFWAVENUMBE"\
   "R TIME TON TONNE TORR TRITON_MASS TRITONMASS TRITONMASS_ERR"\
   " TRJBOUNDARY TSP TT_AT_0TAI TT_AT_0UT1 TURN UAMU UAMU_ERR U"\
   "ET UHFENERGY UHFHz UHFWAVELENGTH UHFWAVENUMBER UI16MAX UI32"\
   "MAX UNITGM UNIVERSEAGE UNIVERSEMASS UNIVERSERADIUS UPQUARK_"\
   "MASS UPQUARKENERGY UPQUARKHz UPQUARKMASS UPQUARKMASS_ERR UP"\
   "QUARKWAVELENGTH UVAENERGY UVAHz UVAWAVELENGTH UVAWAVENUMBER"\
   " UVBENERGY UVBHz UVBWAVELENGTH UVBWAVENUMBER UVCENERGY UVCH"\
   "z UVCWAVELENGTH UVCWAVENUMBER VHFENERGY VHFHz VHFWAVELENGTH"\
   " VHFWAVENUMBER VIOLETENERGY VIOLETHz VIOLETWAVELENGTH VIOLE"\
   "TWAVENUMBER VISCOSITY VOLT VOLTAGE VOLUME VONKLITZING VONKL"\
   "ITZING_ERR WATT WEBER WEEK YARD YELLOWENERGY YELLOWGREENENE"\
   "RGY YELLOWGREENHz YELLOWGREENWAVELENGTH YELLOWGREENWAVENUMB"\
   "ER YELLOWHz YELLOWWAVELENGTH YELLOWWAVENUMBER YOBI YOCTO YO"\
   ...
   "n1 almean1 amean1 aqmean1 b2m bankers bb_pdf bell bellx ben"\
   "ford_rand bernoulli bernoullid bernoullin bessI0 bessI1 bes"\
   "sJ0 bessJ1 bessK0 bessK1 bessY0 bessY1 bessY1__1 bits_count"\
   " bits_ls1b bits_ls1bpos bits_ms1b bits_ms1bpos bitwisenot b"\
   "lackbody_pdf blackbodymode blackbodypower cantor carmichael"\
   " catalan cauchy_rand cbrt ceil chisqr_rand circle_get clip "\
   "clockhour clockmin clocksec clockstdev clocksum cnv_dbl2si1"\
   "6 corr_delete corr_handlex corr_handley corrcorr corrslope "\
   "corrstderr corry0 cos cos__1 cosd cosdinv cosh coshinv cosi"\
   "ntegral cosinv cosm1 cosm1__1 cost costinv cot cotd cotdinv"\
   " coth cothinv cotinv cott cottinv csc cscd cscdinv csch csc"\
   "hinv cscinv csct csctinv ctz cu cube cuberoot date_easter d"\
   "ate_pesach date_rosh_hashanah day2dhms day2dhmsinv day2hour"\
   " deg2dms deg2rad deg2sec deg2tur digamma digamma__1 digamma"\
   "inv dms2deg dms2rad doomsday ecc2flat Ein elliptic1a ellipt"\
   "ic1k elliptic1m elliptic1m__1 elliptic1m__2 elliptic2a elli"\
   "ptic2k elliptic2m elliptic2m__1 ellipticE ellipticK erf erf"\
   "__1 erf__2 erf__3 erf__4 erfc erfcinv erfcx erfcxinv erfinv"\
   " eta eulerphi eulerx exp exp__1 exp__2 exp_rand expintegral"\
   "1 expintegrali expm1 fac facinv factorial factorialdouble f"\
   "actorialinv fibo fibox fiboxinv flat2ecc floor frac fubini "\
   "fusc g2jewish gamma_rand gau_cdf gau_pdf gau_quantile gd gd"\
   "inv geo_rand ghmean1 ghmean1inv glmean1 gmean1 gqmean1 has_"\
   "primitiveroot haversin heaviside heronianmean1 hlmean1 hmea"\
   "n1 hn hn__1 hour2day hqmean1 hypot1 hypot1inv id int_rand i"\
   "round iseven isint isjewish8short isjewish9short isjewishle"\
   "ap isleapyear ismagic isneg isnegint isodd ispos isposint i"\
   "spractical isprime issquarefree iszero j2k2dow j2k2jd j2k2k"\
   "wt j2k2uet j2k2ymdhms jacobicir jd2dow jd2j2k jd2kwt jd2uet"\
   " jd2ymdhms jewish2g jewish2jd jewish2jdx jewish_months_in_y"\
   "ear jewish_yearlength k2a k2m k2tempc k2tempf k2tempr ks_a_"\
   "cdf kwt2j2k kwt2jd kwt2uet l10 lg lgamma lgamma__1 lgamma__"\
   "2 lgammainv lix lixinv lmean1 ln ln1p ln__1 ln__2 lns log l"\
   "og10 logintegral logistic_rand lqmean1 lucas lucasx m2a m2b"\
   " m2k mertens minkowski mobius neg nom normal_cdf normal_cdf"\
   "__1 normal_pdf normal_quantile normal_quantile__1 parabola_"\
   "get parabola_roots partition partitionq pcf pfg pfl poi_ran"\
   "d pow10 pow2 prime0 prime1 primecount primecountx primenext"\
   " primenth primenth__1 primeprev primitiveroot print_contfra"\
   " print_contfrac print_contfracd print_factor print_jd264 pr"\
   "int_num2char qmean1 rad2deg rad2dms rad2dms2 rad2sec rad2tu"\
   "r rand_init randl reci reimann round rto125 rtoi rtoz sba s"\
   "earch_check search_search sec sec2deg sec2dhms sec2rad sec2"\
   "tur secd secdinv sech sechinv secinv sect sectinv shc_shft2"\
   "steps shc_steps2shft shc_steps2shftinv sigma0 sigma1 sigmoi"\
   "d sigmoidinv sign sin sin__1 sinc sinc__1 sincc sincinv sin"\
   "d sindinv sinh sinhinv sinintegral sininv sint sintinv smoo"\
   "th sq sqinv sqrt sqrt__1 sqrt__2 sqrt__3 sqrtx square squar"\
   "eroot stair stts_delete stts_reset sttscount sttsmagic stts"\
   "max sttsmean sttsmin sttsmsq sttsspread sttsstdev sttsstdev"\
   "mean sttssum sttsvar supercatalan tan tand tandinv tanh tan"\
   "hinv taninv tant tantinv tempc tempc2k tempc2tempf tempf te"\
   "mpf2k tempf2tempc tempr tempr2k tgamma tgamma__1 tgamma__2 "\
   "tgamma__3 tgamma__stirling tgammadouble tgammainv topyh1 to"\
   "tient tri tri_rand triinv trip trunc tur2deg tur2rad tur2se"\
   "c uet2j2k uet2jd uet2kwt uni_rand versin wm wminv wp wpinv "\
   "ymdhms2j2k ymdhms2jd ymdhms_get zag zeta zig zigzag"\
   "\n"\
   ...
   "__1 ellipseecc ellipseflatness ellipsem elliptic1ia ellipti"\
   "c1ik elliptic1im elliptic1im__1 elliptic2ia elliptic2ik ell"\
   "iptic2im elliptic2im__1 elliptic3a elliptic3k elliptic3m el"\
   "liptic3m__1 ellipticEi ellipticF ellipticP entringer euleri"\
   "an exp_cdf exp_pdf exp_quantile expintegraln factor factori"\
   "alt floor2 fmod fmods fmodu fmody fmul gamma_cdf gamma_pdf "\
   "gcd gcda geo_cdf geo_pdf geo_quantile ghmean glmean gmean g"\
   "ompertz_rand gqmean has_primitiveroot_f heronianmean hlmean"\
   " hmean hnm hqmean hypot int_cdf int_pdf int_quantile ints_r"\
   "and iseq isge isgt isle islt ismult ismultl isneq ispractic"\
   "al_f isprimitiveroot issignsame issquarefree_f isss jacobip"\
   "hi jewish_monthbegin jewish_monthlength ks_b_cdf ks_cdf ks_"\
   "quantile lbeta lcam lcams lcantim lcm lcombx ligamma ligamm"\
   "ainv lmean logistic_cdf logistic_pdf logistic_quantile lper"\
   "mx lqmean max2 maxabs maxabs2 maxi mb_cdf mb_pdf mean min2 "\
   "minabs minabs2 mini mobius_f mods modulo nbd_rand nc nd nev"\
   "illethetac nevillethetad nevillethetan nevillethetas ns nth"\
   "root__1 pareto_rand perm permutation permx pochhammer poi_c"\
   "df poi_pdf poi_quantile polya_rand polycnum polynum pow pow"\
   "i prime0_f print_base_out print_base_outf qmean rand_init_a"\
   "rray ratio repetendlen rligamma rms round2 rtomsd ruigamma "\
   "sc sd shc_shftpoles2steps sigma sigma0_f sigma1_f sn sn__1 "\
   "spread2stdev stdev2spread stirling1 stirling2 stts_copy stt"\
   "s_downdate stts_newx stts_scale stts_shift stts_update stts"\
   "_update2 t_cdf t_cdf__1 t_pdf t_quantile t_quantile__1 tetr"\
   "acnum tetranum theta1 theta2 theta3 theta4 Tn topyh totient"\
   "_f trap_rand tri_cdf tri_pdf tri_quantile uigamma uigamma__"\
   "1 uigammainv Un uni_cdf uni_pdf uni_quantile variance zeta_"\
   "cdf zeta_pdf zipf_rand znorder znorder__1"\
   "\n"\
   "   Kw 3-ary Functions: agcmean aghmean atothenmodp atothenm"\
   "odx beta_cdf beta_pdf beta_quantile betainc betainc__1 bino"\
   "mial_cdf binomial_pdf bits_assign bkbn cantorll cantorul ca"\
   "ntorxx carlsonRD carlsonRF chebeval clip2 clip2x corr_updat"\
   "e cossin_ev divi dlog dlogx elliptic3ia elliptic3ik ellipti"\
   "c3im elliptic3im__1 ellipticPi epdf2cdf f11 f_cdf f_quantil"\
   "e f_quantile__1 fibo3 fit_ls fit_ls0 fit_minmax fit_minmax0"\
   " fit_poly fitx_minmax fmod2 gompertz_cdf gompertz_pdf gompe"\
   "rtz_quantile hms2day horner hypot3 ifzero isalmostequal isb"\
   "etween isbetweenx isfloorsame iswithin jewishymd2jd lv_ellp"\
   "j maxabsoffset maxmin maxwell_boltzmann_cdf maxwell_boltzma"\
   "nn_pdf maxwell_juttner_pdf minabsoffset n2perm nbd_cdf nbd_"\
   "pdf pareto_cdf pareto_pdf pareto_quantile pendulum pmean po"\
   "lya_cdf polya_pdf print_kevy remquou roundy sigma_f sigmoid"\
   "3 sigmoid3d stts_updatex taninv3 trap_cdf trap_pdf trap_qua"\
   "ntile ymd2dow ymd2doy ymd2j2k ymd2jd zipf_cdf zipf_pdf zipf"\
   "_quantile"\
   "\n"\
...
#define Kw_DESC \
   ...
   "R h_REC HALAQIM(_PER_HOUR)? HART(LEY)? HBAR(_ERR)? HECT(ARE"\
   "|O) HELION(_MASS|MASS(_ERR)?) HENRY HERTZ HFENERGY HFHz HFW"\
   "AVE(LENGTH|NUMBER) HI HI_ERR HIENERGY HIHz HIWAVE(LENGTH|NU"\
   "MBER) HORSEPOWER HOUR HP HPMETRIC HUBBLE(_ERR)? HXENERGY HX"\
   "Hz HXWAVE(LENGTH|NUMBER) HYDROGEN(LINE(_ERR)?|RADIUS(_ERR)?"\
   ") INCH INDUCTANCE INHG INTMAX J2K(DAY)? JC JCENTURY JD JDAY"\
   " JDSEC_AT_0(GREGORIAN|J2K|KWT|UET) JEWISH_FIRST_MONTH JM JM"\
   "ILLENNIUM JOSEPHSON(_ERR)? JOULE JULIAN(CENTURY|DAY|MILLENN"\
   "IUM|YEAR) JY JYEAR K_AT_0TEMP[CFR] kB kB_(ERR|REC) KCD(_ERR"\
   ")? KELVIN KG KGENERGY KGF KGHz KGWAVE(LENGTH|NUMBER) KIBI K"\
   "ILO(GRAM)? KPGBOUNDARY KWT LB LBF LC_(CIRCLE_(RADIUS|[XY])|"\
   "EPS|GD_(COUNT|D(AY|OW)|HOUR|JD|M(IN|ONTH)|NUM|SEC|YEAR)|KNU"\
   "TH_(ARRAY_COUNT|KK_COUNT|LL|MAX|QUALITY_COUNT|TT)|MA(GIC_IN"\
   "T(_NOT)?|X_FACTORS)|PARABOLA_(COEFF_[ABC]|R(EAL_ROOTS|OOT_["\
   "AB])|X_AXIS|Y_EXTREMA)|STTS(_(COUNT|M(A(GIC|X(_KEY)?)|EAN|I"\
   "N|SQ)|NUM)|C_(CO(UNT|VAR)|MAGIC|XX|YY))) LENGTH LFENERGY LF"\
   "Hz LFWAVE(LENGTH|NUMBER) LIFEAGE LIGHT(_(ERR|REC)|YEAR)? LI"\
   "T(ER|RE) LNT(EN|WO) LUMEN LUX MACH MAGNETIC(_ERR|FLUX|INDUC"\
   "TION)? MARATHON MASS MEBI MEGA MET(ER|RE) MFENERGY MFHz MFW"\
   "AVE(LENGTH|NUMBER) MICRO(|WAVE(ENERGY|Hz|WAVE(LENGTH|NUMBER"\
   "))) MIL(E|KYWAY(AGE|DAY|MASS|RADIUS)|LI) MINUTE MIR(ENERGY|"\
   "Hz|WAVE(LENGTH|NUMBER)) MM MMHG MOL(ARMASS(_ERR|X(_ERR)?)?|"\
   "E) MONTHS_IN_YEAR MOONMONTH MPH MPSS? MU0(_ERR)? MUON(_MASS"\
   "|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH) NANO NAT NEUTRON(_MASS|E"\
   "NERGY|Hz|MASS(_ERR)?|WAVELENGTH) NEWTON NICKEL(MAS|RADIU|TH"\
   "ICKNES)S NINEVOLT(BATTERY(CHARGE|ENERGY|VOLTAGE)?|CHARGE|EN"\
   "ERGY|VOLTAGE)? NIR(ENERGY|Hz|WAVE(LENGTH|NUMBER)) NPBOUNDAR"\
   "Y NUV(ENERGY|Hz|WAVE(LENGTH|NUMBER)) OHM ORANGE(ENERGY|Hz|W"\
   "AVE(LENGTH|NUMBER)) OUNCE PA PARSEC PEBI PENNY(MAS|RADIU|TH"\
   "ICKNES)S PETA PHI PHONEBATTERY(CHARGE|ENERGY|VOLTAGE)? PI P"\
   "ICO PIN(GPONGBALL(MASS|RADIUS)|T) PLANCK(|_(ERR|REC)|BAR(_E"\
   "RR)?|CHARGE|ENERGY|LENGTH|MASS|T(EMP|IME)) POINT POUND POWE"\
   "R PPB PPM PPQ PPT PRESSURE PRO(TON(_MASS|ENERGY|Hz|MASS(_ER"\
   "R)?|RADIUS(_ERR)?|WAVELENGTH)|XIMACENTAURI) PSI PTRBOUNDARY"\
   " QUART(ER(MAS|RADIU|THICKNES)S)? RAD(IAN)? RED(ENERGY|Hz|WA"\
   "VE(LENGTH|NUMBER)) RESISTANCE RPM RPS RYDBERG(_ERR|ENERGY|H"\
   "z|WAVE(LENGTH|NUMBER))? SECOND SHANNON SHF(ENERGY|Hz|WAVE(L"\
   "ENGTH|NUMBER)) SI16M(AX|IN) SI32M(AX|IN) SIEMENS SOCCERBALL"\
   "(MASS|RADIUS) SOFTBALL(MASS|RADIUS) SOL(ARCONSTANT|ID_ANGLE"\
   ") SPE(CIFICHEAT|ED) SPHERESURFACE SQDEG SQRTTWO SQUAREDEGRE"\
   "E STANDARD(ATMOSPHERE|GRAVITY) STE(FAN(_ERR)?|RADIAN) SXENE"\
   "RGY SXHz SXWAVE(LENGTH|NUMBER) SXX(ENERGY|Hz|WAVE(LENGTH|NU"\
   "MBER)) TAU(_MASS|ENERGY|Hz|MASS(_ERR)?|WAVELENGTH)? TBLSP T"\
   "EBI TEMPERATURE TENNISBALL(MASS|RADIUS) TERA TESLA THF(ENER"\
   "GY|Hz|WAVE(LENGTH|NUMBER)) TIME TON(NE)? TORR TRITON(_MASS|"\
   "MASS(_ERR)?) TRJBOUNDARY TSP TT_AT_0(TAI|UT1) TURN UAMU(_ER"\
   "R)? UET UHF(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UI16MAX UI32MAX "\
   "UNI(TGM|VERSE(AGE|MASS|RADIUS)) UPQUARK(_MASS|ENERGY|Hz|MAS"\
   "S(_ERR)?|WAVELENGTH) UVA(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UVB"\
   "(ENERGY|Hz|WAVE(LENGTH|NUMBER)) UVC(ENERGY|Hz|WAVE(LENGTH|N"\
   "UMBER)) VHF(ENERGY|Hz|WAVE(LENGTH|NUMBER)) VIOLET(ENERGY|Hz"\
   "|WAVE(LENGTH|NUMBER)) VISCOSITY VOL(T(AGE)?|UME) VONKLITZIN"\
   "G(_ERR)? WATT WEBER WEEK YARD YELLOW(ENERGY|GREEN(ENERGY|Hz"\
   "|WAVE(LENGTH|NUMBER))|Hz|WAVE(LENGTH|NUMBER)) YOBI YOCTO YO"\
   "TTA ZEBI ZEPTO ZETTA"\
   "\n"\
   "   Kw 0-ary Functions: corr_new euler__1 gau_rand jd2ymdhms"\
   ...
   "mean1 amean1 aqmean1 b2m bankers bb_pdf bellx? benford_rand"\
   " bernoulli[dn]? bess(I[01]|J[01]|K[01]|Y(0|1(__1)?)) bit(s_"\
   "(count|ls1b(pos)?|ms1b(pos)?)|wisenot) blackbody(_pdf|mode|"\
   "power) cantor carmichael catalan cauchy_rand cbrt ceil chis"\
   "qr_rand circle_get clip clock(hour|min|s(ec|tdev|um)) cnv_d"\
   "bl2si16 corr(_(delete|handle[xy])|corr|s(lope|tderr)|y0) co"\
   "s(|__1|d(inv)?|h(inv)?|in(tegral|v)|m1(__1)?|t(inv)?) cot(["\
   "dht]?(inv)?)? csc([dht]?(inv)?)? ctz cu cube(root)? date_(e"\
   "aster|pesach|rosh_hashanah) day2(dhms(inv)?|hour) deg2(dms|"\
   "rad|sec|tur) digamma(__1|inv)? dms2(deg|rad) doomsday ecc2f"\
   "lat Ein elliptic(1([ak]|m(__[12])?)|2([ak]|m(__1)?)|[EK]) e"\
   "rf(|__([12]|[34])|c(inv|x(inv)?)?|inv) eta euler(phi|x) exp"\
   "(_(_[12]|rand)|integral[1i]|m1)? fac(inv|torial(double|inv)"\
   "?)? fibo(x(inv)?)? flat2ecc floor frac fubini fusc g2jewish"\
   " gamma_rand gau_(cdf|pdf|quantile) gd gdinv geo_rand ghmean"\
   "1(inv)? glmean1 gmean1 gqmean1 has_primitiveroot haversin h"\
   "eaviside heronianmean1 hlmean1 hmean1 hn hn__1 hour2day hqm"\
   "ean1 hypot1(inv)? id int_rand iround is(even|int|jewish8sho"\
   "rt|jewish9short|jewishleap|leapyear|magic|neg|negint|odd|po"\
   "s|posint|practical|prime|squarefree|zero) j2k2(dow|jd|kwt|u"\
   "et|ymdhms) jacobicir jd2(dow|j2k|kwt|uet|ymdhms) jewish(2(g"\
   "|jdx?)|_(months_in_year|yearlength)) k2a k2m k2temp[cfr] ks"\
   "_a_cdf kwt2(j(2k|d)|uet) l10 lg lgamma(__[12]|inv)? lix(inv"\
   ")? lmean1 ln ln1p ln__[12] lns log(10|i(ntegral|stic_rand))"\
   "? lqmean1 lucasx? m2a m2b m2k mertens minkowski mobius neg "\
   "nom normal_(cdf(__1)?|pdf|quantile(__1)?) par(abola_(get|ro"\
   "ots)|titionq?) pcf pfg pfl poi_rand pow(10|2) pri(m(e([01]|"\
   "countx?|n(ext|th(__1)?)|prev)|itiveroot)|nt_(contfra(cd?)?|"\
   "factor|jd264|num2char)) qmean1 rad2(d(eg|ms2?)|sec|tur) ran"\
   "d(_init|l) reci reimann round rto(125|[iz]) sba search_(che"\
   "ck|search) sec(|2(d(eg|hms)|rad|tur)|[dht]?(inv)?) shc_s(hf"\
   "t2steps|teps2shft(inv)?) sig(m(a[01]|oid(inv)?)|n) sin(|__1"\
   "|c(__1|c|inv)?|d(inv)?|h(inv)?|in(tegral|v)|t(inv)?) smooth"\
   " sq sqinv sqrt(__[123]|x)? square(root)? stair stts(_(delet"\
   "e|reset)|count|m(a(gic|x)|ean|in|sq)|s(pread|tdev(mean)?|um"\
   ")|var) supercatalan tan([dht]?(inv)?)? temp(c(2(k|tempf))?|"\
   "f(2(k|tempc))?|r(2k)?) tgamma(__([123]|stirling)|double|inv"\
   ")? topyh1 totient tri(_rand|inv|p)? trunc tur2(deg|rad|sec)"\
   " uet2(j(2k|d)|kwt) uni_rand versin wm(inv)? wp(inv)? ymdhms"\
   "(2j(2k|d)|_get) zag zeta zig(zag)?"\
   "\n"\
   ...
   "ip(se(area|cir(__1)?|ecc|flatness|m)|tic(1i([ak]|m(__1)?)|2"\
   "i([ak]|m(__1)?)|3([ak]|m(__1)?)|Ei|[FP]))) entringer euleri"\
   "an exp(_(cdf|pdf|quantile)|integraln) factor(ialt)? floor2 "\
   "fmod[suy]? fmul gamma_(cdf|pdf) gcda? geo_(cdf|pdf|quantile"\
   ") ghmean glmean gmean gompertz_rand gqmean has_primitiveroo"\
   "t_f heronianmean hlmean hmean hnm hqmean hypot int(_(cdf|pd"\
   "f|quantile)|s_rand) is(eq|ge|gt|le|lt|mult|multl|neq|practi"\
   "cal_f|primitiveroot|signsame|squarefree_f|ss) jacobiphi jew"\
   "ish_month(begin|length) ks_(b_cdf|cdf|quantile) lbeta lca(m"\
   "s?|ntim) lcm lcombx ligamma(inv)? lmean logistic_(cdf|pdf|q"\
   "uantile) lpermx lqmean max(2|abs2?|i) mb_(cdf|pdf) mean min"\
   "(2|abs2?|i) mobius_f mod(s|ulo) nbd_rand nc nd nevilletheta"\
   "([cd]|[ns]) ns nthroot__1 pareto_rand perm(utation|x)? poch"\
   "hammer poi_(cdf|pdf|quantile) poly(a_rand|cnum|num) powi? p"\
   "ri(me0_f|nt_base_outf?) qmean rand_init_array ratio repeten"\
   "dlen rligamma rms round2 rtomsd ruigamma sc sd shc_shftpole"\
   "s2steps sigma(0_f|1_f)? sn sn__1 spread2stdev stdev2spread "\
   "stirling[12] stts_(copy|downdate|newx|s(cale|hift)|update2?"\
   ") t_cdf(__1)? t_pdf t_quantile(__1)? tetra(cnum|num) theta("\
   "[12]|[34]) Tn topyh totient_f trap_rand tri_(cdf|pdf|quanti"\
   "le) uigamma(__1|inv)? Un uni_(cdf|pdf|quantile) variance ze"\
   "ta_(cdf|pdf) zipf_rand znorder(__1)?"\
   "\n"\
   "   Kw 3-ary Functions: agcmean aghmean atothenmod[px] beta("\
   "_(cdf|pdf|quantile)|inc(__1)?) binomial_(cdf|pdf) bits_assi"\
   "gn bkbn cantor(ll|ul|xx) carlsonR[DF] chebeval clip2x? corr"\
   "_update cossin_ev divi dlogx? elliptic(3i([ak]|m(__1)?)|Pi)"\
   " epdf2cdf f11 f_cdf f_quantile(__1)? fibo3 fit(_(ls0?|minma"\
   "x0?|poly)|x_minmax) fmod2 gompertz_(cdf|pdf|quantile) hms2d"\
   "ay horner hypot3 ifzero is(almostequal|between|betweenx|flo"\
   "orsame|within) jewishymd2jd lv_ellpj max(absoffset|min|well"\
   "_(boltzmann_(cdf|pdf)|juttner_pdf)) minabsoffset n2perm nbd"\
   "_(cdf|pdf) pareto_(cdf|pdf|quantile) pendulum pmean polya_("\
   "cdf|pdf) print_kevy remquou roundy sigm(a_f|oid3d?) stts_up"\
   "datex taninv3 trap_(cdf|pdf|quantile) ymd2(do[wy]|j(2k|d)) "\
